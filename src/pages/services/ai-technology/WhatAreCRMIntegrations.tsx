...
const WhatAreCRMIntegrations = () => {
  ...
  const seoConfig = {
    title: "What Are C R M Integrations Services | MarkTechRover",
    description: "Professional what are c r m integrations services. Expert solutions for your business needs. Get started today.",
    keywords: ["what are c r m integrations","services","professional","expert","business"],
    url: "/services/ai-technology/what-are-c-r-m-integrations",
    type: "website" as const,
    publishedAt: "2025-08-05T06:37:20.490Z",
    modifiedAt: "2025-08-05T06:37:20.490Z",
    author: "MarkTechRover",
    section: "Services",
    tags: ["what are c r m integrations","services"],
    image: "/images/services/what-are-c-r-m-integrations.jpg"
  };

  const deliverables = [
    {
      id: 1,
      title: 'Custom what-are-c-r-m-integrations',
      description: 'Bespoke what-are-c-r-m-integrations tailored to your brand and business objectives',
      icon: <DesignIcon className="h-6 w-6" />,
      features: [
        'Custom what-are-c-r-m-integrations and layout',
    ...
    {
      id: 3,
      title: 'E-commerce what-are-c-r-m-integrations',
      description: 'Professional e-commerce what-are-c-r-m-integrations for online stores',
    ...
    },
    {
      ...
      description: 'what-are-c-r-m-integrations optimized for search engine visibility',
  ...
  const designPackages = [
    {
      name: 'Basic what-are-c-r-m-integrations',
      price: '₹45,000',
      period: 'one-time',
      description: 'Perfect for small businesses and startups',
      features: [
        '5-page custom what-are-c-r-m-integrations',
    ...
    {
      name: 'Professional what-are-c-r-m-integrations',
      price: '₹85,000',
      period: 'one-time',
      description: 'Comprehensive what-are-c-r-m-integrations for growing businesses',
      features: [
        '10-page custom what-are-c-r-m-integrations',
    ...
    {
      name: 'Enterprise what-are-c-r-m-integrations',
      price: '₹1,50,000',
      period: 'one-time',
      description: 'Full-featured what-are-c-r-m-integrations for large businesses',
      features: [
      ...
      <div className="min-h-screen ">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
            <div className="text-center">
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-purple-500/20 border border-purple-400/30 text-purple-200 text-sm font-medium mb-6">
                ...
                what-are-c-r-m-integrations Services
              </div>
              ...
              <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-white via-purple-100 to-white bg-clip-text text-transparent">
                what-are-c-r-m-integrations Services in Delhi
              </h1>
              
              <p className="text-xl md:text-2xl text-purple-200 mb-8 max-w-4xl mx-auto leading-relaxed">
                Best what-are-c-r-m-integrations company in Delhi NCR offering custom what-are-c-r-m-integrations. 
                Professional what-are-c-r-m-integrations services India with modern, responsive designs.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                ...
                >
                  ...
                  Get what-are-c-r-m-integrations Quote
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <section id="deliverables" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                what-are-c-r-m-integrations Deliverables
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Comprehensive what-are-c-r-m-integrations services designed for business growth. 
                Best what-are-c-r-m-integrations company in Delhi NCR delivering modern, responsive websites.
              </p>
            </div>
          ...
          <section id="packages" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                what-are-c-r-m-integrations Packages
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Comprehensive what-are-c-r-m-integrations solutions. Best what-are-c-r-m-integrations services in India with flexible packages 
          ...
          <section id="technology" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                what-are-c-r-m-integrations Technology
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Advanced what-are-c-r-m-integrations technology stack powering modern websites. 
                Professional what-are-c-r-m-integrations services India with cutting-edge tools and frameworks.
              </p>
            </div>
          ...
          <section id="case-studies" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                what-are-c-r-m-integrations Case Studies
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Real results from what-are-c-r-m-integrations projects. Best what-are-c-r-m-integrations company in Delhi NCR 
          ...
          <section id="approach" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                what-are-c-r-m-integrations Approach
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Proven methodology for what-are-c-r-m-integrations success. what-are-c-r-m-integrations experts in Delhi NCR 
          ...
          <section id="faqs" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                what-are-c-r-m-integrations FAQs
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Common questions about what-are-c-r-m-integrations services. Best what-are-c-r-m-integrations company in Delhi 
              ...
              {[
                {
                  ...
                  answer: 'what-are-c-r-m-integrations and development typically takes 4-8 weeks depending on complexity, number of pages, and features required. Simple websites can be completed in 2-3 weeks, while complex e-commerce or custom applications may take 8-12 weeks.'
                },
                {
                  question: 'What is the typical cost for what-are-c-r-m-integrations services?',
                  answer: 'what-are-c-r-m-integrations costs typically range from ₹45,000 to ₹1,50,000 depending on complexity, features, and scope of work. We provide detailed quotes based on your specific requirements and business goals.'
                },
                {
                ...
                },
                {
                  ...
                  answer: 'Yes, we work with businesses across India and internationally. Our what-are-c-r-m-integrations services are not limited by geography and can be delivered remotely with excellent results.'
                },
                {
                ...
                {
                  question: 'Do you provide SEO optimization with what-are-c-r-m-integrations?',
                  answer: 'Yes, we include basic SEO optimization with all what-are-c-r-m-integrations packages. This includes SEO-friendly URL structure, meta tags, schema markup, fast loading speed, mobile optimization, and other SEO best practices.'
                }
              ].map((faq, index) => (
        ...
        <section className="bg-gradient-to-r from-purple-600 to-purple-800 text-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-purple-100 mb-8 max-w-3xl mx-auto">
              Best what-are-c-r-m-integrations company in Delhi NCR offering comprehensive what-are-c-r-m-integrations services. 
              Get started with professional what-are-c-r-m-integrations services India today.
            </p>
...
export default WhatAreCRMIntegrations; 