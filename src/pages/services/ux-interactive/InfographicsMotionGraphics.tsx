...
const InfographicsMotionGraphics = () => {
  ...
  const seoConfig = {
    title: "Infographics Motion Graphics Services | MarkTechRover",
    description: "Professional infographics motion graphics services. Expert solutions for your business needs. Get started today.",
    keywords: ["infographics motion graphics","services","professional","expert","business"],
    url: "/services/ux-interactive/infographics-motion-graphics",
    type: "website" as const,
    publishedAt: "2025-08-05T06:37:20.382Z",
    modifiedAt: "2025-08-05T06:37:20.382Z",
    author: "MarkTechRover",
    section: "Services",
    tags: ["infographics motion graphics","services"],
    image: "/images/services/infographics-motion-graphics.jpg"
  };

  const deliverables = [
    {
      id: 1,
      title: 'Custom infographics-motion-graphics',
      description: 'Bespoke infographics-motion-graphics tailored to your brand and business objectives',
      icon: <DesignIcon className="h-6 w-6" />,
      features: [
        'Custom infographics-motion-graphics and layout',
    ...
    {
      id: 3,
      title: 'E-commerce infographics-motion-graphics',
      description: 'Professional e-commerce infographics-motion-graphics for online stores',
    ...
    },
    {
      ...
      description: 'infographics-motion-graphics optimized for search engine visibility',
  ...
  const designPackages = [
    {
      name: 'Basic infographics-motion-graphics',
      price: '₹45,000',
      period: 'one-time',
      description: 'Perfect for small businesses and startups',
      features: [
        '5-page custom infographics-motion-graphics',
    ...
    {
      name: 'Professional infographics-motion-graphics',
      price: '₹85,000',
      period: 'one-time',
      description: 'Comprehensive infographics-motion-graphics for growing businesses',
      features: [
        '10-page custom infographics-motion-graphics',
    ...
    {
      name: 'Enterprise infographics-motion-graphics',
      price: '₹1,50,000',
      period: 'one-time',
      description: 'Full-featured infographics-motion-graphics for large businesses',
      features: [
      ...
      <div className="min-h-screen ">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
            <div className="text-center">
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-purple-500/20 border border-purple-400/30 text-purple-200 text-sm font-medium mb-6">
                ...
                infographics-motion-graphics Services
              </div>
              ...
              <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-white via-purple-100 to-white bg-clip-text text-transparent">
                infographics-motion-graphics Services in Delhi
              </h1>
              
              <p className="text-xl md:text-2xl text-purple-200 mb-8 max-w-4xl mx-auto leading-relaxed">
                Best infographics-motion-graphics company in Delhi NCR offering custom infographics-motion-graphics. 
                Professional infographics-motion-graphics services India with modern, responsive designs.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <section id="deliverables" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                infographics-motion-graphics Deliverables
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Comprehensive infographics-motion-graphics services designed for business growth. 
                Best infographics-motion-graphics company in Delhi NCR delivering modern, responsive websites.
              </p>
            </div>
          ...
          <section id="packages" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                infographics-motion-graphics Packages
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Comprehensive infographics-motion-graphics solutions. Best infographics-motion-graphics services in India with flexible packages 
          ...
          <section id="technology" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                infographics-motion-graphics Technology
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Advanced infographics-motion-graphics technology stack powering modern websites. 
                Professional infographics-motion-graphics services India with cutting-edge tools and frameworks.
              </p>
            </div>
          ...
          <section id="case-studies" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                infographics-motion-graphics Case Studies
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Real results from infographics-motion-graphics projects. Best infographics-motion-graphics company in Delhi NCR 
          ...
          <section id="approach" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                infographics-motion-graphics Approach
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Proven methodology for infographics-motion-graphics success. infographics-motion-graphics experts in Delhi NCR 
          ...
          <section id="faqs" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                infographics-motion-graphics FAQs
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Common questions about infographics-motion-graphics services. Best infographics-motion-graphics company in Delhi 
              ...
              {[
                {
                  ...
                  answer: 'infographics-motion-graphics and development typically takes 4-8 weeks depending on complexity, number of pages, and features required. Simple websites can be completed in 2-3 weeks, while complex e-commerce or custom applications may take 8-12 weeks.'
                },
                {
                  question: 'What is the typical cost for infographics-motion-graphics services?',
                  answer: 'infographics-motion-graphics costs typically range from ₹45,000 to ₹1,50,000 depending on complexity, features, and scope of work. We provide detailed quotes based on your specific requirements and business goals.'
                },
                {
                ...
                },
                {
                  ...
                  answer: 'Yes, we work with businesses across India and internationally. Our infographics-motion-graphics services are not limited by geography and can be delivered remotely with excellent results.'
                },
                {
                ...
                {
                  question: 'Do you provide SEO optimization with infographics-motion-graphics?',
                  answer: 'Yes, we include basic SEO optimization with all infographics-motion-graphics packages. This includes SEO-friendly URL structure, meta tags, schema markup, fast loading speed, mobile optimization, and other SEO best practices.'
                }
              ].map((faq, index) => (
