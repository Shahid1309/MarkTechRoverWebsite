...
const WebsiteDesign = () => {
  ...
  const deliverables = [
    {
      ...
      description: 'Bespoke website design tailored to your brand and business objectives',
    ...
    },
    {
      ...
      description: 'Professional e-commerce website design for online stores',
    ...
    },
    {
      ...
      description: 'Website design optimized for search engine visibility',
  ...
  const designPackages = [
    ...
    },
    {
      ...
      price: '₹85,000',
      period: 'one-time',
      description: 'Comprehensive website design for growing businesses',
      features: [
    ...
    {
      name: 'Enterprise Website Design',
      price: '₹1,50,000',
      period: 'one-time',
      description: 'Full-featured website design for large businesses',
      features: [
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-purple-200 mb-8 max-w-4xl mx-auto leading-relaxed">
                Best website design company in Delhi NCR offering custom website design. 
                Professional website design services India with modern, responsive designs.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <section id="deliverables" className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Comprehensive website design services designed for business growth. 
                Best website design company in Delhi NCR delivering modern, responsive websites.
              </p>
            </div>
          ...
          <section id="packages" className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Comprehensive website design solutions. Best website design services in India with flexible packages 
          ...
          <section id="technology" className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Advanced website design technology stack powering modern websites. 
                Professional website design services India with cutting-edge tools and frameworks.
              </p>
            </div>
          ...
          <section id="case-studies" className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Real results from website design projects. Best website design company in Delhi NCR 
          ...
          <section id="approach" className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Proven methodology for website design success. Website design experts in Delhi NCR 
          ...
          <section id="faqs" className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Common questions about website design services. Best website design company in Delhi 
        ...
        <section className="bg-gradient-to-r from-purple-600 to-purple-800 text-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-purple-100 mb-8 max-w-3xl mx-auto">
              Best website design company in Delhi NCR offering comprehensive website design services. 
              Get started with professional website design services India today.
            </p>
