...
const ShopifyEcommerceDevelopment = () => {
  ...
  const seoConfig = {
    title: 'Shopify Ecommerce Development Services | MarkTech Rover',
    description:
      'High-converting Shopify stores with custom themes, performance optimization, and growth automations. Accelerate DTC revenue with expert Shopify development.',
    keywords: [
    ...
    tags: ['Shopify', 'Ecommerce', 'DTC', 'CRO'],
  ...
  const features = [
    {
      ...
      description: 'Optimized flows for browse, PDP, cart, and checkout',
      icon: <ShoppingCart className="h-8 w-8" />,
      color: 'from-emerald-500 to-green-500',
      benefits: ['CRO playbooks', 'AOV boosters', 'Trust signals', 'Checkout focus']
    },
    {
      id: 2,
      title: 'Custom Themes',
      description: 'Pixel-perfect, performant themes built for scale',
      icon: <Palette className="h-8 w-8" />,
      color: 'from-blue-500 to-cyan-500',
      benefits: ['Hydrogen & Liquid', 'Headless ready', 'Design systems', 'Performance tuned']
    },
    {
      id: 3,
      title: 'App Integrations',
      description: 'Martech, loyalty, subscriptions, and analytics that work together',
      icon: <Layers className="h-8 w-8" />,
      color: 'from-purple-500 to-violet-500',
      benefits: ['Subscriptions', 'Loyalty & rewards', 'CRM/CDP', 'Marketing automation']
    },
    {
      id: 4,
      title: 'Speed & Stability',
      description: 'Core Web Vitals excellence with observability and QA',
      icon: <Zap className="h-8 w-8" />,
      color: 'from-yellow-500 to-orange-500',
      benefits: ['CWV optimization', 'Image/CDN tuning', 'Automated tests', '24/7 monitoring']
    },
    {
      id: 5,
      title: 'Global & Multi-store',
      description: 'Markets, currencies, languages, and tax rules handled elegantly',
      icon: <Globe className="h-8 w-8" />,
      color: 'from-pink-500 to-rose-500',
      benefits: ['Markets setup', 'Multi-currency', 'Translations', 'Geo-routing']
    },
    {
      id: 6,
      title: 'Data & Growth',
      description: 'Analytics, A/B testing, and lifecycle automations',
      icon: <BarChart3 className="h-8 w-8" />,
      color: 'from-indigo-500 to-blue-500',
      benefits: ['Event taxonomy', 'A/B tests', 'Attribution setup', 'Lifecycle flows']
    }
  ];
  ...
  const processSteps = [
    {
      ...
      description: 'Review performance, tech, and opportunities for revenue lift',
      detailedDescription:
        'We analyze your current Shopify setup, conversions, speed, and integrations. Then we prioritize quick wins and foundational changes to unlock near-term revenue.',
      icon: <Search className="h-6 w-6" />,
      deliverables: ['Audit report', 'Revenue roadmap', 'CWV baseline', 'Integration plan'],
      duration: '1-2 weeks',
    ...
    {
      step: '02',
      title: 'UX & Theme Design',
      description: 'Design systems, PDPs, and checkout flows that convert',
      detailedDescription:
        'We craft modular Shopify UI components, design CRO-driven PDPs, and ensure brand-consistent experiences across devices with accessibility at the core.',
      icon: <PenTool className="h-6 w-6" />,
      deliverables: ['Design system', 'PDP/PLP mockups', 'Checkout UX', 'Content guidelines'],
      duration: '2-3 weeks',
    ...
    },
    {
      ...
      description: 'Build themes, apps, and integrations that scale',
      detailedDescription:
        'We develop performant Shopify themes, connect loyalty/subscription apps, configure markets, and set up analytics with automated QA for reliable releases.',
      icon: <Code className="h-6 w-6" />,
      deliverables: ['Custom theme', 'App integrations', 'Markets setup', 'Automated tests'],
      duration: '3-5 weeks',
    ...
    },
    {
      ...
      description: 'Staged rollout, experimentation, and lifecycle automations',
      detailedDescription:
        'We launch with feature flags, track every funnel step, run A/B tests, and implement lifecycle flows that keep customers engaged and buying again.',
      icon: <Rocket className="h-6 w-6" />,
      deliverables: ['Go-live plan', 'A/B tests', 'Lifecycle automations', 'Post-launch support'],
  ...
  const packages = [
    {
      ...
      price: '₹70,000',
      period: 'per month',
      description: 'Perfect for small businesses starting with Shopify',
      features: [
        { text: 'Basic Shopify setup', included: true },
        { text: 'Up to 100 products', included: true },
        { text: 'Standard theme', included: true },
        { text: 'Email support', included: true },
        { text: 'Basic payment integration', included: true },
        { text: 'Advanced customization', included: false },
        { text: 'Multi-store support', included: false },
    ...
    },
    {
      ...
      price: '₹1,80,000',
      period: 'per month',
      description: 'Comprehensive Shopify for growing businesses',
      features: [
        { text: 'Advanced Shopify setup', included: true },
        { text: 'Up to 500 products', included: true },
        { text: 'Custom theme', included: true },
        { text: 'Priority support', included: true },
        { text: 'Advanced payment integration', included: true },
    ...
    },
    {
      ...
      price: 'Custom',
      period: 'pricing',
      description: 'Full-featured Shopify for large organizations',
      features: [
        { text: 'Enterprise Shopify setup', included: true },
        { text: 'Unlimited products', included: true },
        { text: 'Custom design system', included: true },
        { text: '24/7 priority support', included: true },
        { text: 'All payment integrations', included: true },
        { text: 'Full customization', included: true },
        { text: 'Multi-store & international', included: true },
      ...
      <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-5xl mx-auto">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-purple-500/20 to-blue-500/20 border border-purple-500/30 backdrop-blur-sm mb-8">
                ...
                <span className="text-sm font-medium text-purple-200">Shopify Ecommerce Development</span>
              </div>

              <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-6 leading-tight">
                <span className="bg-gradient-to-r from-white via-purple-200 to-blue-200 bg-clip-text text-transparent">Hire Shopify Development Agency</span>
              </h1>

              <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
                Launch, optimize, and scale Shopify stores with custom themes, conversion-led UX, and integrations that accelerate DTC revenue.
              </p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
                {[
                  { value: '400+', label: 'Shopify Launches' },
                  { value: '35%', label: 'Avg. CVR Lift' },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
                Why Choose Our <span className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">Shopify Experts</span>?
              </h2>
              <p className="text-xl text-gray-400 max-w-3xl mx-auto">
                We combine CRO, design systems, and deep Shopify expertise to create lightning-fast stores that convert.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  title: 'Revenue Focus',
                  description: 'Every sprint targets conversion, AOV, and retention wins'
                },
                {
                  icon: <Users className="h-6 w-6" />,
                  title: 'UX that Sells',
                  description: 'Persuasive PDPs, frictionless checkout, and trust-driven design'
                },
                {
                  icon: <Zap className="h-6 w-6" />,
                  title: 'Speed Obsessed',
                  description: 'CWV excellence with robust QA and observability'
                }
              ].map((item, index) => (
                <div
                  key={index}
        ...
        <section id="features" className="py-20 bg-gradient-to-b from-transparent via-gray-900/50 to-transparent">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
                Revenue-Ready <span className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">Shopify Features</span>
              </h2>
              <p className="text-xl text-gray-400 max-w-3xl mx-auto">Built-in growth capabilities for modern DTC brands</p>
            </div>
        ...
        <section id="process" className="py-20 relative">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
                Our <span className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">Shopify Process</span>
              </h2>
              <p className="text-xl text-gray-400 max-w-3xl mx-auto">From audit to launch, every step drives revenue</p>
            </div>
                ...
                <div className="bg-gradient-to-r from-purple-900/20 to-blue-900/20 rounded-2xl p-6 border border-purple-500/20">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-green-400 font-semibold">+30% avg</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-gray-300">Avg. Order Value</span>
                      <span className="text-blue-400 font-semibold">+15% avg</span>
                    </div>
                    <div className="flex items-center justify-between">
        ...
        <section className="py-20 bg-gradient-to-b from-transparent via-gray-900/50 to-transparent">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
                Choose Your <span className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">Shopify Package</span>
              </h2>
              <p className="text-xl text-gray-400 max-w-3xl mx-auto">Plans tuned for launch, growth, and scale</p>
            </div>
        ...
        <section id="portfolio" className="py-20 relative">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
                Shopify <span className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">Success Stories</span>
              </h2>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              {
                title: 'DTC Apparel',
                description: 'CRO-driven redesign with loyalty and subscriptions',
                metrics: ['32% CVR Lift', '18% AOV Lift', '4 Months'],
                gradient: 'from-emerald-500 to-green-500'
              },
              {
                title: 'Beauty Brand',
                description: 'Headless storefront with personalized bundles',
                metrics: ['27% Revenue Lift', '40% Faster Load', '5 Months'],
                gradient: 'from-blue-500 to-cyan-500'
              },
              {
                title: 'Home Decor',
                description: 'Markets rollout with translations and multi-currency',
                metrics: ['3 Markets Live', '24% Intl. Revenue', '3 Months'],
                gradient: 'from-yellow-500 to-orange-500'
              },
              {
                title: 'Nutrition',
                description: 'Subscription-first flows with retention automations',
                metrics: ['29% LTV Lift', '22% Churn Reduction', '6 Months'],
        ...
        <section id="faqs" className="py-20 bg-gradient-to-b from-transparent via-gray-900/50 to-transparent">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-400">How we deliver high-performing Shopify stores</p>
            </div>
              ...
              {[
                {
                  ...
                  answer:
                    'Yes. We handle migrations from Magento, WooCommerce, and custom platforms. We preserve SEO, map redirects, and ensure data integrity for products, customers, and orders.'
                },
                {
                  question: 'Do you support subscriptions and loyalty?',
                  answer:
                    'Absolutely. We integrate leading subscription and loyalty apps, customize flows, and ensure they work seamlessly across checkout, accounts, and lifecycle campaigns.'
                },
                {
                  question: 'How do you improve store speed?',
                  answer:
                    'We optimize images, code-split, leverage CDN/edge, clean up apps, and measure Core Web Vitals. Automated testing and observability keep performance consistent post-launch.'
                },
                {
                  question: 'Can you handle internationalization?',
                  answer:
                    'Yes. We set up Shopify Markets, translations, multi-currency, tax rules, and geo-routing to deliver tailored experiences by market.'
                },
                {
                  question: 'Do you provide post-launch support?',
                  answer:
                    'We provide ongoing support, experimentation, and growth ops. Packages include SLA-backed maintenance, CRO sprints, and feature enhancements.'
                }
              ].map((faq, index) => (
                <div
                  key={index}
        ...
        <section className="py-20 relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">Ready to Grow Your Shopify Revenue?</h2>
            <p className="text-xl text-purple-100 mb-8 max-w-3xl mx-auto">
              Let’s design, build, and optimize a Shopify store that converts faster and scales confidently.
            </p>
