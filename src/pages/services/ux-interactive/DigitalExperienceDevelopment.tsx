...
const DigitalExperienceDevelopment = () => {
  ...
  const seoConfig = {
    title: "Digital Experience Development Services | MarkTechRover",
    description: "Professional digital experience development services. Expert solutions for your business needs. Get started today.",
    keywords: ["digital experience development","services","professional","expert","business"],
    url: "/services/ux-interactive/digital-experience-development",
    type: "website" as const,
    publishedAt: "2025-08-05T06:37:20.392Z",
    modifiedAt: "2025-08-05T06:37:20.392Z",
    author: "MarkTechRover",
    section: "Services",
    tags: ["digital experience development","services"],
    image: "/images/services/digital-experience-development.jpg"
  };

  const deliverables = [
    {
      id: 1,
      title: 'Custom digital-experience-development',
      description: 'Bespoke digital-experience-development tailored to your brand and business objectives',
      icon: <DesignIcon className="h-6 w-6" />,
      features: [
        'Custom digital-experience-development and layout',
    ...
    {
      id: 3,
      title: 'E-commerce digital-experience-development',
      description: 'Professional e-commerce digital-experience-development for online stores',
    ...
    },
    {
      ...
      description: 'digital-experience-development optimized for search engine visibility',
  ...
  const designPackages = [
    {
      name: 'Basic digital-experience-development',
      price: '₹45,000',
      period: 'one-time',
      description: 'Perfect for small businesses and startups',
      features: [
        '5-page custom digital-experience-development',
    ...
    {
      name: 'Professional digital-experience-development',
      price: '₹85,000',
      period: 'one-time',
      description: 'Comprehensive digital-experience-development for growing businesses',
      features: [
        '10-page custom digital-experience-development',
    ...
    {
      name: 'Enterprise digital-experience-development',
      price: '₹1,50,000',
      period: 'one-time',
      description: 'Full-featured digital-experience-development for large businesses',
      features: [
      ...
      <div className="min-h-screen ">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
            <div className="text-center">
              ...
              <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-white via-purple-100 to-white bg-clip-text text-transparent">
                digital-experience-development Services in Delhi
              </h1>
              
              <p className="text-xl md:text-2xl text-purple-200 mb-8 max-w-4xl mx-auto leading-relaxed">
                Best digital-experience-development company in Delhi NCR offering custom digital-experience-development. 
                Professional digital-experience-development services India with modern, responsive designs.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                ...
                >
                  ...
                  Get digital-experience-development Quote
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <section id="deliverables" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                digital-experience-development Deliverables
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Comprehensive digital-experience-development services designed for business growth. 
                Best digital-experience-development company in Delhi NCR delivering modern, responsive websites.
              </p>
            </div>
          ...
          <section id="packages" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                digital-experience-development Packages
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Comprehensive digital-experience-development solutions. Best digital-experience-development services in India with flexible packages 
          ...
          <section id="technology" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                digital-experience-development Technology
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Advanced digital-experience-development technology stack powering modern websites. 
                Professional digital-experience-development services India with cutting-edge tools and frameworks.
              </p>
            </div>
          ...
          <section id="case-studies" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                digital-experience-development Case Studies
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Real results from digital-experience-development projects. Best digital-experience-development company in Delhi NCR 
          ...
          <section id="approach" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                digital-experience-development Approach
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Proven methodology for digital-experience-development success. digital-experience-development experts in Delhi NCR 
          ...
          <section id="faqs" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                digital-experience-development FAQs
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Common questions about digital-experience-development services. Best digital-experience-development company in Delhi 
              ...
              {[
                {
                  ...
                  answer: 'digital-experience-development and development typically takes 4-8 weeks depending on complexity, number of pages, and features required. Simple websites can be completed in 2-3 weeks, while complex e-commerce or custom applications may take 8-12 weeks.'
                },
                {
                  question: 'What is the typical cost for digital-experience-development services?',
                  answer: 'digital-experience-development costs typically range from ₹45,000 to ₹1,50,000 depending on complexity, features, and scope of work. We provide detailed quotes based on your specific requirements and business goals.'
                },
                {
                ...
                },
                {
                  ...
                  answer: 'Yes, we work with businesses across India and internationally. Our digital-experience-development services are not limited by geography and can be delivered remotely with excellent results.'
                },
                {
                ...
                {
                  question: 'Do you provide SEO optimization with digital-experience-development?',
                  answer: 'Yes, we include basic SEO optimization with all digital-experience-development packages. This includes SEO-friendly URL structure, meta tags, schema markup, fast loading speed, mobile optimization, and other SEO best practices.'
                }
              ].map((faq, index) => (
        ...
        <section className="bg-gradient-to-r from-purple-600 to-purple-800 text-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-purple-100 mb-8 max-w-3xl mx-auto">
              Best digital-experience-development company in Delhi NCR offering comprehensive digital-experience-development services. 
              Get started with professional digital-experience-development services India today.
            </p>
