...
const WebVideoProduction = () => {
  ...
  const designPackages = [
    {
      name: 'Basic web-video-production',
      price: '₹45,000',
      period: 'one-time',
      description: 'Perfect for small businesses and startups',
      features: [
        '5-page custom web-video-production',
    ...
    {
      name: 'Professional web-video-production',
      price: '₹85,000',
      period: 'one-time',
      description: 'Comprehensive web-video-production for growing businesses',
      features: [
        '10-page custom web-video-production',
    ...
    {
      name: 'Enterprise web-video-production',
      price: '₹1,50,000',
      period: 'one-time',
      description: 'Full-featured web-video-production for large businesses',
      features: [
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
            <div className="text-center">
              ...
              <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-white via-purple-100 to-white bg-clip-text text-transparent">
                web-video-production Services in Delhi
              </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <section id="packages" className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Comprehensive web-video-production solutions. Best web-video-production services in India with flexible packages 
