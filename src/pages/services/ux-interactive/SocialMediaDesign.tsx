...
const SocialMediaDesign = () => {
  ...
  const seoConfig = {
    title: "Social Media Design Services | MarkTechRover",
    description: "Professional social media design services. Expert solutions for your business needs. Get started today.",
    keywords: ["social media design","services","professional","expert","business"],
  ...
  const deliverables = [
    {
      id: 1,
      title: 'Custom social-media-design',
      description: 'Bespoke social-media-design tailored to your brand and business objectives',
      icon: <DesignIcon className="h-6 w-6" />,
      features: [
        'Custom social-media-design and layout',
    ...
    {
      id: 3,
      title: 'E-commerce social-media-design',
      description: 'Professional e-commerce social-media-design for online stores',
    ...
    },
    {
      ...
      description: 'social-media-design optimized for search engine visibility',
  ...
  const designPackages = [
    {
      name: 'Basic social-media-design',
      price: '₹45,000',
      period: 'one-time',
      description: 'Perfect for small businesses and startups',
      features: [
        '5-page custom social-media-design',
    ...
    {
      name: 'Professional social-media-design',
      price: '₹85,000',
      period: 'one-time',
      description: 'Comprehensive social-media-design for growing businesses',
      features: [
        '10-page custom social-media-design',
    ...
    {
      name: 'Enterprise social-media-design',
      price: '₹1,50,000',
      period: 'one-time',
      description: 'Full-featured social-media-design for large businesses',
      features: [
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
            <div className="text-center">
              ...
              <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-white via-purple-100 to-white bg-clip-text text-transparent">
                social-media-design Services in Delhi
              </h1>
              
              <p className="text-xl md:text-2xl text-purple-200 mb-8 max-w-4xl mx-auto leading-relaxed">
                Best social-media-design company in Delhi NCR offering custom social-media-design. 
                Professional social-media-design services India with modern, responsive designs.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <section id="deliverables" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                social-media-design Deliverables
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Comprehensive social-media-design services designed for business growth. 
                Best social-media-design company in Delhi NCR delivering modern, responsive websites.
              </p>
            </div>
          ...
          <section id="packages" className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Comprehensive social-media-design solutions. Best social-media-design services in India with flexible packages 
          ...
          <section id="technology" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                social-media-design Technology
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Advanced social-media-design technology stack powering modern websites. 
                Professional social-media-design services India with cutting-edge tools and frameworks.
              </p>
            </div>
          ...
          <section id="case-studies" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                social-media-design Case Studies
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Real results from social-media-design projects. Best social-media-design company in Delhi NCR 
          ...
          <section id="approach" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                social-media-design Approach
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Proven methodology for social-media-design success. social-media-design experts in Delhi NCR 
          ...
          <section id="faqs" className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Common questions about social-media-design services. Best social-media-design company in Delhi 
              ...
              {[
                {
                  ...
                  answer: 'social-media-design and development typically takes 4-8 weeks depending on complexity, number of pages, and features required. Simple websites can be completed in 2-3 weeks, while complex e-commerce or custom applications may take 8-12 weeks.'
                },
                {
                  question: 'What is the typical cost for social-media-design services?',
                  answer: 'social-media-design costs typically range from ₹45,000 to ₹1,50,000 depending on complexity, features, and scope of work. We provide detailed quotes based on your specific requirements and business goals.'
                },
                {
                ...
                },
                {
                  ...
                  answer: 'Yes, we work with businesses across India and internationally. Our social-media-design services are not limited by geography and can be delivered remotely with excellent results.'
                },
                {
                ...
                {
                  question: 'Do you provide SEO optimization with social-media-design?',
                  answer: 'Yes, we include basic SEO optimization with all social-media-design packages. This includes SEO-friendly URL structure, meta tags, schema markup, fast loading speed, mobile optimization, and other SEO best practices.'
                }
              ].map((faq, index) => (
        ...
        <section className="bg-gradient-to-r from-purple-600 to-purple-800 text-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-purple-100 mb-8 max-w-3xl mx-auto">
              Best social-media-design company in Delhi NCR offering comprehensive social-media-design services. 
              Get started with professional social-media-design services India today.
            </p>
