      ...
      <div id="packages">
        <section className="py-20 bg-gray-900">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Revenue Marketing & CRO Packages
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Choose the perfect marketing solution for your business
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-gray-800 border border-gray-700 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-purple-300 mb-4">Starter CRO</h3>
                <p className="text-gray-300 mb-4">Basic conversion optimization</p>
              </div>
              <div className="bg-gray-800 border border-gray-700 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-purple-300 mb-4">Professional CRO</h3>
                <p className="text-gray-300 mb-4">Comprehensive optimization</p>
              </div>
              <div className="bg-gray-800 border border-gray-700 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-purple-300 mb-4">Enterprise CRO</h3>
                <p className="text-gray-300 mb-4">Full-scale optimization</p>
              </div>
            </div>
          </div>
        </section>
