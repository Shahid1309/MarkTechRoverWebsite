...
const RevenueOperations = () => {
  ...
  const navItems = [
    { id: 'deliverables', label: 'Deliverables', icon: <CheckCircle className="h-4 w-4" /> },{ id: 'technology', label: 'Revenue Operations Technology', icon: <Cpu className="h-4 w-4" /> },
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 transition-all duration-1000">
              Hire RevOps Consulting Services
            </h1>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Comprehensive revenue operations solutions designed for business growth. 
                  Best RevOps agency in Delhi NCR delivering measurable results.
                </p>
              </div>
                  ...
                  >
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-purple-300 text-sm">RevOps Service</p>
                      </div>
                    </div>
