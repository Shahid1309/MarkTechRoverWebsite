...
const AccountBasedMarketing = () => {
  ...
  const seoConfig = {
    ...
    keywords: [
      'Account-Based Marketing Services Delhi', 'Best ABM agency in Delhi', 'ABM services NCR', 'Best ABM services in India', 'Professional ABM services India', 'ABM experts in Delhi NCR', 'ABM company India', 'SEO services in Delhi', 'Account-based marketing Delhi', 'ABM India'
    ],
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-4xl mx-auto transition-all duration-1000 delay-300">
              Professional account based marketing services in Delhi NCR. Get expert account based marketing solutions with proven results and ROI.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center transition-all duration-1000 delay-1000">
              ...
              >
                <span className="relative z-10">Get Free Account Based Marketing Consultation</span>
