...
const ChannelAttribution = () => {
  ...
  const navItems = [
    { id: 'deliverables', label: 'Deliverables', icon: <CheckCircle className="h-4 w-4" /> },{ id: 'technology', label: 'Channel Attribution & Forecasting Technology', icon: <Cpu className="h-4 w-4" /> },
    { id: 'case-studies', label: 'Channel Attribution & Forecasting Case Studies', icon: <Trophy className="h-4 w-4" /> },
    { id: 'approach', label: 'Channel Attribution & Forecasting Approach', icon: <Rocket className="h-4 w-4" /> },
  ...
  const seoConfig = {
    ...
    keywords: [
      'Channel Attribution & Forecasting Delhi', 'Best attribution agency in Delhi', 'Channel attribution services NCR', 'Best channel attribution services in India', 'Professional attribution services India', 'Channel attribution experts in Delhi NCR', 'Attribution company India', 'SEO services in Delhi', 'Multi-channel attribution Delhi', 'Channel attribution India'
    ],
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 transition-all duration-1000">
              Hire Marketing Attribution Services
            </h1>

            {/* Animated Description */}
            <p className="text-xl text-gray-300 mb-8 max-w-4xl mx-auto transition-all duration-1000 delay-300">
              Professional channel attribution services in Delhi NCR. Get expert channel attribution solutions with proven results and ROI.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center transition-all duration-1000 delay-1000">
              ...
              >
                <span className="relative z-10">Get Free Channel Attribution Consultation</span>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Comprehensive channel attribution and forecasting solutions designed for business growth. 
                  Best attribution agency in Delhi NCR delivering measurable results.
                </p>
              </div>
                  ...
                  >
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-purple-300 text-sm">Attribution Service</p>
                      </div>
                    </div>
          ...
          <section id="technology" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                Channel Attribution & Forecasting Technology
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
          ...
          <section id="case-studies" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent via-purple-900/10 to-transparent">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Real results from our Channel Attribution campaigns. See how we've transformed businesses 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {[
                  {
                    title: 'Multi-Channel Attribution Success',
                    description: 'Transformed a business with strategic channel attribution and optimization',
                    metrics: [
                      { label: 'Attribution Accuracy', value: '300%', icon: <TrendingUp className="h-5 w-5" />, color: 'from-green-500 to-emerald-600' },
                  ...
                  {
                    title: 'Revenue Attribution Growth',
                    description: 'Scaled revenue attribution and improved conversion tracking significantly',
                    metrics: [
                      { label: 'Revenue Visibility', value: '500%', icon: <TrendingUp className="h-5 w-5" />, color: 'from-green-500 to-emerald-600' },
                  ...
                  {
                    title: 'Channel Performance Expansion',
                    description: 'Dramatically increased channel insights and revenue through optimized attribution',
                    metrics: [
                      { label: 'Channel Insights', value: '400%', icon: <BarChart3 className="h-5 w-5" />, color: 'from-blue-500 to-indigo-600' },
                  ...
                  {
                    title: 'Attribution Modeling Success',
                    description: 'Achieved record attribution accuracy and customer insights rates',
                    metrics: [
                      { label: 'Model Accuracy', value: '600%', icon: <Activity className="h-5 w-5" />, color: 'from-purple-500 to-violet-600' },
          ...
          <section id="approach" className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
              <div className="text-center mb-16">
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
                  Our Proven Attribution Approach
                </h2>
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  A systematic methodology designed to maximize your channel attribution ROI. 
                  ...
                  {[
                    {
                      ...
                      description: 'Integrate all marketing channels and data sources for comprehensive attribution',
                      icon: <Target className="h-6 w-6" />,
                    ...
                    },
                    {
                      ...
                      description: 'Build and deploy advanced attribution models to track customer journeys',
                      icon: <Rocket className="h-6 w-6" />,
                    ...
                    },
                    {
                      ...
                      description: 'Analyze channel performance and generate actionable attribution insights',
                      icon: <TrendingUp className="h-6 w-6" />,
                    ...
                    },
                    {
                      ...
                      description: 'Continuously optimize attribution models and scale successful channels',
          ...
          <section id="faqs" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent via-purple-900/10 to-transparent">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-4">
                {[
                  {
                    question: 'What is Channel Attribution and how does it work?',
                    answer: 'Channel Attribution is the process of identifying which marketing channels and touchpoints contribute to conversions and revenue. We use advanced attribution models (first-touch, last-touch, multi-touch, data-driven) to track customer journeys across all channels, giving you accurate insights into which marketing efforts are driving results. This helps you optimize budget allocation and improve ROI.'
                  },
                  {
                    question: 'How long does it take to set up channel attribution?',
                    answer: 'The setup process typically takes 2-4 weeks depending on the complexity of your marketing stack and number of channels. We handle data integration, model configuration, dashboard setup, and team training. Our team ensures seamless integration with all your marketing platforms and provides comprehensive documentation.'
                  },
                  {
                    question: 'What is the typical investment for Channel Attribution services?',
                    answer: 'Channel Attribution services typically range from ₹60,000 to ₹2,00,000 per month depending on the number of channels, data volume, attribution model complexity, and reporting requirements. We provide custom quotes based on your specific marketing stack, attribution needs, and growth goals. Most businesses see ROI within the first 2-3 months.'
                  },
                  {
                    question: 'Do you work with businesses outside Delhi NCR?',
                    answer: 'Yes, we work with businesses across India and internationally. Our Channel Attribution services are cloud-based and can be delivered remotely with excellent results. We have experience working with businesses in Mumbai, Bangalore, Chennai, Hyderabad, and other major cities, as well as international clients.'
                  },
                  {
                    question: 'How do you measure Channel Attribution success?',
                    answer: 'We track comprehensive KPIs including attribution accuracy, channel performance, conversion paths, revenue attribution, budget optimization impact, and overall ROI. We provide detailed monthly reports with actionable insights, channel recommendations, and optimization strategies. Our dashboards give you real-time visibility into attribution performance.'
                  },
                  {
                    question: 'What attribution models do you support?',
                    answer: 'We support all major attribution models including first-touch, last-touch, linear, time-decay, position-based, and data-driven attribution. We help you choose the right model based on your business model, sales cycle, and marketing goals. We can also create custom attribution models tailored to your specific needs.'
                  },
                  {
                    question: 'Can attribution integrate with my existing marketing tools?',
                    answer: 'Absolutely! We integrate with all major marketing platforms including Google Analytics, Facebook Ads, LinkedIn Ads, email marketing tools, CRM systems, and custom solutions. Integration ensures seamless data flow and accurate attribution across all channels. We handle the entire integration process and ensure your systems are updated in real-time.'
                  },
                  {
                    question: 'How does attribution help optimize marketing spend?',
                    answer: 'Attribution shows you exactly which channels and campaigns are driving conversions and revenue, allowing you to reallocate budget from underperforming channels to high-performing ones. This typically results in 20-40% improvement in marketing ROI. We provide ongoing optimization recommendations based on attribution insights to continuously improve your marketing efficiency.'
                  }
                ].map((faq, index) => (
                  <div
                    key={index}
