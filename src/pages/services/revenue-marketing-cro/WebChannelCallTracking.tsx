...
const WebChannelCallTracking = () => {
  ...
  const seoConfig = {
    ...
    keywords: [
      'Web Channel Call Tracking Delhi', 'Best call tracking agency in Delhi', 'Call tracking services NCR', 'Best call tracking services in India', 'Professional call tracking services India', 'Call tracking experts in Delhi NCR', 'Call tracking company India', 'SEO services in Delhi', 'Call tracking Delhi', 'Web channel tracking India'
    ],
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-4xl mx-auto transition-all duration-1000 delay-300">
              Track and optimize every call from your digital marketing campaigns. Get complete visibility into your call attribution and ROI with our advanced call tracking solutions.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center transition-all duration-1000 delay-1000">
              ...
              >
                <span className="relative z-10">Get Free Call Tracking Consultation</span>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive web channel call tracking solutions designed for business growth. 
              Best call tracking agency in Delhi NCR delivering measurable results.
            </p>
          </div>
              ...
              >
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-purple-300 text-sm">Call Tracking Service</p>
                  </div>
                </div>
...
export default WebChannelCallTracking; 