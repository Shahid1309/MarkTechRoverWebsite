...
const UXTesting = () => {
  ...
  const navItems = [
    ...
    { id: 'packages', label: 'User Experience Testing Packages', icon: <DollarSign className="h-4 w-4" /> },
    { id: 'technology', label: 'User Experience Testing Technology', icon: <Cpu className="h-4 w-4" /> },
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 transition-all duration-1000">
              Marktechrover: Best <span className="bg-gradient-to-r from-purple-300 via-purple-400 to-purple-500 bg-clip-text text-transparent font-extrabold">U X Testing</span> in Delhi, NCR & India
            </h1>
      ...
      <div className={`fixed left-1/2 transform -translate-x-1/2 z-50 transition-all duration-500 ${isNavSticky ? 'top-32 opacity-100 scale-100' : 'top-0 opacity-0 scale-95 pointer-events-none'}`}>
        ...
        <div className="relative">
          ...
          <section id="deliverables" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                User Experience Testing Deliverables
              </h2>
          ...
          <section id="case-studies" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                User Experience Testing Case Studies
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
