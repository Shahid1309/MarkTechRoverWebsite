...
const UXTesting = () => {
  ...
  const navItems = [
    { id: 'deliverables', label: 'Deliverables', icon: <CheckCircle className="h-4 w-4" /> },{ id: 'technology', label: 'User Experience Testing Technology', icon: <Cpu className="h-4 w-4" /> },
    { id: 'case-studies', label: 'User Experience Testing Case Studies', icon: <Trophy className="h-4 w-4" /> },
    { id: 'approach', label: 'User Experience Testing Approach', icon: <Rocket className="h-4 w-4" /> },
  ...
  const seoConfig = {
    ...
    keywords: [
      'User Experience Testing Delhi', 'Best UX testing agency in Delhi', 'UX testing services NCR', 'Best UX testing services in India', 'Professional UX testing services India', 'UX testing experts in Delhi NCR', 'UX testing company India', 'SEO services in Delhi', 'UX testing Delhi', 'User experience testing India'
    ],
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 transition-all duration-1000">
              Hire UX Testing Services
            </h1>

            {/* Animated Description */}
            <p className="text-xl text-gray-300 mb-8 max-w-4xl mx-auto transition-all duration-1000 delay-300">
              Professional u x testing services in Delhi NCR. Get expert u x testing solutions with proven results and ROI.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center transition-all duration-1000 delay-1000">
              ...
              >
                <span className="relative z-10">Get Free U X Testing Consultation</span>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Comprehensive UX testing solutions designed for business growth. 
                  Best UX testing agency in Delhi NCR delivering measurable results.
                </p>
              </div>
                  ...
                  >
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-purple-300 text-sm">UX Testing Service</p>
                      </div>
                    </div>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-4xl font-bold text-white mb-4">
                  User Experience Testing Technology
                </h2>
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  The research, analytics, and testing stack we use to uncover friction, validate ideas, and improve
                  user journeys across devices.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    description: 'Seeing exactly how users interact with your experience.',
                    icon: <Eye className="h-8 w-8" />,
                    features: [
                      'Session Recordings & Heatmaps',
                      'Click & Scroll Tracking',
                      'Rage Click & Error Detection',
                      'Form & Funnel Drop-off Analysis',
                      'Device & Browser Breakdown',
                    ],
                  },
                  {
                    title: 'User Research Tools',
                    description: 'Gathering direct feedback from real users.',
                    icon: <Users className="h-8 w-8" />,
                    features: [
                      'Remote User Testing Platforms',
                      'On-site Surveys & Polls',
                      'Task-based UX Tests',
                      'Panel & Audience Recruitment',
                      'Interview & Insight Libraries',
                    ],
                  },
                  {
                    title: 'Design & Prototyping',
                    description: 'Quickly visualizing and iterating on better experiences.',
                    icon: <PenTool className="h-8 w-8" />,
                    features: [
                      'High-fidelity Prototypes',
                      'Interactive Flows & Micro-interactions',
                      'Design Systems & Components',
                      'Collaboration with Product & Dev',
                      'Versioning & Feedback Loops',
                    ],
                  },
                  {
                    title: 'A/B & UX Experiments',
                    description: 'Testing UX changes before making permanent decisions.',
                    icon: <Target className="h-8 w-8" />,
                    features: [
                      'A/B & Multivariate UX Tests',
                      'Layout & Navigation Experiments',
                      'Copy & Visual Variations',
                      'Experiment Tracking & Logs',
                      'Impact & Learnings Repositories',
                    ],
                  },
                  {
                    title: 'Performance & Accessibility',
                    description: 'Ensuring UX is fast, accessible, and inclusive.',
                  ...
                  },
                  {
                    ...
                    description: 'Making UX findings easy to consume and act on.',
                    icon: <BarChart3 className="h-8 w-8" />,
                    features: [
                      'UX Dashboards & Scorecards',
                      'Stakeholder Summary Reports',
                      'Prioritized UX Backlogs',
                      'Roadmap & Initiative Tracking',
                      'Regular UX Review Rituals',
                    ],
                  },
                ].map((tech, index) => (
                  <div
          ...
          >
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Real results from our UX testing and experimentation programs. See how better experiences turned into
                  measurable growth.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {[
                  {
                    title: 'Checkout Friction Fix',
                    description:
                      'Reduced friction in a multi-step ecommerce checkout with focused UX testing and iteration.',
                    metrics: [
                      {
                  ...
                  },
                  {
                    ...
                    description:
                      'Ran moderated tests and in-product experiments to simplify onboarding for a B2B SaaS product.',
                    metrics: [
                      {
                        label: 'Time-to-Value',
                        value: '-35%',
                    ...
                    highlight: 'Product Adoption',
                    gradient: 'from-blue-600/20 to-indigo-600/20',
                  },
                  {
                    title: 'Mobile UX Improvements',
                    description:
                      'Optimized a mobile-heavy experience with device-specific UX tests and design updates.',
                    metrics: [
                      {
                  ...
                  {
                    title: 'Lead Form Simplification',
                    description:
                      'Used UX testing to simplify complex lead forms without hurting lead quality for a B2B services brand.',
                    metrics: [
                      {
          ...
          >
            ...
            <div className="max-w-7xl mx-auto relative z-10">
              <div className="text-center mb-16">
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
                  Our Proven UX Testing Approach
                </h2>
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  A practical, test-first methodology that turns user struggles into clear, prioritized UX improvements.
                </p>
              </div>
                  ...
                  {[
                    {
                      ...
                      description:
                        'Clarify key journeys, target users, and primary friction points to investigate through UX tests.',
                      icon: <Search className="h-6 w-6" />,
                      color: 'from-blue-500 to-blue-600',
                    },
                    {
                      step: '02',
                      title: 'Plan & Design Tests',
                      description:
                        'Select the right methods (moderated, unmoderated, in-product) and design tasks, scripts, and hypotheses.',
                    ...
                    },
                    {
                      ...
                      title: 'Run & Analyze',
                      description:
                        'Execute tests, capture qualitative and quantitative insights, and synthesize patterns across sessions.',
                      icon: <Activity className="h-6 w-6" />,
                      color: 'from-green-500 to-green-600',
                    },
                    {
                      step: '04',
                      title: 'Prioritize & Iterate',
                      description:
                        'Turn findings into prioritized changes, collaborate with design and dev, and re-test high-impact areas.',
          ...
          >
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Everything you need to know about UX testing, user research, and how we run experiments.
                </p>
              </div>
              ...
              <div className="space-y-4">
                {[
                  {
                    question: 'What is UX testing and how is it different from analytics?',
                    answer:
                      'Analytics tells you what is happening (for example, where users drop off), while UX testing shows you why it is happening by watching real people use your product. We use methods like moderated tests, unmoderated tasks, and in-product experiments to uncover friction, confusion, and missed opportunities that numbers alone cannot explain.',
                  },
                  {
                    question: 'How long does a UX testing engagement take?',
                    answer:
                      'A focused UX test cycle can be completed in 3–4 weeks including planning, recruiting, running tests, analysis, and presenting findings. Larger programs that cover multiple journeys or products may run over several months with iterative testing rounds. We define scope and timelines clearly based on your priorities and release cycles.',
                  },
                  {
                    question: 'What is the typical investment for UX testing services?',
                    answer:
                      'UX testing and research engagements typically range from ₹40,000 to ₹1,50,000 per month depending on the number of journeys, participant volume, testing methods, and depth of analysis. We can run one-time studies or set up ongoing research programs that support continuous product and CRO work.',
                  },
                  {
                    question: 'Do you help with implementation of UX recommendations?',
                    answer:
                      'Yes. We can work directly with your product, design, and engineering teams to translate findings into design updates, prototypes, and production changes. If you already have internal designers or developers, we collaborate and provide prioritized backlogs, specs, and UX guidance to speed up implementation.',
                  },
                  {
                    question: 'Can we test prototypes or only live products?',
                    answer:
                      'We can do both. Testing prototypes early helps you avoid expensive mistakes and validate directions before investing in full builds. Testing live experiences helps you understand real-world behavior and prioritize incremental improvements. Often, we combine both approaches as part of a UX and CRO program.',
                  },
                  {
                    question: 'How do you recruit participants for UX tests?',
                    answer:
                      'We can work with your existing users and customers or recruit from external panels that match your target profiles. Screening criteria, incentives, and logistics are handled as part of our process. We make sure participants are close to your real buyers, not just generic testers.',
                  },
                  {
                    question: 'Will UX testing slow down our roadmap?',
                    answer:
                      'Done properly, UX testing de-risks and accelerates your roadmap by giving you evidence on what will or won’t work. We design studies to fit into your sprint cycles and decision points so you have insights ready when it is time to commit to designs or features.',
                  },
                  {
                    question: 'How do you present UX findings to stakeholders?',
                    answer:
                      'We provide concise summaries with video clips, annotated screenshots, priority issues, and clear recommendations. Stakeholders get both quick takeaways and deeper detail if they want to dive in. We can present findings live to your team and leave behind structured documentation for future reference.',
                  },
                ].map((faq, index) => (
                  <div
                    key={index}
