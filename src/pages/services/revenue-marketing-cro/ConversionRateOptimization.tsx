...
const ConversionRateOptimization = () => {
  ...
  const navItems = [
    { id: 'deliverables', label: 'Deliverables', icon: <CheckCircle className="h-4 w-4" /> },{ id: 'technology', label: 'Conversion Rate Optimization Technology', icon: <Cpu className="h-4 w-4" /> },
    { id: 'case-studies', label: 'Conversion Rate Optimization Case Studies', icon: <Trophy className="h-4 w-4" /> },
    { id: 'approach', label: 'Conversion Rate Optimization Approach', icon: <Rocket className="h-4 w-4" /> },
  ...
  const seoConfig = {
    ...
    keywords: [
      'Conversion Rate Optimization Delhi', 'Best CRO agency in Delhi', 'CRO services NCR', 'Best CRO services in India', 'Professional CRO services India', 'CRO experts in Delhi NCR', 'CRO company India', 'SEO services in Delhi', 'Conversion optimization Delhi', 'CRO India'
    ],
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-4xl mx-auto transition-all duration-1000 delay-300">
              Professional conversion rate optimization services in Delhi NCR. Get expert conversion rate optimization solutions with proven results and ROI. Pair CRO with our <Link to="/services/seo-lead-generation/seo-services" className="text-purple-300 hover:text-purple-200 underline">SEO services</Link> to maximize both traffic and conversions.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center transition-all duration-1000 delay-1000">
              ...
              >
                <span className="relative z-10">Get Free Conversion Rate Optimization Consultation</span>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Comprehensive conversion rate optimization solutions designed for business growth. 
                  Best CRO agency in Delhi NCR delivering measurable results.
                </p>
              </div>
                  ...
                  >
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-purple-300 text-sm">CRO Service</p>
                      </div>
                    </div>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-4xl font-bold text-white mb-4">
                  Conversion Rate Optimization Technology
                </h2>
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  The experimentation, analytics, and UX stack we use to diagnose friction and unlock conversion wins
                  across your funnels.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    description: 'Understanding how visitors behave before and after they convert.',
                    ...
                    features: [
                      ...
                      'Custom CRO Dashboards',
                    ],
                  },
                  {
                    title: 'Experimentation & A/B Testing',
                    description: 'Safely testing ideas to see what truly lifts conversions.',
                    icon: <Target className="h-8 w-8" />,
                    features: [
                      'A/B & Multivariate Testing Platforms',
                      'Split URL & Feature Tests',
                      'Experiment Design Frameworks',
                      'Statistical Significance Guardrails',
                      'Test Result Libraries',
                    ],
                  },
                  {
                    title: 'User Research & UX Insights',
                    description: 'Seeing your site through your visitors’ eyes.',
                    icon: <Eye className="h-8 w-8" />,
                    features: [
                      'Session Recordings & Heatmaps',
                      'On-site Surveys & Polls',
                      'User Testing & Interviews',
                      'Form & Checkout Analysis',
                      'Qualitative Insight Repositories',
                    ],
                  },
                  {
                    title: 'Personalization & Messaging',
                    description: 'Tailoring copy and experiences to segments and intent.',
                    icon: <MessageSquare className="h-8 w-8" />,
                    features: [
                      'Dynamic Content Blocks',
                      'Audience & Segment Targeting',
                      'Headline & Offer Testing',
                      'Geo & Device Personalization',
                      'Experiment-led Copy Libraries',
                    ],
                  },
                  {
                    title: 'Performance & UX',
                    description: 'Technical foundations that keep experiences fast and smooth.',
                    icon: <Cpu className="h-8 w-8" />,
                    features: [
                      'Core Web Vitals Monitoring',
                      'Page Speed Tooling',
                      'UX & Accessibility Audits',
                      'Error & Drop-off Monitoring',
                      'Release & Change Tracking',
                    ],
                  },
                  {
                    title: 'Collaboration & Roadmapping',
                    description: 'Keeping CRO work visible, prioritized, and aligned with growth.',
                    icon: <Users className="h-8 w-8" />,
                    features: [
                      'Hypothesis & Idea Backlogs',
                      'Prioritization Frameworks (ICE, PIE, etc.)',
          ...
          <section id="case-studies" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent via-purple-900/10 to-transparent">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Real results from our Conversion Rate Optimization campaigns. See how we've transformed businesses 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {[
                  {
                    title: 'E-commerce Conversion Success',
                    description: 'Transformed an online store with strategic CRO optimization and A/B testing',
                    metrics: [
                      { label: 'Conversion Rate', value: '300%', icon: <TrendingUp className="h-5 w-5" />, color: 'from-green-500 to-emerald-600' },
                  ...
                  },
                  {
                    ...
                    description: 'Scaled sign-ups and improved conversion rates significantly through optimization',
                    metrics: [
                      { label: 'Sign-up Rate', value: '500%', icon: <TrendingUp className="h-5 w-5" />, color: 'from-green-500 to-emerald-600' },
                  ...
                  },
                  {
                    ...
                    description: 'Dramatically increased form completions and revenue through optimized funnels',
                    metrics: [
                      { label: 'Form Completions', value: '400%', icon: <Phone className="h-5 w-5" />, color: 'from-blue-500 to-indigo-600' },
                  ...
                  {
                    title: 'B2B Conversion Success',
                    description: 'Achieved record conversions and customer acquisition rates',
                    metrics: [
                      { label: 'Conversions', value: '600%', icon: <Calendar className="h-5 w-5" />, color: 'from-purple-500 to-violet-600' },
          ...
          <section id="approach" className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
              <div className="text-center mb-16">
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
                  Our Proven CRO Approach
                </h2>
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  A systematic methodology designed to maximize your conversion rates. 
                  From analysis to optimization, we guide you through every step.
                </p>
              </div>
                  ...
                  {[
                    {
                      ...
                      description: 'Complete conversion funnel analysis, user behavior research, and opportunity identification',
                      icon: <Target className="h-6 w-6" />,
                    ...
                    },
                    {
                      ...
                      description: 'Develop optimization strategies and launch A/B tests across key conversion points',
                      icon: <Rocket className="h-6 w-6" />,
                    ...
                    },
                    {
                      ...
                      description: 'Implement winning variations and optimize user experience for maximum conversions',
                      icon: <TrendingUp className="h-6 w-6" />,
                    ...
                    },
                    {
                      ...
                      description: 'Continuously monitor, test, and optimize to scale successful improvements',
          ...
          <section id="faqs" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent via-purple-900/10 to-transparent">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-4">
                {[
                  {
                    question: 'What is Conversion Rate Optimization and how does it work?',
                    answer: 'Conversion Rate Optimization (CRO) is the systematic process of improving your website or landing page to increase the percentage of visitors who take desired actions, such as making a purchase, filling out a form, or signing up. We use data-driven analysis, A/B testing, user behavior research, and strategic improvements to identify and fix conversion barriers, ultimately increasing your revenue without necessarily increasing traffic.'
                  },
                  {
                    question: 'How long does it take to see CRO results?',
                    answer: 'Initial improvements can be seen within 2-4 weeks, but comprehensive CRO programs typically show significant results within 3-6 months. The timeline depends on your traffic volume, conversion goals, and the complexity of changes needed. We provide monthly progress reports and can often implement quick wins that show immediate improvements while working on longer-term optimizations.'
                  },
                  {
                    question: 'What is the typical investment for CRO services?',
                    answer: 'CRO services typically range from ₹45,000 to ₹1,50,000 per month depending on your website complexity, traffic volume, testing requirements, and optimization goals. We provide custom quotes based on your specific business needs, current conversion rates, and growth objectives. Most businesses see ROI within the first 3 months.'
                  },
                  {
                    question: 'Do you work with businesses outside Delhi NCR?',
                    answer: 'Yes, we work with businesses across India and internationally. Our CRO services are delivered remotely with excellent results. We have experience working with businesses in Mumbai, Bangalore, Chennai, Hyderabad, and other major cities, as well as international clients.'
                  },
                  {
                    question: 'How do you measure CRO success?',
                    answer: 'We track comprehensive KPIs including conversion rate improvements, revenue per visitor, cost per acquisition, A/B test results, user engagement metrics, and overall ROI. We provide detailed monthly reports with actionable insights, test results, and optimization recommendations. Our dashboards give you real-time visibility into conversion performance.'
                  },
                  {
                    question: 'What types of websites can benefit from CRO?',
                    answer: 'Virtually any website can benefit from CRO including e-commerce stores, SaaS platforms, lead generation sites, B2B websites, service businesses, and content sites. We customize our approach based on your business model, industry, and conversion goals. Whether you want to increase sales, sign-ups, downloads, or inquiries, CRO can help.'
                  },
                  {
                    question: 'Do you provide A/B testing services?',
                    answer: 'Yes, A/B testing is a core component of our CRO services. We design, implement, and analyze A/B tests to validate optimization hypotheses. We use industry-leading testing tools and statistical analysis to ensure test results are reliable and actionable. All tests are designed to provide clear insights into what works best for your audience.'
                  },
                  {
                    question: 'Can CRO work alongside my existing marketing campaigns?',
                    answer: 'Absolutely! CRO complements all marketing channels by improving the effectiveness of traffic you\'re already generating. When combined with PPC, SEO, social media, or email marketing, CRO multiplies your ROI by converting more of your existing visitors. We integrate CRO insights with your marketing strategy to create a comprehensive growth system.'
                  }
                ].map((faq, index) => (
                  <div
                    key={index}
