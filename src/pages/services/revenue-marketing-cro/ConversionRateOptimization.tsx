...
const ConversionRateOptimization = () => {
  ...
  const navItems = [
    ...
    { id: 'packages', label: 'Conversion Rate Optimization Packages', icon: <DollarSign className="h-4 w-4" /> },
    { id: 'technology', label: 'Conversion Rate Optimization Technology', icon: <Cpu className="h-4 w-4" /> },
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 transition-all duration-1000">
              Marktechrover: Best <span className="bg-gradient-to-r from-purple-300 via-purple-400 to-purple-500 bg-clip-text text-transparent font-extrabold">Conversion Rate Optimization</span> in Delhi, NCR & India
            </h1>

            {/* Animated Description */}
            <p className="text-xl text-gray-300 mb-8 max-w-4xl mx-auto transition-all duration-1000 delay-300">
              Professional conversion rate optimization services in Delhi NCR. Get expert conversion rate optimization solutions with proven results and ROI.
            </p>
          ...
          <section id="deliverables" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                Conversion Rate Optimization Deliverables
              </h2>
