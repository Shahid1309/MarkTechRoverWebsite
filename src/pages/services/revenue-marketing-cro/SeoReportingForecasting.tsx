...
const SeoReportingForecasting = () => {
  ...
  const navItems = [
    { id: 'deliverables', label: 'Deliverables', icon: <CheckCircle className="h-4 w-4" /> },{ id: 'technology', label: 'SEO Reporting & Forecasting Technology', icon: <Cpu className="h-4 w-4" /> },
    { id: 'case-studies', label: 'SEO Reporting & Forecasting Case Studies', icon: <Trophy className="h-4 w-4" /> },
    { id: 'approach', label: 'SEO Reporting & Forecasting Approach', icon: <Rocket className="h-4 w-4" /> },
  ...
  const seoConfig = {
    ...
    keywords: [
      'SEO Reporting & Forecasting Delhi', 'Best SEO reporting agency in Delhi', 'SEO reporting services NCR', 'Best SEO reporting services in India', 'Professional SEO reporting services India', 'SEO reporting experts in Delhi NCR', 'SEO reporting company India', 'SEO services in Delhi', 'SEO forecasting Delhi', 'SEO analytics India'
    ],
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 transition-all duration-1000">
              Hire SEO Reporting Services
            </h1>

            {/* Animated Description */}
            <p className="text-xl text-gray-300 mb-8 max-w-4xl mx-auto transition-all duration-1000 delay-300">
              Professional seo reporting forecasting services in Delhi NCR. Get expert seo reporting forecasting solutions with proven results and ROI.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center transition-all duration-1000 delay-1000">
              ...
              >
                <span className="relative z-10">Get Free Seo Reporting Forecasting Consultation</span>
        ...
        <div className="relative">
          ...
          <section id="deliverables" className="py-20 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Comprehensive SEO reporting and forecasting solutions designed for business growth. 
                  Best SEO analytics agency in Delhi NCR delivering measurable results.
              </p>
            </div>
                  ...
                  >
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-purple-300 text-sm">SEO Reporting Service</p>
                      </div>
                    </div>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-4xl font-bold text-white mb-4">
                  SEO Reporting & Forecasting Technology
                </h2>
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  The toolkit we use to connect rankings, traffic, and revenue forecasts. 
                  Clean data, connected sources, and clear reporting you can trust.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    description: 'Foundation for trustworthy SEO reporting and forecasting.',
                  ...
                  },
                  {
                    ...
                    description: 'Tools to understand demand, SERPs, and ranking opportunities.',
                  ...
                  },
                  {
                    ...
                    description: 'Connecting SEO scenarios with pipeline and revenue.',
                    icon: <Activity className="h-8 w-8" />,
                    features: [
                      'Traffic & Ranking Models',
                      'Scenario Planning (Best / Base / Conservative)',
                      'Pipeline & Revenue Mapping',
                      'Seasonality & Trend Adjustments',
                      'Goal vs. Actual Tracking',
                    ],
                  },
                  {
                    title: 'Data Integration',
                    description: 'Bringing data from multiple platforms into one source of truth.',
                    icon: <Database className="h-8 w-8" />,
                    features: [
                      'Search Console Integration',
                      'Ad Platforms & CRM Feeds',
                      'ETL & Data Pipelines',
                      'Data Quality Checks',
                  ...
                  },
                  {
                    ...
                    description: 'Systems that keep SEO, content, and leadership aligned.',
                    icon: <Users className="h-8 w-8" />,
                    features: [
                      'Shared Roadmap Boards',
                      'Content & Dev Backlogs',
                  ...
                  },
                  {
                    ...
                    description: 'Always-on monitoring for SEO performance and anomalies.',
                    icon: <Eye className="h-8 w-8" />,
                    features: [
                      'Ranking Drop Alerts',
                      'Traffic Anomaly Detection',
                      'Technical SEO Monitors',
          ...
          <section id="case-studies" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent via-purple-900/10 to-transparent">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
                  Forecasting Wins in Action
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Real SEO reporting and forecasting implementations that turned data into growth.
                  See how better visibility and forecasting improved revenue and decision-making.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                {
                    title: 'Enterprise SaaS Visibility Lift',
                    description: 'Built a forecasting model that connected SEO performance with pipeline and ARR growth.',
                    metrics: [
                      { label: 'Organic Pipeline', value: '+280%', icon: <TrendingUp className="h-5 w-5" />, color: 'from-green-500 to-emerald-600' },
                      { label: 'Forecast Accuracy', value: '92%', icon: <Target className="h-5 w-5" />, color: 'from-purple-500 to-pink-600' },
                  ...
                  {
                    title: 'Ecommerce Revenue Forecasting',
                    description: 'Connected keyword clusters, rankings, and revenue to build roll-up revenue forecasts.',
                    metrics: [
                      { label: 'Revenue Visibility', value: '+350%', icon: <BarChart3 className="h-5 w-5" />, color: 'from-blue-500 to-indigo-600' },
                      { label: 'Forecast Scenarios', value: '3x', icon: <Activity className="h-5 w-5" />, color: 'from-yellow-500 to-amber-600' },
                  ...
                  {
                    title: 'Multi-location Lead Forecasting',
                    description: 'Created location-level lead and call forecasts for a multi-city services brand.',
                    metrics: [
                      { label: 'Locations Modeled', value: '120+', icon: <MapPin className="h-5 w-5" />, color: 'from-purple-500 to-violet-600' },
                      { label: 'Lead Growth', value: '230%', icon: <Users className="h-5 w-5" />, color: 'from-green-500 to-emerald-600' },
                  ...
                  {
                    title: 'Board-ready SEO Reporting',
                    description: 'Standardized reporting for leadership with clean forecasting and KPI visibility.',
                    metrics: [
                      { label: 'Reporting Time', value: '-70%', icon: <Clock className="h-5 w-5" />, color: 'from-yellow-500 to-amber-600' },
                      { label: 'Exec Adoption', value: '4.9/5', icon: <Star className="h-5 w-5" />, color: 'from-purple-500 to-pink-600' },
                      { label: 'Timeframe', value: '4 Months', icon: <Calendar className="h-5 w-5" />, color: 'from-blue-500 to-cyan-600' }
                    ],
                    highlight: 'Executive Ready',
                        ...
                        <div className="flex items-start gap-5 mb-6">
                          <div className="relative">
                            <div className="p-4 bg-gradient-to-br from-purple-500/30 to-purple-600/30 rounded-2xl border-2 border-purple-400/40 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 shadow-lg shadow-purple-500/20">
                              <BarChart3 className="h-7 w-7 text-purple-200" />
                            </div>
          ...
          <section id="approach" className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
              <div className="text-center mb-16">
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
                  Our Reporting & Forecasting Approach
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  A structured framework that turns SEO data into executive-ready reporting and accurate revenue forecasts.
              </p>
            </div>
              ...
              {[
                {
                  step: '01',
                      ...
                      description: 'Audit tracking, analytics, and data quality to ensure reliable reporting inputs.',
                ...
                },
                {
                  step: '02',
                      ...
                      description: 'Design dashboards and reports aligned to leadership, marketing, and sales needs.',
                      icon: <BarChart3 className="h-6 w-6" />,
                ...
                },
                {
                  step: '03',
                      ...
                      description: 'Build traffic, lead, and revenue forecasts using historical performance and scenarios.',
                      icon: <Brain className="h-6 w-6" />,
                      color: 'from-green-500 to-green-600'
                },
                {
                  step: '04',
                      title: 'Iteration & Alignment',
                      description: 'Refine models and reporting with feedback from leadership and performance data.',
          ...
          <section id="faqs" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent via-purple-900/10 to-transparent">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-16">
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
                SEO Reporting & Forecasting FAQs
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Everything you need to know about making SEO reporting and forecasting work for your business.
              </p>
            </div>
              ...
              {[
                {
                    question: 'What is SEO reporting & forecasting and why do I need it?',
                    answer:
                      'SEO reporting & forecasting connects your organic performance (traffic, rankings, leads, revenue) to business outcomes. Reporting shows what happened, while forecasting shows what is likely to happen based on scenarios. Together, they help you justify investment, set realistic targets, and make data-backed decisions.'
                },
                {
                    question: 'How long does it take to implement SEO reporting & forecasting?',
                    answer:
                      'Most implementations take 3–6 weeks, depending on your current data setup. We start with a data audit, then connect your analytics, CRM, and revenue data. From there we design dashboards, configure forecasting models, and iterate with your team until the outputs match your decision-making needs.'
                },
                {
                    question: 'What tools do you use for reporting and forecasting?',
                    answer:
                      'We typically work with Google Analytics 4, Google Search Console, Looker Studio, BigQuery, and spreadsheet or BI tools for modeling. For more advanced setups, we can integrate with CRM and data warehouses to pull in pipeline and revenue data, ensuring your SEO reporting is fully aligned with sales and finance.'
                },
                {
                    question: 'Can you report and forecast by channel, keyword, and page?',
                    answer:
                      'Yes. We can break down performance and forecasts by channel, keyword cluster, landing page, location, funnel stage, and more. This allows you to see exactly which parts of your SEO program are driving growth and where additional investment will have the highest impact.'
                },
                {
                    question: 'How accurate are SEO forecasts?',
                    answer:
                      'Forecast accuracy depends on data history, market volatility, and the level of granularity. Typically, once we have 12–18 months of clean data, we can build models that give directional accuracy for different scenarios (conservative, expected, aggressive). We continuously refine models as new data comes in.'
                },
                {
                    question: 'Can you integrate SEO reporting with our leadership or board reports?',
                    answer:
                      'Absolutely. We specialize in building executive-ready reports that fit into your existing leadership or board templates. We translate technical SEO metrics into business language—pipeline, revenue, ROI, and risk—so stakeholders can see SEO as a predictable growth lever, not a black box.'
                }
              ].map((faq, index) => (
                  <div
                    key={index}
...
export default SeoReportingForecasting; 