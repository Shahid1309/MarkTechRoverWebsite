...
const LeadNurtureEmail = () => {
  ...
  const navItems = [
    { id: 'deliverables', label: 'Deliverables', icon: <CheckCircle className="h-4 w-4" /> },{ id: 'technology', label: 'Lead Nurture Email Marketing Technology', icon: <Cpu className="h-4 w-4" /> },
    { id: 'case-studies', label: 'Lead Nurture Email Marketing Case Studies', icon: <Trophy className="h-4 w-4" /> },
    { id: 'approach', label: 'Lead Nurture Email Marketing Approach', icon: <Rocket className="h-4 w-4" /> },
  ...
  const seoConfig = {
    ...
    keywords: [
      'Lead Nurture Email Marketing Delhi', 'Best email nurture agency in Delhi', 'Email nurture services NCR', 'Best email nurture services in India', 'Professional email nurture services India', 'Email nurture experts in Delhi NCR', 'Email nurture company India', 'SEO services in Delhi', 'Lead nurturing Delhi', 'Email marketing India'
    ],
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 transition-all duration-1000">
              Hire Lead Nurturing Services
            </h1>

            {/* Animated Description */}
            <p className="text-xl text-gray-300 mb-8 max-w-4xl mx-auto transition-all duration-1000 delay-300">
              Professional lead nurture email services in Delhi NCR. Get expert lead nurture email solutions with proven results and ROI.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center transition-all duration-1000 delay-1000">
              ...
              >
                <span className="relative z-10">Get Free Lead Nurture Email Consultation</span>
        ...
        <div className="relative">
          ...
          <section id="deliverables" className="py-20 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Comprehensive lead nurture email marketing solutions designed for business growth. 
                  Best email nurture agency in Delhi NCR delivering measurable results.
              </p>
            </div>
                  ...
                  >
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-purple-300 text-sm">Email Nurture Service</p>
                      </div>
                    </div>
          ...
          <section id="technology" className="py-20 px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                Lead Nurture Email Marketing Technology
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  The email, automation, and data stack we use to design, deliver, and optimize nurture programs that
              ...
              {[
                {
                    ...
                    description: 'Core tools for building and running nurture journeys.',
                    icon: <Mail className="h-8 w-8" />,
                    features: [
                      'Modern Email & Marketing Automation Tools',
                      'Segmented Lists & Audiences',
                      'Behavior-based Triggers',
                      'Template & Module Libraries',
                      'Multi-channel Journeys',
                    ],
                  },
                  {
                    title: 'CRM & Data Integration',
                    description: 'Ensuring sales and marketing see the same picture.',
                  icon: <Users className="h-8 w-8" />,
                    features: [
                      'CRM Integrations (HubSpot, Salesforce, Zoho, etc.)',
                      'Lead & Account Field Mapping',
                      'Two-way Sync of Activities',
                  ...
                  },
                  {
                    ...
                    description: 'Measuring the true impact of nurture programs.',
                  icon: <BarChart3 className="h-8 w-8" />,
                    features: [
                      'Open, Click, & Reply Tracking',
                      'Funnel & Stage-conversion Reporting',
                      'Campaign & Sequence Dashboards',
                      'Source & Segment Performance',
                      'Goal & KPI Tracking',
                    ],
                  },
                  {
                    title: 'Personalization & Scoring',
                    description: 'Targeting the right leads with the right message at the right time.',
                    icon: <Target className="h-8 w-8" />,
                    features: [
                      'Lead & Account Scoring Models',
                      'Firmographic & Behavioral Segmentation',
                  ...
                  },
                  {
                    ...
                    description: 'Keeping nurture content organized, reusable, and on-brand.',
                    icon: <FileText className="h-8 w-8" />,
                    features: [
                      'Centralized Content Libraries',
                      'Use-case & Stage-based Templates',
                  ...
                  },
                  {
                    ...
                    description: 'Continually improving email and nurture performance.',
                    icon: <Activity className="h-8 w-8" />,
                    features: [
                      'Subject Line & Send-time Testing',
                      'Content & Offer Experiments',
                      'Cadence & Sequence Variations',
                      'Deliverability & Inbox Placement Checks',
          ...
          >
            <div className="max-w-7xl mx-auto">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Real results from our lead nurture email campaigns. See how we&apos;ve turned cold leads into
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                {
                    title: 'B2B SaaS Nurture Engine',
                    description:
                      'Built a multi-stage nurture program that activated cold trial users and stalled opportunities.',
                    metrics: [
                      {
                        label: 'SQL Uplift',
                        value: '230%',
                    ...
                    highlight: 'Pipeline Impact',
                    gradient: 'from-purple-600/20 to-blue-600/20',
                  },
                  {
                    title: 'Ecommerce Repeat Purchase Flows',
                    description:
                      'Implemented lifecycle email flows to increase repeat orders and customer lifetime value.',
                    metrics: [
                      {
                        label: 'Repeat Orders',
                        value: '310%',
                    ...
                    highlight: 'Retention Win',
                    gradient: 'from-blue-600/20 to-indigo-600/20',
                  },
                  {
                    title: 'High-ticket Services Nurture',
                    description:
                      'Created education-first nurture journeys for a high-ticket services brand across multiple cities.',
                    metrics: [
                      {
                    ...
                    highlight: 'Sales Alignment',
                    gradient: 'from-purple-600/20 to-pink-600/20',
                  },
                  {
                    title: 'Industrial Leads Reactivation',
                    description:
                      'Reactivated a large database of inactive B2B leads with segmented nurture streams and offers.',
                    metrics: [
                      {
                        label: 'Dormant Leads Touched',
                        value: '12K+',
                        icon: <Users className="h-5 w-5" />,
                        color: 'from-green-500 to-emerald-600',
                      },
                      {
                        label: 'Reactivated Pipeline',
                        value: '₹3.2 Cr',
          ...
          >
            ...
            <div className="max-w-7xl mx-auto relative z-10">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
                  Our Proven Lead Nurturing Approach
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  A step-by-step email and workflow methodology that moves leads from awareness to sales conversations,
                  without spamming or burning your database.
              </p>
            </div>
              ...
              {[
                {
                  step: '01',
                      ...
                      description:
                        'Map your buyer journey, define segments, and identify key moments for education and offers.',
                      icon: <Target className="h-6 w-6" />,
                ...
                },
                {
                  step: '02',
                      ...
                      description:
                        'Design sequences, content, and triggers tailored to each lead stage, persona, and intent.',
                ...
                },
                {
                  step: '03',
                      ...
                      description:
                        'Implement workflows in your email/marketing automation platform integrated with your CRM.',
                ...
                },
                {
                  step: '04',
                      ...
                      description:
                        'Continuously test, measure, and optimize subject lines, content, and cadence to scale results.',
          ...
          >
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Everything you need to know about lead nurture email marketing and automation.
              </p>
            </div>
              ...
              <div className="space-y-4">
                {[
                  {
                    question: 'What is lead nurture email marketing and how is it different from newsletters?',
                    answer:
                      'Lead nurture email marketing is a structured set of automated email sequences designed to move leads through specific stages of your funnel. Instead of generic newsletters sent to everyone, nurture programs are personalized and triggered based on behavior, lifecycle stage, and interests, with clear goals such as demo bookings, trial activation, or proposal requests.',
                  },
                  {
                    question: 'How long does it take to see results from nurture emails?',
                    answer:
                      'Most businesses see early signs of improvement—such as higher engagement and more replies—within 3–4 weeks of launch. Pipeline and revenue impact typically becomes clear within 2–3 months as leads move through the full journey. Timelines depend on your sales cycle, list quality, and existing email performance.',
                  },
                  {
                    question: 'What is the typical investment for lead nurture email services?',
                    answer:
                      'Lead nurture email programs usually range from ₹40,000 to ₹1,25,000 per month depending on the number of segments, automation complexity, content volume, and integration needs. We scope pricing based on your database size, platforms, and growth targets, with clear deliverables and timelines.',
                  },
                  {
                    question: 'Which tools and platforms do you work with?',
                    answer:
                      'We work with all major email and marketing automation platforms including HubSpot, Mailchimp, Klaviyo, ActiveCampaign, Marketo, Pardot, and custom setups. We help you design workflows that fit your current stack or guide you on selecting and implementing the right tools if you are just getting started.',
                  },
                  {
                    question: 'Will nurture emails annoy or spam my leads?',
                    answer:
                      'Done correctly, nurture emails are helpful, relevant, and timed thoughtfully. We prioritize value—education, resources, and guidance—over constant selling. We also manage frequency, segmentation, and unsubscribe preferences carefully so your database experiences your brand as useful and trustworthy instead of spammy.',
                  },
                  {
                    question: 'Can you connect nurture emails with our sales team process?',
                    answer:
                      'Yes. We integrate nurture workflows with your CRM so sales can see engagement history, lead scores, and key actions. We can also set up alerts for sales reps when leads hit certain thresholds (e.g., high-intent actions), and design handoff rules that keep marketing and sales aligned.',
                  },
                  {
                    question: 'Do you create email content and sequences or just strategy?',
                    answer:
                      'We do both. Our team can handle end-to-end planning, copywriting, design, automation setup, testing, and optimization. If you have internal writers or designers, we can collaborate and provide frameworks and feedback while your team creates the assets.',
                  },
                  {
                    question: 'How do you measure lead nurture success?',
                    answer:
                      'We go beyond open and click rates. We track reply rates, meeting bookings, pipeline influenced, win rates, and revenue attribution from nurture flows. You get clear dashboards and reports that connect email engagement to actual sales outcomes.',
                  },
              ].map((faq, index) => (
                  <div
                    key={index}
...
export default LeadNurtureEmail; 