...
const AmazonSEO = () => {
  ...
  const navItems = [
    ...
    { id: 'packages', label: 'SEO for Amazon Packages', icon: <DollarSign className="h-4 w-4" /> },
    { id: 'technology', label: 'SEO for Amazon Technology', icon: <Cpu className="h-4 w-4" /> },
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 transition-all duration-1000">
              Marktechrover: Best <span className="bg-gradient-to-r from-purple-300 via-purple-400 to-purple-500 bg-clip-text text-transparent font-extrabold">Amazon S E O</span> in Delhi, NCR & India
            </h1>
