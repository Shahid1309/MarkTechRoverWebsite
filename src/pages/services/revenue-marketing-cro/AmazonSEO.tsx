...
const AmazonSEO = () => {
  ...
  const navItems = [
    { id: 'deliverables', label: 'Deliverables', icon: <CheckCircle className="h-4 w-4" /> },{ id: 'technology', label: 'SEO for Amazon Technology', icon: <Cpu className="h-4 w-4" /> },
    { id: 'case-studies', label: 'SEO for Amazon Case Studies', icon: <Trophy className="h-4 w-4" /> },
    { id: 'approach', label: 'SEO for Amazon Approach', icon: <Rocket className="h-4 w-4" /> },
  ...
  const seoConfig = {
    ...
    keywords: [
      'SEO for Amazon Delhi', 'Best Amazon SEO agency in Delhi', 'Amazon SEO services NCR', 'Best Amazon SEO services in India', 'Professional Amazon SEO services India', 'Amazon SEO experts in Delhi NCR', 'Amazon SEO company India', 'SEO services in Delhi', 'Amazon SEO Delhi', 'Amazon optimization India'
    ],
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 transition-all duration-1000">
              Hire Amazon SEO Agency
            </h1>

            {/* Animated Description */}
            <p className="text-xl text-gray-300 mb-8 max-w-4xl mx-auto transition-all duration-1000 delay-300">
              Professional amazon s e o services in Delhi NCR. Get expert amazon s e o solutions with proven results and ROI.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center transition-all duration-1000 delay-1000">
              ...
              >
                <span className="relative z-10">Get Free Amazon S E O Consultation</span>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Comprehensive Amazon SEO solutions designed for business growth. 
                  Best Amazon SEO agency in Delhi NCR delivering measurable results.
                </p>
              </div>
                  ...
                  >
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-purple-300 text-sm">Amazon SEO Service</p>
                      </div>
                    </div>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-4xl font-bold text-white mb-4">
                  SEO for Amazon Technology
                </h2>
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  A full Amazon-native toolkit for ranking, conversion, and profitability. From keyword research to listing
                  experiments and review tracking, we use proven Amazon SEO and analytics tools tuned for Indian and global
                  marketplaces.
                </p>
              </div>
              ...
              {[
                {
                  title: 'Amazon Keyword Intelligence',
                  description: 'Finding the exact terms your buyers type into Amazon search.',
                  icon: <Search className="h-8 w-8" />,
                  features: [
                    'High-intent Keyword Research',
                    'Long-tail & Niche Term Discovery',
                    'Backend & Frontend Keyword Mapping',
                    'Competitor Keyword Gap Analysis',
                    'Seasonality & Trend Tracking',
                  ],
                },
                {
                  title: 'Listing Optimization Stack',
                  description: 'Turning product pages into high-converting, algorithm-friendly assets.',
                  icon: <FileText className="h-8 w-8" />,
                  features: [
                    'Title, Bullet & Description Optimization',
                    'A+ Content / EBC Planning',
                    'Image & Gallery Strategy',
                    'Mobile-first Layout Checks',
                    'Searchability vs. Readability Balance',
                  ],
                },
                {
                  title: 'Conversion & Content Testing',
                  description: 'Validating which content moves the needle before rolling it out widely.',
                  icon: <Activity className="h-8 w-8" />,
                  features: [
                    'A/B Tests on Titles & Images',
                    'Pricing & Offer Experimentation',
                    'Badging & Social Proof Tests',
                    'Buy Box & Prime Impact Analysis',
                    'Test Logs & Learnings Library',
                  ],
                },
                {
                  title: 'Review & Rating Systems',
                  description: 'Protecting and improving review profiles without breaking Amazon policies.',
                  icon: <Star className="h-8 w-8" />,
                  features: [
                    'Review Volume & Rating Dashboards',
                    'Early Reviewer & Vine Strategy Guidance',
                ...
                },
                {
                  ...
                  description: 'Understanding true performance by product, keyword, and category.',
                  icon: <BarChart3 className="h-8 w-8" />,
                  features: [
                    'Search Term & ASIN Reports',
                    'Category & Sub-category Rank Tracking',
                    'Unit Economics & Profitability Analysis',
                    'Repeat Purchase & LTV Insights',
                    'Executive-ready Performance Dashboards',
                  ],
                },
                {
                  title: 'PPC & Organic Synergy',
                  description: 'Aligning Amazon Ads with SEO so both channels lift each other.',
                  icon: <ShoppingCart className="h-8 w-8" />,
                  features: [
                    'Search Term Harvesting from Ads',
                    'Ranking Campaign Support',
                    'Branded vs Non-branded Split',
                    'Placement & Bid Strategy Inputs',
                    'Organic vs Paid Share Reporting',
                  ],
                },
              ].map((tech, index) => (
                <div
          ...
          <section id="case-studies" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent via-purple-900/10 to-transparent">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  How structured Amazon SEO, content, and reviews turned under-performing listings into category leaders.
                  These examples show what's possible when search, content, and ads work together on Amazon.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {[
                  {
                    title: 'D2C Beauty Brand Rank Lift',
                    description:
                      'Optimized titles, bullets, and keywords across 40+ SKUs, then paired with ranking campaigns on priority terms.',
                    metrics: [
                      { label: 'Core Keywords', value: 'Top 3 Rank', icon: <Target className="h-5 w-5" />, color: 'from-green-500 to-emerald-600' },
                      { label: 'Organic Sessions', value: '2.7x', icon: <TrendingUp className="h-5 w-5" />, color: 'from-blue-500 to-indigo-600' },
                      { label: 'Timeframe', value: '5 Months', icon: <Clock className="h-5 w-5" />, color: 'from-blue-500 to-cyan-600' }
                    ],
                    highlight: 'Ranking Success',
                    gradient: 'from-purple-600/20 to-blue-600/20'
                  },
                  {
                    title: 'Home & Kitchen Category Expansion',
                    description:
                      'Rebuilt content and images for hero SKUs, then replicated learnings to new variants and bundles.',
                    metrics: [
                      { label: 'Sales Growth', value: '190%', icon: <DollarSign className="h-5 w-5" />, color: 'from-yellow-500 to-amber-600' },
                      { label: 'Conversion Rate', value: '35% Higher', icon: <Target className="h-5 w-5" />, color: 'from-green-500 to-emerald-600' },
                  ...
                  {
                    title: 'Electronics Accessories Turnaround',
                    description:
                      'Addressed low review ratings and poor keyword coverage that were blocking visibility in a crowded niche.',
                    metrics: [
                      { label: 'Avg Rating', value: '4.1 → 4.6', icon: <Star className="h-5 w-5" />, color: 'from-yellow-500 to-amber-600' },
                      { label: 'Daily Impressions', value: '3.3x', icon: <Eye className="h-5 w-5" />, color: 'from-purple-500 to-pink-600' },
                  ...
                  {
                    title: 'FMCG Brand Launch on Amazon India',
                    description:
                      'Launched and scaled a new brand with search-first content, structured catalog, and review programs.',
                    metrics: [
                      { label: 'Monthly Run-rate', value: '₹1.2 Cr', icon: <DollarSign className="h-5 w-5" />, color: 'from-yellow-500 to-amber-600' },
                      { label: 'Keywords Ranking', value: '60+', icon: <Search className="h-5 w-5" />, color: 'from-green-500 to-emerald-600' },
          ...
          <section id="approach" className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
              <div className="text-center mb-16">
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
                  Our Proven Amazon SEO Approach
                </h2>
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  A simple, repeatable framework that connects Amazon SEO with catalog strategy, reviews, and ads. We focus
                  on what actually moves rank and conversion instead of chasing every new Amazon "hack".
                </p>
              </div>
                  ...
                  {[
                    {
                      ...
                      description:
                        'Audit listings, reviews, and search terms, then build a keyword map for each ASIN and family.',
                      icon: <Search className="h-6 w-6" />,
                      color: 'from-blue-500 to-blue-600'
                    },
                    {
                      step: '02',
                      title: 'Content & Creative Upgrade',
                      description:
                        'Rewrite titles, bullets, descriptions, and A+ content while coordinating with new images and creatives.',
                      icon: <PenTool className="h-6 w-6" />,
                      color: 'from-purple-500 to-purple-600'
                    },
                    {
                      step: '03',
                      title: 'Launch, Reviews & Rank',
                      description:
                        'Roll out changes with review programs and ranking campaigns to push visibility on priority terms.',
                    ...
                    },
                    {
                      ...
                      description:
                        'Use analytics to refine keywords, content, and ads, then scale learnings to new SKUs and categories.',
                      icon: <TrendingUp className="h-6 w-6" />,
          ...
          <section id="faqs" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent via-purple-900/10 to-transparent">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Answers to the most common questions brands ask when they start taking Amazon SEO seriously.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    answer:
                      "Amazon's A9/A10 algorithm is focused heavily on sales velocity and conversion, not just relevance and authority like Google. That means keywords, content, reviews, and pricing must all be aligned to drive more purchases on Amazon — not clicks to a website.",
                  },
                  {
                    question: 'How long does it take to see results from Amazon SEO?',
                    answer:
                      'Most brands start seeing movement in impressions and rank within 3–6 weeks of optimized content going live, with stronger sales impact usually visible over 2–3 months. Timelines depend on competition, pricing, reviews, and how aggressively we support SEO with PPC.',
                  },
                  {
                    question: 'Do you also manage Amazon PPC or only organic SEO?',
                    answer:
                      'We can do SEO-only engagements, but Amazon works best when ads and SEO are aligned. Many clients ask us to manage both so that search term data, ranking efforts, and budgets are coordinated from one team.',
                  },
                  {
                    question: 'Can you work with both Vendor Central and Seller Central accounts?',
                    answer:
                      'Yes. We work with brands on Seller Central, Vendor Central, and hybrid models. We adapt our content, catalog, and reporting approach to your specific setup, including any agency-of-record or distributor relationships.',
                  },
                  {
                    question: 'What do you need from our side to get started?',
                    answer:
                      'We typically need catalog access, sales data, existing creatives, brand guidelines, and clarity on margin constraints. From there we handle keyword research, content planning, implementation coordination, and reporting.',
                  },
                  {
                    question: 'Is your SEO for Amazon service suitable for small catalogs?',
                    answer:
                      'Yes. We work with both focused catalogs and large portfolios. For smaller catalogs we go deeper on each ASIN and often see faster, more visible gains because effort is concentrated on fewer products.',
                  }
                ].map((faq, index) => (
                  <div
                    key={index}
