...
const EmailMarketingManagement = () => {
  ...
  const navItems = [
    { id: 'deliverables', label: 'Deliverables', icon: <CheckCircle className="h-4 w-4" /> },{ id: 'technology', label: 'Email Marketing Management Technology', icon: <Cpu className="h-4 w-4" /> },
    { id: 'case-studies', label: 'Email Marketing Management Case Studies', icon: <Trophy className="h-4 w-4" /> },
    { id: 'approach', label: 'Email Marketing Management Approach', icon: <Rocket className="h-4 w-4" /> },
  ...
  const seoConfig = {
    ...
    keywords: [
      'Email Marketing Management Delhi', 'Best email marketing agency in Delhi', 'Email marketing services NCR', 'Best email marketing services in India', 'Professional email marketing services India', 'Email marketing experts in Delhi NCR', 'Email marketing company India', 'SEO services in Delhi', 'Email marketing Delhi', 'Email marketing India'
    ],
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-4xl mx-auto transition-all duration-1000 delay-300">
              Professional email marketing management services in Delhi NCR. Get expert email marketing management solutions with proven results and ROI.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center transition-all duration-1000 delay-1000">
              ...
              >
                <span className="relative z-10">Get Free Email Marketing Management Consultation</span>
        ...
        <div className="relative">
          ...
          <section id="deliverables" className="py-20 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Comprehensive email marketing management solutions designed for business growth. 
                  Best email marketing agency in Delhi NCR delivering measurable results.
              </p>
            </div>
                  ...
                  >
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-purple-300 text-sm">Email Marketing Service</p>
                      </div>
                    </div>
          ...
          <section id="technology" className="py-20 px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                Email Marketing Management Technology
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  The email, data, and automation stack we use to plan, send, and optimize campaigns that grow revenue
                  and retention.
              </p>
            </div>
              ...
              {[
                {
                    ...
                    description: 'Modern tools for managing campaigns and journeys at scale.',
                    icon: <Mail className="h-8 w-8" />,
                    features: [
                      'Campaign Builders & Journeys',
                  ...
                  },
                  {
                    ...
                    description: 'Connecting email with a complete view of your customers.',
                  ...
                  },
                  {
                    ...
                    description: 'Sending the right message to the right people at the right time.',
                    icon: <Target className="h-8 w-8" />,
                    features: [
                      'Behavioral & Event-based Segments',
                      'RFM & CLV-based Targeting',
                      'Dynamic Content & Offers',
                      'Language & Locale Variants',
                      'Time-zone & Frequency Controls',
                    ],
                },
                {
                  title: 'Analytics & Reporting',
                    description: 'Measuring performance from inbox to revenue.',
                  icon: <BarChart3 className="h-8 w-8" />,
                    features: [
                      'Campaign & Journey Dashboards',
                      'Cohort & Retention Analysis',
                      'Channel & Source Attribution',
                      'Revenue & CLV Impact',
                      'Executive & Team-level Views',
                    ],
                  },
                  {
                    title: 'Testing & Optimization',
                    description: 'Continuous improvement of content, timing, and targeting.',
                    icon: <Activity className="h-8 w-8" />,
                    features: [
                      'Subject Line & Content A/B Tests',
                      'Send Time & Frequency Experiments',
                      'Offer & Journey Variations',
                      'Deliverability & Inbox Monitoring',
                      'Iterative Test Roadmaps',
                    ],
                  },
                  {
                    title: 'Compliance & Deliverability',
                    description: 'Keeping your email program safe, reliable, and trustworthy.',
          ...
          <section id="case-studies" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent via-purple-900/10 to-transparent">
            <div className="max-w-7xl mx-auto">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Real results from our Email Marketing Management campaigns. See how we've transformed businesses 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                {
                    title: 'E-commerce Email Success',
                    description: 'Transformed an online store with strategic email marketing and automation',
                    metrics: [
                      { label: 'Email Revenue', value: '300%', icon: <TrendingUp className="h-5 w-5" />, color: 'from-green-500 to-emerald-600' },
                  ...
                  {
                    title: 'SaaS Email Growth',
                    description: 'Scaled email engagement and improved conversion rates significantly',
                    metrics: [
                      { label: 'Open Rates', value: '500%', icon: <TrendingUp className="h-5 w-5" />, color: 'from-green-500 to-emerald-600' },
                  ...
                  {
                    title: 'B2B Email Expansion',
                    description: 'Dramatically increased lead generation and revenue through optimized email campaigns',
                    metrics: [
                      { label: 'Lead Generation', value: '400%', icon: <Users className="h-5 w-5" />, color: 'from-blue-500 to-indigo-600' },
                  ...
                  {
                    title: 'Retail Email Success',
                    description: 'Achieved record email engagement and customer retention rates',
                    metrics: [
                      { label: 'Engagement', value: '600%', icon: <Heart className="h-5 w-5" />, color: 'from-purple-500 to-violet-600' },
          ...
          <section id="approach" className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
              <div className="text-center mb-16">
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
                  Our Proven Email Marketing Approach
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  A systematic methodology designed to maximize your email marketing ROI. 
                  From strategy to automation, we guide you through every step.
              </p>
            </div>
              ...
              {[
                {
                  step: '01',
                      ...
                      description: 'Develop email marketing strategy and set up automation platforms',
                      icon: <Target className="h-6 w-6" />,
                ...
                },
                {
                  step: '02',
                      ...
                      description: 'Create and launch targeted email campaigns with segmentation',
                      icon: <Rocket className="h-6 w-6" />,
                ...
                },
                {
                  step: '03',
                      ...
                      description: 'Implement automated email sequences and lead nurturing workflows',
                      icon: <TrendingUp className="h-6 w-6" />,
                ...
                },
                {
                  step: '04',
                      ...
                      description: 'Continuously optimize campaigns and scale successful email programs',
          ...
          <section id="faqs" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent via-purple-900/10 to-transparent">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Everything you need to know about Email Marketing Management. 
              ...
              {[
                {
                    question: 'What is Email Marketing Management and how does it work?',
                    answer: 'Email Marketing Management is a comprehensive service that handles all aspects of your email marketing program including strategy, campaign creation, automation, segmentation, A/B testing, and performance optimization. We manage your email platform, create engaging content, design responsive templates, set up automated workflows, and continuously optimize campaigns to maximize open rates, click-through rates, and revenue.'
                },
                {
                    question: 'How long does it take to see email marketing results?',
                    answer: 'Initial improvements can be seen within 2-4 weeks, but comprehensive email marketing programs typically show significant results within 3-6 months. The timeline depends on your list size, email frequency, and campaign goals. We provide monthly progress reports and can often implement quick wins that show immediate improvements while building long-term strategies.'
                },
                {
                    question: 'What is the typical investment for Email Marketing Management?',
                    answer: 'Email Marketing Management services typically range from ₹30,000 to ₹1,20,000 per month depending on your list size, email volume, automation complexity, and content requirements. We provide custom quotes based on your specific business needs, email goals, and growth objectives. Most businesses see ROI within the first 2-3 months.'
                },
                {
                  question: 'Do you work with businesses outside Delhi NCR?',
                    answer: 'Yes, we work with businesses across India and internationally. Our Email Marketing Management services are delivered remotely with excellent results. We have experience working with businesses in Mumbai, Bangalore, Chennai, Hyderabad, and other major cities, as well as international clients.'
                  },
                  {
                    question: 'How do you measure Email Marketing success?',
                    answer: 'We track comprehensive KPIs including open rates, click-through rates, conversion rates, revenue per email, unsubscribe rates, list growth, engagement scores, and overall ROI. We provide detailed monthly reports with actionable insights, campaign performance analysis, and optimization recommendations. Our dashboards give you real-time visibility into email performance.'
                  },
                  {
                    question: 'What email platforms do you work with?',
                    answer: 'We work with all major email marketing platforms including Mailchimp, Constant Contact, SendGrid, Klaviyo, HubSpot, Marketo, Pardot, and custom solutions. We can help you choose the right platform for your needs or work with your existing platform. We handle platform setup, integration, and optimization.'
                  },
                  {
                    question: 'Do you provide email design and content creation?',
                    answer: 'Yes, email design and content creation are core components of our service. We create responsive email templates, write engaging copy, design compelling visuals, and ensure all emails are optimized for deliverability and engagement. We maintain brand consistency and create content that resonates with your audience.'
                  },
                  {
                    question: 'Can email marketing integrate with my CRM?',
                    answer: 'Absolutely! We integrate email marketing with all major CRM systems including Salesforce, HubSpot, Zoho, Pipedrive, and custom solutions. Integration allows seamless data flow, automated lead capture, activity tracking, and personalized email experiences based on CRM data. We handle the entire integration process.'
                }
              ].map((faq, index) => (
                  <div
                    key={index}
