...
const OnlineReviewAcceleration = () => {
  ...
  const navItems = [
    { id: 'deliverables', label: 'Deliverables', icon: <CheckCircle className="h-4 w-4" /> },{ id: 'technology', label: 'Online Review Acceleration Technology', icon: <Cpu className="h-4 w-4" /> },
    { id: 'case-studies', label: 'Online Review Acceleration Case Studies', icon: <Trophy className="h-4 w-4" /> },
    { id: 'approach', label: 'Online Review Acceleration Approach', icon: <Rocket className="h-4 w-4" /> },
  ...
  const seoConfig = {
    ...
    keywords: [
      'Online Review Acceleration Delhi', 'Best review management agency in Delhi', 'Review acceleration services NCR', 'Best review acceleration services in India', 'Professional review acceleration services India', 'Review management experts in Delhi NCR', 'Review management company India', 'SEO services in Delhi', 'Review management Delhi', 'Online reviews India'
    ],
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 transition-all duration-1000">
              Hire Review Management Services
            </h1>

            {/* Animated Description */}
            <p className="text-xl text-gray-300 mb-8 max-w-4xl mx-auto transition-all duration-1000 delay-300">
              Professional online review acceleration services in Delhi NCR. Get expert online review acceleration solutions with proven results and ROI.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center transition-all duration-1000 delay-1000">
              ...
              >
                <span className="relative z-10">Get Free Online Review Acceleration Consultation</span>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Comprehensive online review acceleration solutions designed for business growth. 
                  Best review management agency in Delhi NCR delivering measurable results.
                </p>
              </div>
                  ...
                  >
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-purple-300 text-sm">Review Management Service</p>
                      </div>
                    </div>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-4xl font-bold text-white mb-4">
                  Online Review Acceleration Technology
                </h2>
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  The review, reputation, and feedback stack we use to collect, manage, and showcase reviews across all
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                  {
                    title: 'Review Platforms & Listings',
                    description: 'Managing your presence where customers search and decide.',
                  ...
                  {
                    title: 'Review Generation Tools',
                    description: 'Driving a steady, compliant flow of new high-quality reviews.',
                    icon: <MessageSquare className="h-8 w-8" />,
                    features: [
                      'SMS & Email Review Requests',
                      'QR Codes & Short Links',
                      'Post-purchase & Post-service Flows',
                      'Segmentation & Timing Rules',
                      'Opt-out & Compliance Controls',
                    ],
                  },
                  {
                    title: 'Reputation Monitoring',
                    description: 'Staying on top of what customers are saying in real time.',
                  ...
                  },
                  {
                    ...
                    description: 'Responding to reviews in a consistent, brand-safe way.',
                  ...
                  },
                  {
                    ...
                    description: 'Putting your best reviews and ratings to work in your marketing.',
                    icon: <Star className="h-8 w-8" />,
                    features: [
                      'On-site Review Widgets',
                      'Testimonial & Case Study Feeds',
                      'Social Media & Ad Integrations',
                      'Landing Page & Funnel Proof',
                      'PDF & Sales Deck Exports',
                    ],
                  },
                  {
                    title: 'Reporting & Insights',
                    description: 'Turning review data into actionable business insights.',
                    icon: <BarChart3 className="h-8 w-8" />,
                    features: [
                      'Review Volume & Rating Dashboards',
                      'Location & Channel Comparisons',
                      'NPS & Satisfaction Metrics',
                      'Operations & CX Feedback Loops',
          ...
          >
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Real results from our Online Review Acceleration programs. See how better reviews improved trust,
                  ranking, and revenue.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {[
                  {
                    title: 'Local Services Review Surge',
                    description:
                      'Helped a multi-location services brand systematically collect reviews from happy customers.',
                    metrics: [
                      {
                        label: 'New Reviews',
                        value: '480%',
                    ...
                    highlight: 'Trust Engine',
                    gradient: 'from-purple-600/20 to-blue-600/20',
                  },
                  {
                    title: 'Healthcare Reputation Lift',
                    description:
                      'Implemented compliant review workflows for a healthcare provider with multiple locations.',
                    metrics: [
                      {
                    ...
                    highlight: 'Reputation Turnaround',
                    gradient: 'from-blue-600/20 to-indigo-600/20',
                  },
                  {
                    title: 'Hospitality Review Strategy',
                    description:
                      'Boosted online reviews and ratings across OTA and review platforms for a hospitality brand.',
                    metrics: [
                      {
                        label: 'Review Volume',
                        value: '320%',
                    ...
                    highlight: 'Booking Boost',
                    gradient: 'from-purple-600/20 to-pink-600/20',
                  },
                  {
                    title: 'B2B Reviews & Case Proof',
                    description:
                      'Built a repeatable system to collect, approve, and showcase testimonials for a B2B company.',
                    metrics: [
                      {
          ...
          >
            ...
            <div className="max-w-7xl mx-auto relative z-10">
              <div className="text-center mb-16">
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
                  Our Proven Review Acceleration Approach
                </h2>
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  A clear, compliant process that turns happy customers into powerful online proof—without creating
                  ...
                  {[
                    {
                      ...
                      description:
                        'Review your current ratings, review volume, and platforms; then define clear targets by location and channel.',
                    ...
                    },
                    {
                      ...
                      description:
                        'Set up review request flows, messaging, and timing rules that feel natural and brand-safe.',
                    ...
                    },
                    {
                      ...
                      description:
                        'Start campaigns across SMS, email, and in-person touchpoints while monitoring volume and sentiment.',
                    ...
                    },
                    {
                      ...
                      description:
                        'Refine targeting and messaging, respond to reviews, and showcase proof across your site and campaigns.',
          ...
          >
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Everything you need to know about Online Review Acceleration, reputation management, and compliance.
                </p>
              </div>
              ...
              <div className="space-y-4">
                {[
                  {
                    question: 'How does Online Review Acceleration work?',
                    answer:
                      'Online Review Acceleration is a structured program that makes it easy for happy customers to leave reviews while minimizing friction and protecting your brand. We design compliant outreach flows via SMS, email, and in-person prompts, connect them to the right platforms, and monitor results so that you consistently collect more high-quality reviews over time.',
                  },
                  {
                    question: 'Is it compliant with platform policies and regulations?',
                    answer:
                      'Yes. We follow platform policies and legal guidelines by avoiding incentivized or misleading reviews, clearly separating feedback collection from public review requests where needed, and giving all customers an easy way to share honest feedback. Our flows are designed to be transparent, fair, and audit-friendly.',
                  },
                  {
                    question: 'How long does it take to see improvements in reviews and ratings?',
                    answer:
                      'Most businesses see a noticeable increase in fresh reviews within 4–6 weeks of launch, with rating improvements and ranking impact typically becoming clear within 2–4 months. The exact timeline depends on your existing volume, customer throughput, and how many locations or channels we are supporting.',
                  },
                  {
                    question: 'What is the typical investment for Online Review Acceleration?',
                    answer:
                      'Programs usually start around ₹35,000 per month and can go up to ₹1,25,000+ depending on the number of locations, platforms, automation complexity, and reporting needs. We scope pricing based on your footprint and goals so you can clearly see expected impact and ROI.',
                  },
                  {
                    question: 'Can you help us respond to reviews, not just collect them?',
                    answer:
                      'Yes. We can create response playbooks, templates, and workflows, or fully manage responses on your behalf within agreed guidelines. This includes handling positive and negative reviews, escalation rules, and coordination with your operations or customer service teams.',
                  },
                  {
                    question: 'Will this create extra work for our internal team?',
                    answer:
                      'Our goal is to reduce, not increase, workload. We automate as much of the review request and monitoring process as possible, while giving your team clear, simple actions when human involvement is needed—such as handling sensitive issues or celebrating standout feedback.',
                  },
                  {
                    question: 'Can you integrate review data into our existing dashboards and CRM?',
                    answer:
                      'Yes. We can push key review and rating metrics into your BI tools and CRM so that leadership, marketing, and operations teams can see trends alongside other performance data. This also enables advanced use cases like using review themes to inform product and service improvements.',
                  },
                  {
                    question: 'How do you report on progress and success?',
                    answer:
                      'You receive regular reports that track review volume, average rating, response times, sentiment, and platform/location breakdowns. We highlight key wins, issues, and recommendations so you always know how your reputation is evolving and what we are doing next to improve it.',
                  },
                ].map((faq, index) => (
                  <div
                    key={index}
...
export default OnlineReviewAcceleration; 