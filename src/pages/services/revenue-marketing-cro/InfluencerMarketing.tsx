...
const InfluencerMarketing = () => {
  ...
  const navItems = [
    ...
    { id: 'packages', label: 'Influencer Marketing Services Packages', icon: <DollarSign className="h-4 w-4" /> },
    { id: 'technology', label: 'Influencer Marketing Services Technology', icon: <Cpu className="h-4 w-4" /> },
    { id: 'case-studies', label: 'Influencer Marketing Services Case Studies', icon: <Trophy className="h-4 w-4" /> },
    { id: 'approach', label: 'Influencer Marketing Services Approach', icon: <Rocket className="h-4 w-4" /> },
  ...
  const seoConfig = {
    ...
    keywords: [
      'Influencer Marketing Services Delhi', 'Best influencer marketing agency in Delhi', 'Influencer marketing services NCR', 'Best influencer marketing services in India', 'Professional influencer marketing services India', 'Influencer marketing experts in Delhi NCR', 'Influencer marketing company India', 'SEO services in Delhi', 'Influencer marketing Delhi', 'Influencer marketing India'
    ],
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 transition-all duration-1000">
              Marktechrover: Best <span className="bg-gradient-to-r from-purple-300 via-purple-400 to-purple-500 bg-clip-text text-transparent font-extrabold">Influencer Marketing</span> in Delhi, NCR & India
            </h1>

            {/* Animated Description */}
            <p className="text-xl text-gray-300 mb-8 max-w-4xl mx-auto transition-all duration-1000 delay-300">
              Professional influencer marketing services in Delhi NCR. Get expert influencer marketing solutions with proven results and ROI.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center transition-all duration-1000 delay-1000">
              ...
              >
                <span className="relative z-10">Get Free Influencer Marketing Consultation</span>
      ...
      <div className={`fixed left-1/2 transform -translate-x-1/2 z-50 transition-all duration-500 ${isNavSticky ? 'top-32 opacity-100 scale-100' : 'top-0 opacity-0 scale-95 pointer-events-none'}`}>
        ...
        <div className="relative">
          ...
          <section id="deliverables" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                Influencer Marketing Services Deliverables
              </h2>
          ...
          <section id="packages" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                Influencer Marketing Services Packages
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
          ...
          <section id="technology" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                Influencer Marketing Services Technology
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
          ...
          <section id="case-studies" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                Influencer Marketing Services Case Studies
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
          ...
          <section id="approach" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                Influencer Marketing Services Approach
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
          ...
          <section id="faqs" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                Influencer Marketing Services FAQs
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                ...
                Get Influencer Marketing Quote
              </Link>
