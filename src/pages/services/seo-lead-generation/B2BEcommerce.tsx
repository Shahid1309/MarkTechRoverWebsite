  ...
  const packages = [
    {
      ...
      bestFor: 'Small B2B businesses starting with ecommerce',
      limitations: ['Limited customizations', 'Basic reporting only', 'No priority support']
    },
    {
      name: 'Professional',
      price: '₹1,89,000',
      monthlyPrice: '₹94,500/mo',
      platforms: 'Up to 2',
      ...
      savings: '₹10,000',
      features: [
        'Comprehensive B2B Platform Setup',
        'Advanced Product Catalog Management',
        'Custom B2B Customer Portal',
        'Advanced Payment & Credit Management',
        ...
        'Competitor Analysis',
        'Dedicated B2B Ecommerce Manager',
        'Priority Phone & Email Support',
        'Performance Optimization',
        'Multi-Platform Management'
      ],
      bestFor: 'Growing B2B businesses serious about ecommerce results',
      exclusiveFeatures: ['Exclusive: Custom B2B Workflows', 'Exclusive: Advanced Integration Support', 'Exclusive: Custom B2B Dashboard']
    },
    {
      name: 'Enterprise',
      price: '₹2,99,000',
      monthlyPrice: '₹1,49,500/mo',
      platforms: 'Unlimited',
      integrations: 'Unlimited',
      customizations: 'Full Custom',
      originalPrice: '₹3,09,000',
      savings: '₹10,000',
      features: [
        'Everything in Professional',
        'Unlimited Platform Management',
        'Full-Scale B2B Ecommerce Solutions',
        'International B2B Setup',
        'Multi-Platform Integration',
        'Advanced Analytics & Custom Reports',
        'Weekly Performance Reviews',
        'Dedicated B2B Ecommerce Team (3 specialists)',
      ...
      bestFor: 'Large B2B businesses requiring maximum ecommerce impact',
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center">
            ...
            <h1 className={`text-4xl md:text-6xl font-bold text-white mb-6 transition-all duration-1000 ${
              ...
              MarkTechRover: Delhi's <span className="bg-gradient-to-r from-purple-300 via-purple-400 to-purple-500 bg-clip-text text-transparent font-extrabold">B2B Ecommerce Enablement Agency</span> for Revenue Growth
            </h1>
      ...
      <section id="packages" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-900/5 via-transparent to-purple-900/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">B2B Ecommerce Enablement Plans Built for Growth</h2>
            <p className="text-gray-300 max-w-3xl mx-auto">Transparent monthly packages tailored for B2B businesses in Delhi & pan-India. Upgrade anytime. Every plan includes reporting, dashboards, and quarterly strategy reviews.</p>
            </div>
                ...
                <div className={`p-6 ${index === 1 ? 'pt-12' : 'pt-10'}`}>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-3 p-3 bg-transparent rounded-lg border border-white/20">
                      ...
                      <div className="text-center">
                        <div className="text-sm font-bold text-white">{pkg.integrations}</div>
                        <div className="text-xs text-gray-300">Integrations</div>
                      </div>
                      <div className="text-center">
                        <div className="text-sm font-bold text-white">{pkg.customizations}</div>
                        <div className="text-xs text-gray-300">Customizations</div>
                      </div>
                    </div>
                    ...
                    <div className="p-3 bg-transparent rounded-lg border border-white/20">
                      <h4 className="text-xs font-semibold text-white mb-2 flex items-center space-x-2">
                        ...
                        <span>Expected Results (6 months)</span>
                      </h4>
                      <div className="grid grid-cols-2 gap-2">
                        <div className="text-center p-2 bg-transparent rounded border border-white/15">
                          ...
                          <div className="text-xs text-gray-300">B2B Traffic</div>
                        </div>
                        <div className="text-center p-2 bg-transparent rounded border border-white/15">
                          <div className="text-sm font-bold text-white">
                            {index === 0 ? '+250%' : index === 1 ? '+350%' : '+450%'}
                          </div>
                          <div className="text-xs text-gray-300">B2B Sales</div>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="mt-16 text-center">
            <div className="bg-gradient-to-r from-purple-900/20 to-purple-800/20 rounded-2xl p-8 border border-purple-500/20">
              <h3 className="text-2xl font-bold text-white mb-6">Why 500+ B2B Businesses Trust Us</h3>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="text-center">
                  ...
                  <div className="text-gray-400 text-sm">B2B Ecommerce</div>
                </div>
                <div className="text-center">
