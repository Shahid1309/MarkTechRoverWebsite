...
const EcommerceSocial = () => {
  ...
  const seoConfig = {
    ...
    keywords: [
      'Ecommerce Social Media Advertising Delhi', 'Best ecommerce social ads agency in Delhi', 'Ecommerce social media advertising services NCR', 'Best ecommerce social media advertising services in India', 'Professional ecommerce social ads services India', 'Ecommerce social media advertising experts in Delhi NCR', 'Ecommerce social ads company India', 'SEO services in Delhi', 'Ecommerce social media marketing Delhi', 'Ecommerce social media advertising India'
    ],
  ...
  const deliverables = [
    {
      title: 'Facebook & Instagram Shopping Ads',
      description: 'Complete setup and ongoing management of Facebook and Instagram Shopping campaigns. We create product catalogs, set up dynamic product ads, optimize for conversions, and ensure your products appear in social feeds with maximum visibility and performance.',
      icon: <ShoppingCart className="h-6 w-6" />
    },
    {
      title: 'Ecommerce Social Media Campaigns',
      description: 'Strategic social media advertising campaigns specifically optimized for ecommerce. We create product-focused ad sets, optimize targeting for commercial intent, and develop ad creative that drives qualified traffic to your product pages.',
      icon: <Megaphone className="h-6 w-6" />
    },
    {
      title: 'Product Catalog Management',
      description: 'Professional management of product catalogs across Facebook, Instagram, and other social platforms. We optimize product feeds, improve product data quality, and ensure your products appear in relevant social feeds with compelling visuals and pricing.',
      icon: <Layers className="h-6 w-6" />
    },
    {
      title: 'Ecommerce Social Remarketing',
      description: 'Comprehensive social remarketing campaigns to re-engage visitors and drive conversions. We create visual ads, build remarketing audiences, and implement dynamic remarketing that shows visitors the exact products they viewed.',
      icon: <Eye className="h-6 w-6" />
    },
    {
      title: 'Ecommerce Social Video Ads',
      description: 'Advanced video advertising campaigns that leverage social media\'s visual power to maximize ecommerce conversions. We create product videos, optimize for engagement, and drive sales through compelling video content.',
      icon: <Video className="h-6 w-6" />
    },
    {
      title: 'Ecommerce Social Influencer Marketing',
      description: 'Strategic influencer partnerships and campaigns to reach new audiences and drive ecommerce sales. We identify relevant influencers, create authentic content, and measure ROI from influencer collaborations.',
      icon: <Users className="h-6 w-6" />
    },
    {
      title: 'Ecommerce Social Landing Page Optimization',
      description: 'Conversion-focused landing page optimization for social media traffic. We optimize product pages, category pages, and checkout flows to improve conversion rates and maximize the value of your social traffic.',
      icon: <MousePointer className="h-6 w-6" />
    },
    {
      title: 'Ecommerce Social Conversion Tracking & Analytics',
      description: 'Comprehensive conversion tracking setup including Facebook Pixel, Instagram tracking, and cross-platform attribution. We provide detailed analytics that connect social media performance to revenue and ROI.',
      icon: <BarChart3 className="h-6 w-6" />
    },
    {
      title: 'Ecommerce Social A/B Testing & Experimentation',
      description: 'Continuous A/B testing of ad creatives, landing pages, and targeting strategies. We run systematic experiments to identify winning strategies and optimize for maximum performance.',
      icon: <Activity className="h-6 w-6" />
    },
    {
      title: 'Ecommerce Social Budget Management & Scaling',
      description: 'Strategic budget allocation and scaling strategies. We optimize budget distribution across platforms, identify scaling opportunities, and ensure efficient spend allocation that maximizes revenue growth.',
  ...
  const packages = [
    {
      ...
      savings: '₹10,000',
      features: [
        'Facebook & Instagram Shopping Ads Setup',
        'Basic Social Campaigns (10 campaigns)',
        'Product Catalog Optimization',
        'Basic Social Remarketing',
        'Monthly Performance Reports',
        'Email Support',
        'Basic Conversion Tracking',
        'Monthly Optimization'
      ],
      bestFor: 'Small ecommerce stores starting with social media advertising',
    ...
    },
    {
      ...
      savings: '₹10,000',
      features: [
        'Comprehensive Facebook & Instagram Shopping Management',
        'Advanced Social Campaigns (30 campaigns)',
        'Video Advertising Campaigns',
        'Advanced Social Remarketing',
        ...
        'Competitor Analysis',
        'Dedicated Ecommerce Social Media Manager',
        'Priority Phone & Email Support',
        'Budget Optimization & Scaling',
        'Cross-Platform Campaign Management'
      ],
      bestFor: 'Growing ecommerce businesses serious about social media advertising results',
      exclusiveFeatures: ['Exclusive: AI-Powered Audience Targeting', 'Exclusive: Advanced Attribution Modeling', 'Exclusive: Custom Ecommerce Social Dashboard']
    },
    {
      name: 'Enterprise',
      price: '₹1,59,000',
      monthlyPrice: '₹79,500/mo',
      campaigns: 'Unlimited',
      adGroups: 'Unlimited',
      adCreatives: '200',
      originalPrice: '₹1,69,000',
      savings: '₹10,000',
      features: [
        'Everything in Professional',
        'Unlimited Campaign Management',
        'Full-Scale Social Shopping & Video Campaigns',
        'International Ecommerce Social Setup',
        'Multi-Platform Campaign Management',
        'Advanced Analytics & Custom Reports',
        'Weekly Performance Reviews',
        'Dedicated Ecommerce Social Team (3 specialists)',
        '24/7 Priority Support',
        'Custom Integrations & Automation',
        'Advanced Video Ads',
        'Enterprise-Level Budget Management',
        'Strategic Consulting & Advisory',
        'Executive Reporting & Dashboards'
      ],
      bestFor: 'Large ecommerce businesses requiring maximum social media advertising impact',
  ...
  const technologyFeatures = [
    {
      title: 'Real-Time Ecommerce Social Monitoring',
      description: 'Track your ecommerce social ad performance across all platforms—updated in real-time.',
      icon: <Activity className="h-8 w-8" />
    },
    {
      title: 'AI-Powered Ecommerce Audience Targeting',
      description: 'Discover high-value ecommerce audiences and optimize targeting automatically.',
    ...
    {
      title: 'Automated Ecommerce Optimization',
      description: 'Proactive campaign adjustments and alerts—never miss optimization opportunities.',
      icon: <Shield className="h-8 w-8" />
    },
    {
      title: 'Ecommerce Performance Dashboards',
      description: 'Access all ecommerce analytics, conversions, revenue, and growth metrics anytime.',
  ...
  const caseStudies = [
    {
      title: 'Ecommerce Brand Achieves 500% ROI',
      description: 'With Marktechrover\'s ecommerce social media advertising strategy, an online store achieved 500% ROI through Facebook and Instagram Shopping campaigns—results that brought in ₹40+ crores in revenue within six months.',
      metric: '500% ROI',
      timeframe: '6 Months'
    },
    {
      title: 'NCR-Based Ecommerce Firm Dominates Social Shopping',
      description: 'We helped a large ecommerce business go from zero to market leader in NCR\'s online retail space. The blend of Facebook Shopping and Instagram campaigns brought in enterprise-level sales—beyond expectations.',
      metric: 'Enterprise Sales',
      timeframe: 'Social Dominance'
    },
    {
      title: 'Pan-India Ecommerce Expands Nationally',
      description: 'We enabled a pan-India ecommerce business to expand nationally through strategic social media campaigns. Our multi-platform strategy drove national reach and conversions.',
  ...
  const approachSteps = [
    {
      step: 'Step 1: Ecommerce Social Strategy & Audit',
      description: 'Understand your ecommerce goals, current social performance, and competitor landscape.',
      detailedDescription: 'We conduct a comprehensive analysis of your current ecommerce social media performance, competitor strategies, and market opportunities. This includes account audit, product catalog review, and campaign performance analysis.',
      icon: <Search className="h-6 w-6" />,
      duration: '1-2 weeks',
      deliverables: ['Ecommerce Social Audit', 'Competitor Analysis', 'Product Catalog Review', 'Campaign Strategy'],
      color: 'from-blue-500 to-blue-600',
      bgColor: 'from-blue-500/20 to-blue-600/20'
    },
    {
      step: 'Step 2: Custom Ecommerce Roadmap',
      description: 'No generic plans—only tailored, goal-oriented ecommerce social media strategies.',
      detailedDescription: 'Based on our audit findings, we create a personalized ecommerce social media roadmap that aligns with your business objectives. This includes campaign structure, budget allocation, and timeline projections.',
      icon: <Target className="h-6 w-6" />,
      duration: '1 week',
      deliverables: ['Custom Ecommerce Social Strategy', 'Campaign Architecture', 'Budget Plan', 'Timeline Projections'],
      color: 'from-purple-500 to-purple-600',
      bgColor: 'from-purple-500/20 to-purple-600/20'
    },
    {
      step: 'Step 3: Ecommerce Campaign Launch',
      description: 'Shopping Ads, Video campaigns, Remarketing, and Influencer marketing delivered together.',
      detailedDescription: 'Our comprehensive execution covers all aspects of ecommerce social media simultaneously. We set up Shopping campaigns, create video ads, implement remarketing, and launch influencer partnerships.',
      icon: <Layers className="h-6 w-6" />,
      duration: 'Ongoing',
      deliverables: ['Shopping Ads Setup', 'Video Campaigns', 'Social Remarketing', 'Influencer Marketing'],
    ...
    },
    {
      ...
      detailedDescription: 'We continuously monitor your ecommerce campaigns, optimize based on performance data, and adapt to market changes. Regular strategy reviews ensure we stay ahead of the competition.',
      icon: <RefreshCw className="h-6 w-6" />,
      duration: 'Monthly',
      deliverables: ['Performance Monitoring', 'Audience Optimization', 'Budget Optimization', 'Creative Testing'],
  ...
  const faqs = [
    {
      question: 'How soon will I see ecommerce social media advertising results?',
      answer: 'Expect to see initial ecommerce social results within 1-2 weeks for most campaigns, with significant improvements in traffic, conversions, and ROI achieved within 3-4 months. The biggest gains come from committed ecommerce clients with sustained monthly optimization.',
      category: 'timeline',
      tags: ['results', 'timeline', 'performance']
    },
    {
      question: 'Is all work original and platform-compliant for ecommerce?',
      answer: 'Yes! All ecommerce ad creatives and strategies are created by our team and follow Facebook, Instagram, and other platform best practices for safety and long-term ecommerce success.',
      category: 'safety',
      tags: ['compliance', 'safety', 'platforms']
    },
    {
      question: 'Which ecommerce social media advertising plan should I pick?',
      answer: 'Pick an ecommerce social plan that matches your store size and growth goals, or ask for a free, custom ecommerce audit and recommendation from our team.',
      category: 'pricing',
      tags: ['packages', 'pricing', 'selection']
    },
    {
      question: 'Can I scale my ecommerce social package later?',
      answer: 'Absolutely. Our ecommerce social packages are flexible—upgrade or customize at any time as your store grows and you add more products.',
      category: 'pricing',
      tags: ['scaling', 'flexibility', 'upgrades']
    },
    {
      question: 'What\'s included in ecommerce social media advertising reporting?',
      answer: 'You\'ll get interactive dashboards, campaign performance reports, conversion tracking, and ROI analysis every month, specifically focused on ecommerce metrics.',
      category: 'reporting',
      tags: ['analytics', 'reports', 'tracking']
    },
    {
      question: 'Do you work with ecommerce businesses outside Delhi NCR?',
      answer: 'Yes, we serve ecommerce clients globally. While we\'re based in Delhi, NCR, our ecommerce social strategies work for online stores worldwide, with specialized optimization for Indian markets.',
      category: 'service',
      tags: ['international', 'global', 'local']
    },
    {
      question: 'What makes your ecommerce social media advertising different from others?',
      answer: 'Our data-driven ecommerce approach, transparent reporting, and focus on ROI set us apart. We don\'t just run ads—we drive measurable ecommerce growth and sales.',
      category: 'service',
    ...
    <>
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center mb-6">
              <div className={`w-20 h-20 bg-gradient-to-br from-purple-500 via-purple-400 to-purple-600 rounded-2xl flex items-center justify-center shadow-lg shadow-purple-500/25 transition-all duration-1000 ${
                ...
                <Share2 className={`h-10 w-10 text-white transition-all duration-1000 ${
            ...
            <h1 className={`text-4xl md:text-6xl font-bold text-white mb-6 transition-all duration-1000 ${
              ...
              MarkTechRover: Delhi's <span className="bg-gradient-to-r from-purple-300 via-purple-400 to-purple-500 bg-clip-text text-transparent font-extrabold">Ecommerce Social Media Advertising Agency</span> for Revenue Growth
            </h1>
            ...
            <p className={`text-xl text-gray-300 mb-8 max-w-4xl mx-auto transition-all duration-1000 delay-300 ${
              ...
              Grow with a Delhi-based team that blends AI insights with full-funnel ecommerce social media advertising. We focus on measurable ROI, transparent reporting, and strategies tuned for India's ecommerce landscape—so you win across Facebook, Instagram, and beyond.
            </p>
            ...
            <div className={`grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 transition-all duration-1000 delay-500 ${
              ...
              <div className="text-center group cursor-pointer transform hover:scale-105 transition-all duration-300">
                ...
                <div className="text-gray-300 font-semibold">Ecommerce Social Awards</div>
            ...
            <div className={`flex flex-wrap justify-center gap-6 mb-8 transition-all duration-1000 delay-700 ${
              ...
              <div className="flex items-center space-x-2 bg-gray-800/50 px-4 py-2 rounded-lg border border-gray-700">
                ...
                <span className="text-gray-300 text-sm">Facebook Partner</span>
              </div>
              <div className="flex items-center space-x-2 bg-gray-800/50 px-4 py-2 rounded-lg border border-gray-700">
            ...
            <div className={`flex flex-col sm:flex-row gap-4 justify-center transition-all duration-1000 delay-1000 ${
              ...
              >
                <span className="relative z-10">Get Free Ecommerce Social Consultation</span>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-black/40 via-purple-900/10 to-black/40">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">The Ecommerce Social Media Advertising Company Built for 2025</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="rounded-2xl p-6 border border-purple-500/20 bg-gradient-to-br from-purple-900/10 to-purple-800/10">
              <div className="flex items-center space-x-3 mb-3">
                ...
                <h3 className="text-white font-semibold">AI-Powered Ecommerce Social</h3>
              </div>
              <p className="text-gray-300 text-sm">Target the right product and category audiences. Stay ahead as ecommerce social media advertising evolves.</p>
            </div>
            <div className="rounded-2xl p-6 border border-purple-500/20 bg-gradient-to-br from-purple-900/10 to-purple-800/10">
              <div className="flex items-center space-x-3 mb-3">
              ...
              <p className="text-gray-300 text-sm">A cross-functional team for Shopping Ads, Video campaigns, Influencer marketing, and CRO — aligned to your ecommerce goals.</p>
            </div>
            <div className="rounded-2xl p-6 border border-purple-500/20 bg-gradient-to-br from-purple-900/10 to-purple-800/10">
              <div className="flex items-center space-x-3 mb-3">
              ...
              <p className="text-gray-300 text-sm">Dashboards that connect social media performance to product sales and revenue — not just engagement.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              At Marktechrover, our ecommerce social media advertising deliverables are crafted to help you reach the right customers, drive more qualified traffic, and convert more visitors—month after month:
            </p>
          </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="bg-gradient-to-r from-purple-900/20 to-purple-800/20 rounded-xl p-6 border border-purple-500/20">
                        ...
                        <ul className="space-y-3 text-gray-300">
                          <li className="flex items-start space-x-3">
                            ...
                            <span className="text-sm">Professional implementation by certified ecommerce social media experts</span>
                          </li>
                          <li className="flex items-start space-x-3">
                            <div className="w-2 h-2 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
                      ...
                      <div className="bg-gradient-to-r from-green-900/20 to-green-800/20 rounded-xl p-6 border border-green-500/20">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div className="text-center p-3 bg-blue-900/20 rounded-lg">
                            ...
                            <div className="text-xs text-blue-200">Traffic Increase</div>
                          </div>
                          <div className="text-center p-3 bg-blue-900/20 rounded-lg">
                      ...
                      <div className="bg-gradient-to-r from-blue-900/20 to-blue-800/20 rounded-xl p-6 border border-blue-500/20">
                        ...
                        <div className="space-y-4">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              <div className="text-blue-200 font-semibold">Week 1-2: Ecommerce Social Audit</div>
                              <div className="text-blue-100 text-sm">Account audit, product catalog review, and strategy planning</div>
                            </div>
                          </div>
                          <div className="flex items-center space-x-3">
                            <div className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center text-white text-sm font-bold">2</div>
                            <div>
                              <div className="text-blue-200 font-semibold">Week 3-12: Campaign Launch</div>
                              <div className="text-blue-100 text-sm">Shopping Ads, Video campaigns, and Social remarketing setup</div>
                            </div>
                          </div>
                          <div className="flex items-center space-x-3">
                      ...
                      <div className="bg-gradient-to-r from-purple-900/20 to-purple-800/20 rounded-xl p-6 border border-purple-500/20">
                        ...
                        <div className="grid grid-cols-2 gap-3 text-sm">
                          ...
                          <div className="flex items-center space-x-2">
                            <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
                            <span className="text-gray-300">Facebook Shopping</span>
                          </div>
                          <div className="flex items-center space-x-2">
                            <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
      ...
      <section id="packages" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-900/5 via-transparent to-purple-900/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">Ecommerce Social Media Advertising Plans Built for Growth</h2>
                ...
                <div className={`p-6 ${index === 1 ? 'pt-12' : 'pt-10'}`}>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-3 p-3 bg-transparent rounded-lg border border-white/20">
                      ...
                      <div className="text-center">
                        <div className="text-sm font-bold text-white">{pkg.adGroups}</div>
                        <div className="text-xs text-gray-300">Ad Groups</div>
                      </div>
                      <div className="text-center">
                    ...
                    <div className="p-3 bg-transparent rounded-lg border border-white/20">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        <div className="text-center p-2 bg-transparent rounded border border-white/15">
                          <div className="text-sm font-bold text-white">
                            {index === 0 ? '+250%' : index === 1 ? '+350%' : '+450%'}
                          </div>
                          <div className="text-xs text-gray-300">Ecommerce Sales</div>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="bg-gradient-to-r from-purple-900/20 to-purple-800/20 rounded-2xl p-8 border border-purple-500/20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="text-center">
                  ...
                  <div className="text-gray-400 text-sm">Ecommerce Social</div>
                </div>
                <div className="text-center">
      ...
      <section id="technology" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-900/5 via-transparent to-purple-900/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Our Technology: Smarter Ecommerce Social Media Advertising for Modern Results
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Marktechrover invests in powerful ecommerce tools and automation to keep your social media advertising strategy one step ahead
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm">
              ...
              <p className="text-gray-300 mb-4">
                "Marktechrover transformed our ecommerce social media advertising completely. We went from zero to ₹40+ crores in revenue through Facebook and Instagram Shopping campaigns—results that brought in 5X qualified traffic and 500% ROI within six months!"
              </p>
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm">
              ...
              <p className="text-gray-300 mb-4">
                "The ecommerce social media team at Marktechrover is incredibly professional and results-driven. Our Facebook Shopping conversions increased by 500% within the first year of working with them."
              </p>
              <div className="flex items-center">
                <div className="w-10 h-10 bg-gradient-to-br from-purple-500 via-purple-400 to-purple-600 rounded-full flex items-center justify-center mr-3">
                  <Users className="h-5 w-5 text-white" />
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm">
              ...
              <p className="text-gray-300 mb-4">
                "Best investment we've made for our ecommerce. Marktechrover's social media advertising expertise helped us dominate the NCR market and attract high-quality social traffic."
              </p>
              <div className="flex items-center">
                <div className="w-10 h-10 bg-gradient-to-br from-purple-500 via-purple-400 to-purple-600 rounded-full flex items-center justify-center mr-3">
                  <Users className="h-5 w-5 text-white" />
      ...
      <section id="approach" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              A proven 5-step ecommerce social media advertising process that delivers consistent results
            </p>
          </div>
          ...
          <div className="text-center mt-12">
            <div className="bg-gradient-to-r from-purple-900/20 to-purple-800/20 rounded-2xl p-8 border border-purple-500/20">
              <h3 className="text-2xl font-bold text-white mb-4">
                Ready to Start Your Ecommerce Social Media Advertising Journey?
              </h3>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                >
                  Get Free Ecommerce Social Audit
                </Link>
                <Link
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Everything you need to know about our ecommerce social media advertising services
            </p>
          ...
          <div className="mt-12 text-center">
            <div className="bg-gradient-to-r from-purple-900/20 to-purple-800/20 rounded-2xl p-6 border border-purple-500/20">
              ...
              <p className="text-gray-300 mb-4">
                Can't find what you're looking for? Our ecommerce social media advertising experts are here to help!
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  to="/contact"
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-900/5 via-transparent to-purple-900/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Why Choose Marktechrover for Ecommerce Social Media Advertising?
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              We're not just another social media agency. We're your strategic partner for ecommerce digital growth.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm hover:border-purple-400/40 transition-all duration-300">
              ...
              <p className="text-gray-400">We focus on measurable ecommerce outcomes, not just engagement.</p>
            </div>
            ...
            <div className="text-center p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm hover:border-purple-400/40 transition-all duration-300">
              ...
              <p className="text-gray-400">All our ecommerce social strategies comply with Facebook, Instagram, and other platform best practices.</p>
            </div>
            ...
            <div className="text-center p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm hover:border-purple-400/40 transition-all duration-300">
              ...
              <p className="text-gray-400">Certified ecommerce social media specialists with years of experience.</p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Ready to dominate ecommerce social media?
              </h2>
              <p className="text-xl text-gray-300 mb-8">
                Partner with Marktechrover—the best ecommerce social media advertising service provider in Delhi, NCR, and across India. Get in touch for a free consultation or a detailed proposal tailored to your ecommerce goals!
              </p>
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-6 w-6 text-green-400 flex-shrink-0" />
                  <span className="text-gray-300">Free ecommerce social audit worth ₹25,000</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-6 w-6 text-green-400 flex-shrink-0" />
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-r from-purple-900/20 via-purple-800/20 to-purple-900/20 border border-purple-500/30 backdrop-blur-sm">
              <div className="text-center">
                ...
                <div className="space-y-4">
                  ...
                  >
                    Get Free Ecommerce Social Consultation
                  </Link>
                  <Link
                    to="/contact"
...
export default EcommerceSocial; 