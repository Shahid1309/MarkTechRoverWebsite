...
const EcommerceSEO = () => {
  ...
  const seoConfig = {
    ...
    keywords: [
      'Ecommerce SEO Services Delhi', 'Best ecommerce SEO agency in Delhi', 'Ecommerce SEO services NCR', 'Best ecommerce SEO services in India', 'Professional ecommerce SEO services India', 'Ecommerce SEO experts in Delhi NCR', 'Ecommerce SEO company India', 'SEO services in Delhi', 'Ecommerce SEO Delhi', 'Ecommerce SEO optimization India'
    ],
  ...
  const deliverables = [
    {
      title: 'Ecommerce Technical SEO Audit',
      description: 'Comprehensive technical SEO audit specifically for ecommerce platforms. We analyze site structure, crawlability, indexability, page speed, mobile responsiveness, and technical issues that prevent search engines from properly ranking your online store. Our audit covers product pages, category pages, checkout flows, and all critical ecommerce elements.',
      icon: <Settings className="h-6 w-6" />
    },
    {
      title: 'Product Page SEO Optimization',
      description: 'Complete optimization of product pages for maximum search visibility. We optimize product titles, descriptions, images, schema markup, and internal linking structure. Our optimization ensures your products rank for relevant search queries and appear in Google Shopping results, driving qualified traffic to your store.',
      icon: <ShoppingCart className="h-6 w-6" />
    },
    {
      title: 'Category & Collection Page Optimization',
      description: 'Strategic optimization of category and collection pages to rank for high-value commercial keywords. We create optimized category structures, improve internal linking, and develop content that helps search engines understand your product taxonomy. This drives category-level traffic and improves overall site authority.',
      icon: <Layers className="h-6 w-6" />
    },
    {
      title: 'Ecommerce Keyword Research & Mapping',
      description: 'Data-driven keyword research specifically for ecommerce, including product keywords, category keywords, and commercial intent terms. We map keywords to specific products and pages, identify long-tail opportunities, and create content strategies that target your ideal customer search behavior.',
      icon: <Search className="h-6 w-6" />
    },
    {
      title: 'Ecommerce Schema Markup & Rich Snippets',
      description: 'Implementation of advanced schema markup including Product schema, Review schema, Breadcrumb schema, and Organization schema. We ensure your products display rich snippets in search results with prices, ratings, availability, and other key information that improves click-through rates.',
      icon: <FileText className="h-6 w-6" />
    },
    {
      title: 'Ecommerce Content Strategy & Creation',
      description: 'Strategic content creation for ecommerce including product descriptions, category descriptions, blog content, and buying guides. Our content is optimized for both search engines and conversions, helping you rank for commercial keywords while providing value to potential customers.',
      icon: <PenTool className="h-6 w-6" />
    },
    {
      title: 'Ecommerce Link Building & Outreach',
      description: 'Strategic link building specifically for ecommerce businesses. We earn high-authority backlinks through product reviews, industry partnerships, influencer collaborations, and digital PR campaigns. Our link building focuses on improving domain authority and product page rankings.',
      icon: <ExternalLink className="h-6 w-6" />
    },
    {
      title: 'Ecommerce Site Speed & Performance Optimization',
      description: 'Comprehensive site speed optimization for ecommerce platforms. We optimize images, implement lazy loading, improve server response times, and optimize critical rendering paths. Faster sites rank better in search results and provide better user experience, leading to higher conversions.',
      icon: <Zap className="h-6 w-6" />
    },
    {
      title: 'Ecommerce Local SEO (if applicable)',
      description: 'Local SEO optimization for ecommerce businesses with physical locations or local delivery. We optimize Google Business Profile, manage local citations, and implement local schema markup. This helps you rank in local search results and attract customers in your service area.',
      icon: <MapPin className="h-6 w-6" />
    },
    {
      title: 'Ecommerce Analytics & Conversion Tracking',
      description: 'Comprehensive ecommerce analytics setup and tracking. We implement enhanced ecommerce tracking, monitor product performance, track conversion funnels, and provide insights into how SEO drives revenue. Our analytics help you understand which products and pages generate the most value.',
  ...
  const packages = [
    {
      ...
      features: [
        ...
        'Product Page Optimization (500 products)',
        'Basic Category Page Optimization',
      ...
      bestFor: 'Small ecommerce stores starting with SEO',
      limitations: ['Limited product optimization', 'Basic reporting only', 'No priority support']
    },
    {
      name: 'Professional',
      price: '₹69,000',
      monthlyPrice: '₹34,500/mo',
      products: 'Up to 2000',
      pages: 'Up to 80',
      contentAssets: '18',
      ...
      savings: '₹10,000',
      features: [
        'Comprehensive Ecommerce Technical SEO Audit',
        'Advanced Product Page Optimization (2000 products)',
        'Complete Category & Collection Page Optimization',
        'Advanced Keyword Research & Mapping',
        'Advanced Schema Markup & Rich Snippets',
        'Ecommerce Content Strategy & Creation',
        'Ecommerce Link Building Strategy',
        'Site Speed & Performance Optimization',
        'Advanced Analytics & Conversion Tracking',
        'Monthly & Quarterly Detailed Reports',
        'Competitor Analysis & Strategy',
        'Dedicated Ecommerce SEO Manager',
        'Priority Phone & Email Support',
        'Ecommerce Conversion Optimization',
        'Google Shopping Optimization'
      ],
      bestFor: 'Growing ecommerce businesses serious about SEO results',
      exclusiveFeatures: ['Exclusive: AI-Powered Product Optimization', 'Exclusive: Advanced Competitor Tracking', 'Exclusive: Custom Ecommerce SEO Dashboard']
    },
    {
      name: 'Enterprise',
      price: '₹1,29,000',
      monthlyPrice: '₹64,500/mo',
      products: 'Unlimited',
      pages: 'Unlimited',
      contentAssets: '40',
      originalPrice: '₹1,39,000',
      savings: '₹10,000',
      features: [
        'Everything in Professional',
        'Unlimited Product & Page Optimization',
        'Full-Scale Ecommerce Content Strategy',
        'Advanced Ecommerce Link Building Campaigns',
        'International Ecommerce SEO Setup',
        'Multi-Platform Ecommerce Optimization',
        'Advanced Analytics & Custom Reports',
        'Weekly Performance Reviews',
        'Dedicated Ecommerce SEO Team (3 specialists)',
        '24/7 Priority Support',
        'Custom Ecommerce SEO Tools & Integrations',
        'Advanced Schema Implementation',
        'Voice Search Optimization',
        'Video SEO for Product Pages',
        'Ecommerce Conversion Rate Optimization'
      ],
      bestFor: 'Large ecommerce businesses requiring maximum SEO impact',
  ...
  const technologyFeatures = [
    {
      title: 'Real-Time Ecommerce Rank Monitoring',
      description: 'Watch your product and category keywords move up—updated daily.',
      icon: <Activity className="h-8 w-8" />
    },
    {
      title: 'AI-Powered Ecommerce Keyword & Content Research',
      description: 'Surface ecommerce opportunities the competition misses.',
      icon: <Brain className="h-8 w-8" />
    },
    {
      title: 'Ecommerce Competitor Intelligence',
      description: 'Benchmark against ecommerce competitors in Delhi, NCR, and all of India.',
      icon: <Eye className="h-8 w-8" />
    },
    {
      title: 'Ecommerce Site Health Automation',
      description: 'Proactive crawling and alerts—never get blindsided by technical errors.',
      icon: <Shield className="h-8 w-8" />
    },
    {
      title: 'Live Ecommerce Performance Dashboards',
      description: 'Access all ecommerce analytics, rankings, conversions, and growth metrics anytime.',
  ...
  const caseStudies = [
    {
      title: 'Ecommerce Brand Skyrockets to #1 in Product Rankings',
      description: 'With Marktechrover\'s ecommerce SEO strategy, our online store jumped from page 4 to the Google top spot for our main product keywords—results that brought in 4X qualified traffic and 5X sales within six months.',
      metric: '5X Sales Increase',
      timeframe: '6 Months'
    },
    {
      title: 'NCR-Based Ecommerce Firm Dominates Category Search',
      description: 'We went from invisible to the go-to in NCR\'s ecommerce scene. The blend of category optimization and technical fixes brought in enterprise-level traffic—beyond our expectations.',
      metric: 'Enterprise Traffic',
      timeframe: 'Category Dominance'
    },
    {
      title: 'Pan-India Ecommerce Business Expands Nationally',
      description: 'We cracked the code for national ecommerce rankings. Our search visibility, product rankings, and conversions grew and continue to trend upward every month.',
      metric: 'National Rankings',
  ...
  const approachSteps = [
    {
      step: 'Step 1: Ecommerce Strategy Audit',
      description: 'Understand your ecommerce goals, current rankings, and competitor landscape.',
      detailedDescription: 'We conduct a comprehensive analysis of your current ecommerce SEO performance, competitor strategies, and market opportunities. This includes technical audits, product page analysis, and category performance review.',
      icon: <Search className="h-6 w-6" />,
      duration: '1-2 weeks',
      deliverables: ['Ecommerce Technical SEO Audit', 'Competitor Analysis', 'Keyword Research', 'Product Page Analysis'],
      color: 'from-blue-500 to-blue-600',
      bgColor: 'from-blue-500/20 to-blue-600/20'
    },
    {
      step: 'Step 2: Custom Ecommerce Roadmap',
      description: 'No generic plans—only tailored, goal-oriented ecommerce strategies.',
      detailedDescription: 'Based on our audit findings, we create a personalized ecommerce SEO roadmap that aligns with your business objectives. This includes product optimization priorities, category strategy, and timeline projections.',
      icon: <Target className="h-6 w-6" />,
      duration: '1 week',
      deliverables: ['Custom Ecommerce SEO Strategy', 'Product Optimization Plan', 'Content Calendar', 'Timeline Projections'],
      color: 'from-purple-500 to-purple-600',
      bgColor: 'from-purple-500/20 to-purple-600/20'
    },
    {
      step: 'Step 3: Full-Stack Ecommerce Execution',
      description: 'Product pages, category pages, content, technical, and link building delivered together.',
      detailedDescription: 'Our comprehensive execution covers all aspects of ecommerce SEO simultaneously. We optimize product pages, category pages, create content, build links, and ensure technical excellence.',
      icon: <Layers className="h-6 w-6" />,
      duration: 'Ongoing',
      deliverables: ['Product Page Optimization', 'Category Optimization', 'Content Creation', 'Link Building'],
      color: 'from-green-500 to-green-600',
      bgColor: 'from-green-500/20 to-green-600/20'
    },
    {
      step: 'Step 4: Ongoing Ecommerce Optimization',
      description: 'Monthly calls, proactive reporting, and constant adaptation to algorithm updates.',
      detailedDescription: 'We continuously monitor your ecommerce performance, adapt to algorithm changes, and optimize based on data insights. Regular strategy reviews ensure we stay ahead of the competition.',
      icon: <RefreshCw className="h-6 w-6" />,
      duration: 'Monthly',
      deliverables: ['Performance Monitoring', 'Algorithm Adaptation', 'Strategy Refinement', 'Competitor Tracking'],
  ...
  const faqs = [
    {
      question: 'How soon will I see ecommerce SEO results?',
      answer: 'Expect to see ranking lifts and traffic improvements within 4–6 months for most ecommerce sites, with the biggest gains achieved by committed clients and sustained monthly optimization.',
      category: 'timeline',
      tags: ['results', 'timeline', 'performance']
    },
    {
      question: 'Is all work original and Google-safe for ecommerce?',
      answer: 'Yes! All content and links are created by Indian SEO specialists and follow Google\'s best practices for safety and long-term ranking. We ensure all product descriptions and content are original.',
      category: 'safety',
      tags: ['google', 'safety', 'compliance']
    },
    {
      question: 'Which ecommerce plan should I pick?',
      answer: 'Pick a plan that matches your ecommerce store size and growth goals, or ask for a free, custom ecommerce audit and recommendation from our team.',
      category: 'pricing',
      tags: ['packages', 'pricing', 'selection']
    },
    {
      question: 'Can I scale my ecommerce package later?',
      answer: 'Absolutely. Our ecommerce packages are flexible—upgrade or customize at any time as your store grows and you add more products.',
      category: 'pricing',
      tags: ['scaling', 'flexibility', 'upgrades']
    },
    {
      question: 'What\'s included in ecommerce reporting?',
      answer: 'You\'ll get interactive dashboards, product ranking reports, traffic analysis, and conversion tracking every month, specifically focused on ecommerce metrics.',
      category: 'reporting',
      tags: ['analytics', 'reports', 'tracking']
    },
    {
      question: 'Do you work with ecommerce businesses outside Delhi NCR?',
      answer: 'Yes, we serve ecommerce clients globally. While we\'re based in Delhi, NCR, our ecommerce SEO strategies work for online stores worldwide, with specialized optimization for Indian markets.',
      category: 'service',
      tags: ['international', 'global', 'local']
    },
    {
      question: 'What makes your ecommerce SEO different from others?',
      answer: 'Our data-driven ecommerce approach, transparent reporting, and focus on ROI set us apart. We don\'t just improve rankings—we drive measurable ecommerce growth and sales.',
      category: 'service',
    ...
    <>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center">
            ...
            <h1 className={`text-4xl md:text-6xl font-bold text-white mb-6 transition-all duration-1000 ${
              ...
              MarkTechRover: Delhi's <span className="bg-gradient-to-r from-purple-300 via-purple-400 to-purple-500 bg-clip-text text-transparent font-extrabold">Ecommerce SEO Agency</span> for Revenue Growth
            </h1>
            ...
            <p className={`text-xl text-gray-300 mb-8 max-w-4xl mx-auto transition-all duration-1000 delay-300 ${
              ...
              Grow with a Delhi-based team that blends AI insights with full-funnel ecommerce SEO. We focus on measurable ROI, transparent reporting, and strategies tuned for India's ecommerce landscape—so you win across Google, product searches, and beyond.
            </p>
            ...
            <div className={`grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 transition-all duration-1000 delay-500 ${
              ...
              <div className="text-center group cursor-pointer transform hover:scale-105 transition-all duration-300">
                ...
                <div className="text-gray-300 font-semibold">Ecommerce SEO Awards</div>
            ...
            <div className={`flex flex-col sm:flex-row gap-4 justify-center transition-all duration-1000 delay-1000 ${
              ...
              >
                <span className="relative z-10">Get Free Ecommerce SEO Consultation</span>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-black/40 via-purple-900/10 to-black/40">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">The Ecommerce SEO Company Built for 2025</h2>
            <p className="text-gray-300 max-w-3xl mx-auto">AI insights, human execution, and full-funnel ROI tracking — tailored for ecommerce businesses in Delhi, NCR and pan-India markets.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="rounded-2xl p-6 border border-purple-500/20 bg-gradient-to-br from-purple-900/10 to-purple-800/10">
              <div className="flex items-center space-x-3 mb-3">
                ...
                <h3 className="text-white font-semibold">AI-Powered Ecommerce SEO</h3>
              </div>
              <p className="text-gray-300 text-sm">Target the right product and category keywords. Stay ahead as ecommerce SEO evolves.</p>
            </div>
            <div className="rounded-2xl p-6 border border-purple-500/20 bg-gradient-to-br from-purple-900/10 to-purple-800/10">
              <div className="flex items-center space-x-3 mb-3">
                <Users className="h-5 w-5 text-purple-300" />
                <h3 className="text-white font-semibold">Dedicated Ecommerce Team</h3>
              </div>
              <p className="text-gray-300 text-sm">A cross-functional team for technical SEO, content, link building, and CRO — aligned to your ecommerce goals.</p>
            </div>
            <div className="rounded-2xl p-6 border border-purple-500/20 bg-gradient-to-br from-purple-900/10 to-purple-800/10">
              <div className="flex items-center space-x-3 mb-3">
                <BarChart3 className="h-5 w-5 text-purple-300" />
                <h3 className="text-white font-semibold">Ecommerce Revenue Reporting</h3>
              </div>
              <p className="text-gray-300 text-sm">Dashboards that connect SEO performance to product sales and revenue — not just rankings.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              At Marktechrover, our ecommerce SEO deliverables are crafted to help you rank higher, drive more organic traffic, and convert more visitors—month after month:
            </p>
          </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="bg-gradient-to-r from-purple-900/20 to-purple-800/20 rounded-xl p-6 border border-purple-500/20">
                        ...
                        <ul className="space-y-3 text-gray-300">
                          <li className="flex items-start space-x-3">
                            ...
                            <span className="text-sm">Professional implementation by certified ecommerce SEO experts</span>
                          </li>
                          <li className="flex items-start space-x-3">
                            <div className="w-2 h-2 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
                      ...
                      <div className="bg-gradient-to-r from-green-900/20 to-green-800/20 rounded-xl p-6 border border-green-500/20">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div className="text-center p-3 bg-blue-900/20 rounded-lg">
                            ...
                            <div className="text-xs text-blue-200">Organic Traffic</div>
                          </div>
                          <div className="text-center p-3 bg-blue-900/20 rounded-lg">
                            <div className="text-2xl font-bold text-cyan-300">+80%</div>
                            <div className="text-xs text-blue-200">Product Rankings</div>
                          </div>
                          <div className="text-center p-3 bg-blue-900/20 rounded-lg">
                            <div className="text-2xl font-bold text-cyan-300">+120%</div>
                            <div className="text-xs text-blue-200">Ecommerce Sales</div>
                          </div>
                          <div className="text-center p-3 bg-blue-900/20 rounded-lg">
                            <div className="text-2xl font-bold text-cyan-300">+90%</div>
                      ...
                      <div className="bg-gradient-to-r from-blue-900/20 to-blue-800/20 rounded-xl p-6 border border-blue-500/20">
                        ...
                        <div className="space-y-4">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              <div className="text-blue-200 font-semibold">Week 1-2: Ecommerce SEO Audit</div>
                              <div className="text-blue-100 text-sm">Technical audit, keyword research, and strategy planning</div>
                            </div>
                          </div>
                          <div className="flex items-center space-x-3">
                            <div className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center text-white text-sm font-bold">2</div>
                            <div>
                              <div className="text-blue-200 font-semibold">Week 3-12: Optimization Launch</div>
                              <div className="text-blue-100 text-sm">Product page optimization and content creation</div>
                            </div>
                          </div>
                          <div className="flex items-center space-x-3">
                            <div className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center text-white text-sm font-bold">3</div>
                            <div>
                              <div className="text-blue-200 font-semibold">Month 3+: Ongoing Optimization</div>
                      ...
                      <div className="bg-gradient-to-r from-purple-900/20 to-purple-800/20 rounded-xl p-6 border border-purple-500/20">
                        ...
                        <div className="grid grid-cols-2 gap-3 text-sm">
                          ...
                          <div className="flex items-center space-x-2">
                            <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
                            <span className="text-gray-300">Ecommerce Analytics</span>
                          </div>
                          <div className="flex items-center space-x-2">
                            <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
                            <span className="text-gray-300">Schema Markup Tools</span>
                          </div>
                          <div className="flex items-center space-x-2">
                            <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
                            <span className="text-gray-300">Rank Tracking</span>
                          </div>
                          <div className="flex items-center space-x-2">
                            <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
                            <span className="text-gray-300">Link Building Tools</span>
                          </div>
                          <div className="flex items-center space-x-2">
                            <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
                            <span className="text-gray-300">Ecommerce Dashboards</span>
                          </div>
                        </div>
                      </div>
                    </div>
      ...
      <section id="packages" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-900/5 via-transparent to-purple-900/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">Ecommerce SEO Plans Built for Growth</h2>
            <p className="text-gray-300 max-w-3xl mx-auto">Transparent monthly packages tailored for ecommerce businesses in Delhi & pan-India. Upgrade anytime. Every plan includes reporting, dashboards, and quarterly strategy reviews.</p>
          </div>
                ...
                <div className={`p-6 ${index === 1 ? 'pt-12' : 'pt-10'}`}>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-3 p-3 bg-transparent rounded-lg border border-white/20">
                      <div className="text-center">
                        <div className="text-sm font-bold text-white">{pkg.products}</div>
                    ...
                    <div className="p-3 bg-transparent rounded-lg border border-white/20">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        <div className="text-center p-2 bg-transparent rounded border border-white/15">
                          ...
                          <div className="text-xs text-gray-300">Product Rankings</div>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="mt-16 text-center">
            <div className="bg-gradient-to-r from-purple-900/20 to-purple-800/20 rounded-2xl p-8 border border-purple-500/20">
              <h3 className="text-2xl font-bold text-white mb-6">Why 500+ Ecommerce Businesses Trust Us</h3>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="text-center">
                  ...
                  <div className="text-gray-400 text-sm">Ecommerce SEO</div>
                </div>
                <div className="text-center">
      ...
      <section id="technology" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-900/5 via-transparent to-purple-900/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Our Technology: Smarter Ecommerce SEO for Modern Results
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Marktechrover invests in powerful ecommerce tools and automation to keep your SEO strategy one step ahead
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm">
              ...
              <div className="text-lg font-semibold text-white mb-1">Boost in Ecommerce Conversion Rate</div>
              <div className="text-gray-400 text-sm">for campaigns with ai-driven keyword targeting</div>
            </div>
            <div className="text-center p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm">
              ...
              <div className="text-gray-400 text-sm">to give you the best ecommerce data foundation</div>
            </div>
            <div className="text-center p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm">
              ...
              <div className="text-lg font-semibold text-white mb-1">Built-in Ecommerce Value</div>
              <div className="text-gray-400 text-sm">based on cost of similar ecommerce tools</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Real testimonials from ecommerce businesses across Delhi, NCR, and India
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm">
              ...
              <p className="text-gray-300 mb-4">
                "Marktechrover transformed our ecommerce SEO completely. We went from page 4 to #1 for our main product keywords—results that brought in 4X qualified traffic and 5X sales within six months!"
              </p>
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="text-gray-400 text-sm">CEO, Ecommerce Brand Delhi</div>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm">
              ...
              <p className="text-gray-300 mb-4">
                "The ecommerce SEO team at Marktechrover is incredibly professional and results-driven. Our product rankings increased by 500% within the first year of working with them."
              </p>
              <div className="flex items-center">
                <div className="w-10 h-10 bg-gradient-to-br from-purple-500 via-purple-400 to-purple-600 rounded-full flex items-center justify-center mr-3">
                  <Users className="h-5 w-5 text-white" />
                ...
                <div>
                  ...
                  <div className="text-gray-400 text-sm">Marketing Director, Ecommerce Store</div>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm">
              ...
              <p className="text-gray-300 mb-4">
                "Best investment we've made for our ecommerce. Marktechrover's SEO expertise helped us dominate the NCR market and attract high-quality organic traffic."
              </p>
              <div className="flex items-center">
                <div className="w-10 h-10 bg-gradient-to-br from-purple-500 via-purple-400 to-purple-600 rounded-full flex items-center justify-center mr-3">
                  <Users className="h-5 w-5 text-white" />
                ...
                <div>
                  ...
                  <div className="text-gray-400 text-sm">Founder, Ecommerce NCR</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="case-studies" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-900/5 via-transparent to-purple-900/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Case Studies: Delhi-NCR & India Ecommerce Success Stories
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Real results from real ecommerce businesses across India
            </p>
          </div>
      ...
      <section id="approach" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              A proven 5-step ecommerce SEO process that delivers consistent results
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-gradient-to-r from-purple-900/20 to-purple-800/20 rounded-2xl p-6 border border-purple-500/20">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Ecommerce Sales</span>
          ...
          <div className="text-center mt-12">
            <div className="bg-gradient-to-r from-purple-900/20 to-purple-800/20 rounded-2xl p-8 border border-purple-500/20">
              <h3 className="text-2xl font-bold text-white mb-4">
                Ready to Start Your Ecommerce SEO Journey?
              </h3>
              <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                Join hundreds of ecommerce businesses that have transformed their online presence with our proven approach.
              </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 text-center">
            <div className="bg-gradient-to-r from-purple-900/20 to-purple-800/20 rounded-2xl p-6 border border-purple-500/20">
              ...
              <p className="text-gray-300 mb-4">
                Can't find what you're looking for? Our ecommerce SEO experts are here to help!
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  to="/contact"
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-900/5 via-transparent to-purple-900/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Why Choose Marktechrover for Ecommerce SEO?
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              We're not just another SEO agency. We're your strategic partner for ecommerce digital growth.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm hover:border-purple-400/40 transition-all duration-300">
              ...
              <p className="text-gray-400">We focus on measurable ecommerce outcomes, not just rankings.</p>
            </div>
            ...
            <div className="text-center p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm hover:border-purple-400/40 transition-all duration-300">
              ...
              <h3 className="text-xl font-bold text-white mb-3">Google-Compliant</h3>
              <p className="text-gray-400">All our ecommerce SEO strategies comply with Google's best practices.</p>
            </div>
            ...
            <div className="text-center p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm hover:border-purple-400/40 transition-all duration-300">
              ...
              <h3 className="text-xl font-bold text-white mb-3">Expert Ecommerce Team</h3>
              <p className="text-gray-400">Certified ecommerce SEO specialists with years of experience.</p>
            </div>
            ...
            <div className="text-center p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm hover:border-purple-400/40 transition-all duration-300">
              ...
              <p className="text-gray-400">Strategies that grow with your ecommerce business needs.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Ready to dominate ecommerce search?
              </h2>
              <p className="text-xl text-gray-300 mb-8">
                Partner with Marktechrover—the best ecommerce SEO service provider in Delhi, NCR, and across India. Get in touch for a free consultation or a detailed proposal tailored to your ecommerce goals!
              </p>
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-6 w-6 text-green-400 flex-shrink-0" />
                  <span className="text-gray-300">Free ecommerce SEO audit worth ₹25,000</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-6 w-6 text-green-400 flex-shrink-0" />
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-r from-purple-900/20 via-purple-800/20 to-purple-900/20 border border-purple-500/30 backdrop-blur-sm">
              <div className="text-center">
                ...
                <div className="space-y-4">
                  ...
                  >
                    Get Free Ecommerce SEO Consultation
                  </Link>
                  <Link
                    to="/contact"
