...
const SeoServicesPage = () => {
  ...
  useEffect(() => {
    ...
    // Show trust badges after stats animation
  ...
  useEffect(() => {
    ...
    // Prime sections with initial styles
  ...
  const deliverables = [
    {
      title: 'Number of Keyphrases Optimized',
      description: 'Strategic keyword targeting with 150-300+ high-value search terms specifically chosen for your industry, location, and business goals. We focus on long-tail keywords that convert visitors into customers, including local search terms for Delhi, NCR, and pan-India markets.',
      icon: <Target className="h-6 w-6" />
    },
    {
      title: 'Web Pages Optimized',
      description: 'Comprehensive on-page optimization for 30-60+ pages including homepage, service pages, blog posts, and landing pages. We optimize content, structure, and technical elements for maximum search visibility across all major search engines.',
      icon: <Globe className="h-6 w-6" />
    },
    {
      title: 'Technical Website Audit',
      description: 'In-depth technical analysis covering site speed, mobile responsiveness, crawlability, indexability, and security. We identify and fix technical issues that prevent search engines from properly ranking your site, ensuring optimal performance.',
      icon: <Settings className="h-6 w-6" />
    },
    {
      title: 'Keyword Research & Mapping',
      description: 'Data-driven keyword research using advanced tools to identify high-opportunity search terms. We map keywords to specific pages and create content strategies that target your ideal customer search behavior and buying intent.',
      icon: <Search className="h-6 w-6" />
    },
    {
      title: 'Meta Tags & Schema',
      description: 'Professional optimization of title tags, meta descriptions, and structured data markup. We implement JSON-LD schema to help search engines understand your content and display rich snippets in search results for better click-through rates.',
    ...
    },
    {
      ...
      description: 'Strategic link building through guest posting, broken link building, and digital PR campaigns. We earn high-authority backlinks from relevant websites to boost your domain authority and search rankings in competitive markets.',
      icon: <ExternalLink className="h-6 w-6" />
    },
    {
      title: 'Reporting & Analysis',
      description: 'Comprehensive monthly and quarterly reports tracking organic traffic, keyword rankings, conversion rates, and competitor analysis. We provide actionable insights to continuously improve your SEO performance and ROI.',
    ...
    },
    {
      ...
      description: 'Continuous monitoring and optimization based on algorithm updates, competitor analysis, and performance data. We adapt strategies to maintain and improve your search rankings over time, ensuring long-term success.',
  ...
  const technologyFeatures = [
    {
      title: 'Realtime Rank Monitoring',
      description: 'Watch your most important keywords move up—updated daily.',
      icon: <Activity className="h-8 w-8" />
    },
    {
      title: 'AI-Powered Keyword & Content Research',
      description: 'Surface opportunities the competition misses.',
  ...
  const caseStudies = [
    {
      title: 'E-Commerce Brand Skyrockets to #1 in Delhi',
      description: 'With Marktechrover\'s consistent optimization, our site jumped from page 4 to the Google top spot for our main product keywords—results that brought in 3X qualified leads within five months.',
      metric: '3X Qualified Leads',
      timeframe: '5 Months'
    },
    {
      title: 'NCR-Based SaaS Firm Dominates Local Search',
      description: 'We went from invisible to the go-to in NCR\'s SaaS scene. The blend of local SEO and technical fixes brought in enterprise clients—beyond our expectations.',
      metric: 'Enterprise Clients',
      timeframe: 'Local Dominance'
    },
    {
      title: 'Pan-India Service Business Expands Footprint',
      description: 'We cracked the code for national rankings. Our search visibility and conversions grew and continue to trend upward every month.',
  ...
  const approachSteps = [
    {
      ...
      description: 'Understand your business goals, current rankings, and competitor landscape.',
      detailedDescription: 'We conduct a comprehensive analysis of your current SEO performance, competitor strategies, and market opportunities. This includes technical audits, keyword gap analysis, and content performance review.',
      icon: <Search className="h-6 w-6" />,
      duration: '1-2 weeks',
      deliverables: ['Technical SEO Audit', 'Competitor Analysis', 'Keyword Research', 'Content Gap Analysis'],
    ...
    },
    {
      ...
      detailedDescription: 'Based on our audit findings, we create a personalized SEO roadmap that aligns with your business objectives. This includes priority rankings, timeline projections, and resource allocation.',
      icon: <Target className="h-6 w-6" />,
      duration: '1 week',
      deliverables: ['Custom SEO Strategy', 'Priority Keyword List', 'Content Calendar', 'Timeline Projections'],
      color: 'from-purple-500 to-purple-600',
      bgColor: 'from-purple-500/20 to-purple-600/20'
    },
    {
      step: 'Step 3: Full-Stack Execution',
      description: 'On-page, off-page, content, technical, and local SEO delivered together.',
      detailedDescription: 'Our comprehensive execution covers all aspects of SEO simultaneously. We optimize your website structure, create high-quality content, build authoritative backlinks, and ensure technical excellence.',
      icon: <Layers className="h-6 w-6" />,
      duration: 'Ongoing',
      deliverables: ['On-Page Optimization', 'Content Creation', 'Link Building', 'Technical Improvements'],
    ...
    },
    {
      ...
      detailedDescription: 'We continuously monitor your performance, adapt to algorithm changes, and optimize based on data insights. Regular strategy reviews ensure we stay ahead of the competition.',
  ...
  const faqs = [
    {
      ...
      answer: 'Expect to see ranking lifts and traffic improvements within 4–6 months for most sites, with the biggest gains achieved by committed clients and sustained monthly optimization.',
      category: 'timeline',
      tags: ['results', 'timeline', 'performance']
    },
    {
      question: 'Is all work original and Google-safe?',
      answer: 'Yes! All content and links are created by Indian SEO specialists and follow Google\'s best practices for safety and long-term ranking.',
      category: 'safety',
    ...
    },
    {
      ...
      answer: 'You\'ll get interactive dashboards, keyword ranking reports, traffic analysis, and lead/conversion tracking every month.',
      category: 'reporting',
      tags: ['analytics', 'reports', 'tracking']
    },
    {
      question: 'Do you work with international businesses?',
      answer: 'Yes, we serve clients globally. While we\'re based in Delhi, NCR, our SEO strategies work for businesses worldwide, with specialized local SEO for Indian markets.',
      category: 'service',
      tags: ['international', 'global', 'local']
    },
    {
      question: 'What makes your SEO different from others?',
      answer: 'Our data-driven approach, transparent reporting, and focus on ROI set us apart. We don\'t just improve rankings—we drive measurable business growth.',
      category: 'service',
  ...
  <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-black/40 via-purple-900/10 to-black/40">
    <div className="max-w-7xl mx-auto">
      <div className="text-center mb-14">
        ...
        <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">The SEO Company Built for 2025</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="rounded-2xl p-6 border border-purple-500/20 bg-gradient-to-br from-purple-900/10 to-purple-800/10">
          <div className="flex items-center space-x-3 mb-3">
            ...
            <h3 className="text-white font-semibold">AI Visibility Tracking</h3>
          </div>
          <p className="text-gray-300 text-sm">Track performance across Google and AI-driven results. Stay ahead as search evolves.</p>
        </div>
        <div className="rounded-2xl p-6 border border-purple-500/20 bg-gradient-to-br from-purple-900/10 to-purple-800/10">
          <div className="flex items-center space-x-3 mb-3">
          ...
          <p className="text-gray-300 text-sm">A cross-functional team for strategy, content, tech, and CRO — aligned to your goals.</p>
        </div>
        <div className="rounded-2xl p-6 border border-purple-500/20 bg-gradient-to-br from-purple-900/10 to-purple-800/10">
          <div className="flex items-center space-x-3 mb-3">
          ...
          <p className="text-gray-300 text-sm">Dashboards that connect rankings to leads and revenue — not just traffic.</p>
        </div>
      </div>
    </div>
  </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              At Marktechrover, our deliverables are crafted to help you outrank the competition, win qualified traffic, and convert more leads—month after month:
            </p>
          </div>
              ...
              <div className="bg-gradient-to-br from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 rounded-2xl backdrop-blur-sm p-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                          <div className="text-center p-3 bg-blue-900/20 rounded-lg">
                            <div className="text-2xl font-bold text-cyan-300">+40%</div>
                          ...
                          <div className="text-center p-3 bg-blue-900/20 rounded-lg">
                            ...
                            <div className="text-xs text-blue-200">Keyword Rankings</div>
                          </div>
                          <div className="text-center p-3 bg-blue-900/20 rounded-lg">
                      ...
                      <div className="bg-gradient-to-r from-blue-900/20 to-blue-800/20 rounded-xl p-6 border border-blue-500/20">
                        ...
                        <div className="space-y-4">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              <div className="text-blue-200 font-semibold">Week 1-2: Setup & Analysis</div>
                              <div className="text-blue-100 text-sm">Initial audit, strategy planning, and setup</div>
                            </div>
                          </div>
                          <div className="flex items-center space-x-3">
                            <div className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center text-white text-sm font-bold">2</div>
                            <div>
                              <div className="text-blue-200 font-semibold">Week 3-8: Implementation</div>
                              <div className="text-blue-100 text-sm">Core optimization and content creation</div>
                            </div>
                          </div>
                          <div className="flex items-center space-x-3">
                      ...
                      <div className="bg-gradient-to-r from-purple-900/20 to-purple-800/20 rounded-xl p-6 border border-purple-500/20">
                        ...
                        <div className="grid grid-cols-2 gap-3 text-sm">
                          ...
                          <div className="flex items-center space-x-2">
                            <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
                            <span className="text-gray-300">SEMrush</span>
                          </div>
                          <div className="flex items-center space-x-2">
                            <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
                            <span className="text-gray-300">Ahrefs</span>
                          </div>
                          <div className="flex items-center space-x-2">
                            <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
                            <span className="text-gray-300">Screaming Frog</span>
                          </div>
                          <div className="flex items-center space-x-2">
                            <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
                            <span className="text-gray-300">GTmetrix</span>
                          </div>
                        </div>
                      </div>
                    </div>
      ...
      <section id="technology" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-900/5 via-transparent to-purple-900/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Our Technology: Smarter SEO for Modern Rankings
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Marktechrover invests in powerful tools and automation to keep your SEO strategy one step ahead
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm">
              <div className="text-3xl font-bold bg-gradient-to-r from-purple-400 to-purple-600 bg-clip-text text-transparent mb-2">+10%</div>
              <div className="text-lg font-semibold text-white mb-1">Boost in SEO Traffic</div>
              <div className="text-gray-400 text-sm">for a single page with ai-driven keyword enrichment</div>
            </div>
            <div className="text-center p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm">
              ...
              <p className="text-gray-300 mb-4">
                "Marktechrover transformed our online presence completely. We went from page 4 to #1 for our main keywords in just 6 months. The results speak for themselves!"
              </p>
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm">
              ...
              <p className="text-gray-300 mb-4">
                "The team at Marktechrover is incredibly professional and results-driven. Our organic traffic increased by 300% within the first year of working with them."
              </p>
              <div className="flex items-center">
                <div className="w-10 h-10 bg-gradient-to-br from-purple-500 via-purple-400 to-purple-600 rounded-full flex items-center justify-center mr-3">
                  <Users className="h-5 w-5 text-white" />
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm">
              ...
              <p className="text-gray-300 mb-4">
                "Best investment we've made for our business. Marktechrover's local SEO expertise helped us dominate the NCR market and attract high-quality leads."
              </p>
              <div className="flex items-center">
                <div className="w-10 h-10 bg-gradient-to-br from-purple-500 via-purple-400 to-purple-600 rounded-full flex items-center justify-center mr-3">
                  <Users className="h-5 w-5 text-white" />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 text-center">
            <div className="bg-gradient-to-r from-purple-900/20 to-purple-800/20 rounded-2xl p-6 border border-purple-500/20">
              ...
              <p className="text-gray-300 mb-4">
                Can't find what you're looking for? Our SEO experts are here to help!
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  to="/contact"
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-900/5 via-transparent to-purple-900/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Why Choose Marktechrover for SEO?
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              We're not just another SEO agency. We're your strategic partner for digital growth.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm hover:border-purple-400/40 transition-all duration-300">
              ...
              <p className="text-gray-400">We focus on measurable outcomes, not just rankings.</p>
            </div>
            ...
            <div className="text-center p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm hover:border-purple-400/40 transition-all duration-300">
              ...
              <h3 className="text-xl font-bold text-white mb-3">Google-Safe</h3>
              <p className="text-gray-400">All our strategies comply with Google's latest guidelines.</p>
            </div>
            ...
            <div className="text-center p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm hover:border-purple-400/40 transition-all duration-300">
              ...
              <p className="text-gray-400">Certified SEO specialists with years of experience.</p>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-300 mb-8">
                Partner with Marktechrover—the best SEO service provider in Delhi, NCR, and across India. Get in touch for a free SEO consultation or a detailed proposal tailored to your business goals!
              </p>
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-6 w-6 text-green-400 flex-shrink-0" />
                  <span className="text-gray-300">Free SEO audit worth ₹25,000</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-6 w-6 text-green-400 flex-shrink-0" />
