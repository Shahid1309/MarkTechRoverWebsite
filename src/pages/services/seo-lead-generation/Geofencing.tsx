...
const Geofencing = () => {
  ...
  const navItems = [
    ...
    { id: 'packages', label: 'Geofencing Services Packages', icon: <DollarSign className="h-4 w-4" /> },
    { id: 'technology', label: 'Geofencing Services Technology', icon: <Cpu className="h-4 w-4" /> },
    { id: 'case-studies', label: 'Geofencing Services Case Studies', icon: <Trophy className="h-4 w-4" /> },
    { id: 'approach', label: 'Geofencing Services Approach', icon: <Rocket className="h-4 w-4" /> },
  ...
  const seoConfig = {
    ...
    keywords: [
      'Geofencing Services Delhi', 'Best geofencing agency in Delhi', 'Geofencing services NCR', 'Best geofencing services in India', 'Professional geofencing services India', 'Geofencing experts in Delhi NCR', 'Geofencing company India', 'SEO services in Delhi', 'Geofencing Delhi', 'Location-based advertising India'
    ],
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 transition-all duration-1000">
              Marktechrover: Best <span className="bg-gradient-to-r from-purple-300 via-purple-400 to-purple-500 bg-clip-text text-transparent font-extrabold">Geofencing</span> in Delhi, NCR & India
            </h1>

            {/* Animated Description */}
            <p className="text-xl text-gray-300 mb-8 max-w-4xl mx-auto transition-all duration-1000 delay-300">
              Professional geofencing services in Delhi NCR. Get expert geofencing solutions with proven results and ROI.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center transition-all duration-1000 delay-1000">
              ...
              >
                <span className="relative z-10">Get Free Geofencing Consultation</span>
      ...
      <div className={`fixed left-1/2 transform -translate-x-1/2 z-50 transition-all duration-500 ${isNavSticky ? 'top-32 opacity-100 scale-100' : 'top-0 opacity-0 scale-95 pointer-events-none'}`}>
        ...
        <div className="relative">
          ...
          <section id="deliverables" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                Geofencing Services Deliverables
              </h2>
          ...
          <section id="technology" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                Geofencing Services Technology
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
          ...
          <section id="case-studies" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                Geofencing Services Case Studies
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
