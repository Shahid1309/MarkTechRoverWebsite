...
const LocalServicesAds = () => {
  ...
  const seoConfig = {
    title: 'Google Local Services Ads Management Delhi | Best Local Services Agency NCR',
    description: 'Leading Google Local Services Ads management in Delhi NCR. Best local services agency in Delhi offering comprehensive local services ads optimization. Professional local services management India with proven results.',
    keywords: [
      'Google Local Services Ads Delhi',
      'Best local services agency in Delhi',
      'Local services ads management NCR',
      'Best local services ads in India',
      'Professional local services management India',
      'Local services experts in Delhi NCR',
      'Local services company India',
      'SEO services in Delhi',
      'Local SEO services Delhi',
      'Google Local Services optimization Delhi'
    ],
    url: '/services/seo-lead-generation/local-services-ads',
    type: 'website',
    publishedAt: '2024-01-01',
    modifiedAt: '2024-12-01',
    author: 'Ritik Kumar Poddar',
    section: 'Local Services Ads',
    tags: ['Local Services Ads', 'Google Local Services', 'Local SEO', 'Local Marketing', 'Local Advertising'],
    image: '/images/local-services-ads.webp'
  };
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-4xl mx-auto transition-all duration-1000 delay-300">
              Professional local services ads services in Delhi NCR. Get expert local services ads solutions with proven results and ROI.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center transition-all duration-1000 delay-1000">
              ...
              >
                <span className="relative z-10">Get Free Local Services Ads Consultation</span>
          ...
          <section id="deliverables" className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">
                Local Services Ads Deliverables
              </h2>
...
export default LocalServicesAds; 