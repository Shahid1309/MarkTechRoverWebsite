...
const EcommerceMarketing = () => {
  ...
  const navItems = [
    { id: 'deliverables', label: 'Deliverables', icon: <CheckCircle className="h-4 w-4" /> },{ id: 'technology', label: 'Ecommerce Digital Marketing Services Technology', icon: <Cpu className="h-4 w-4" /> },
