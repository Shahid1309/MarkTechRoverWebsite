...
const EcommercePPC = () => {
  ...
  const seoConfig = {
    ...
    keywords: [
      'Ecommerce PPC Services Delhi', 'Best ecommerce PPC agency in Delhi', 'Ecommerce PPC services NCR', 'Best ecommerce PPC services in India', 'Professional ecommerce PPC services India', 'Ecommerce PPC experts in Delhi NCR', 'Ecommerce PPC company India', 'SEO services in Delhi', 'Ecommerce PPC Delhi', 'Ecommerce PPC campaigns India'
    ],
  ...
  const deliverables = [
    {
      title: 'Google Shopping Ads Setup & Management',
      description: 'Complete setup and ongoing management of Google Shopping campaigns. We create and optimize product feeds, set up Shopping campaigns, manage product listings, and ensure your products appear in Google Shopping results with maximum visibility and performance.',
      icon: <ShoppingCart className="h-6 w-6" />
    },
    {
      title: 'Ecommerce Search Campaigns',
      description: 'Strategic Google Ads search campaigns specifically optimized for ecommerce. We create product-focused ad groups, optimize keywords for commercial intent, and develop ad copy that drives qualified traffic to your product pages.',
      icon: <Search className="h-6 w-6" />
    },
    {
      title: 'Product Listing Ads (PLAs)',
      description: 'Professional management of Product Listing Ads across Google, Bing, and other platforms. We optimize product feeds, improve product data quality, and ensure your products appear in relevant search results with compelling visuals and pricing.',
      icon: <Layers className="h-6 w-6" />
    },
    {
      title: 'Ecommerce Display & Remarketing',
      description: 'Comprehensive display and remarketing campaigns to re-engage visitors and drive conversions. We create visual ads, build remarketing audiences, and implement dynamic remarketing that shows visitors the exact products they viewed.',
      icon: <Eye className="h-6 w-6" />
    },
    {
      title: 'Ecommerce Performance Max Campaigns',
      description: 'Advanced Performance Max campaigns that leverage Google\'s AI to maximize ecommerce conversions across all Google properties. We set up and optimize Performance Max campaigns that automatically find your best customers across Search, Display, YouTube, Gmail, and more.',
      icon: <Zap className="h-6 w-6" />
    },
    {
      title: 'Ecommerce Bid Management & Optimization',
      description: 'Strategic bid management using automated bidding strategies, manual bid adjustments, and conversion-based optimization. We continuously optimize bids to maximize ROI, improve cost per acquisition, and scale profitable campaigns.',
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: 'Ecommerce Landing Page Optimization',
      description: 'Conversion-focused landing page optimization for PPC traffic. We optimize product pages, category pages, and checkout flows to improve conversion rates and maximize the value of your paid traffic.',
      icon: <MousePointer className="h-6 w-6" />
    },
    {
      title: 'Ecommerce Conversion Tracking & Analytics',
      description: 'Comprehensive conversion tracking setup including ecommerce tracking, enhanced conversions, and cross-platform attribution. We provide detailed analytics that connect PPC performance to revenue and ROI.',
      icon: <BarChart3 className="h-6 w-6" />
    },
    {
      title: 'Ecommerce A/B Testing & Experimentation',
      description: 'Continuous A/B testing of ad creatives, landing pages, and bidding strategies. We run systematic experiments to identify winning strategies and optimize for maximum performance.',
      icon: <Activity className="h-6 w-6" />
    },
    {
      title: 'Ecommerce Budget Management & Scaling',
      description: 'Strategic budget allocation and scaling strategies. We optimize budget distribution across campaigns, identify scaling opportunities, and ensure efficient spend allocation that maximizes revenue growth.',
  ...
  const packages = [
    {
      ...
      features: [
        ...
        'Basic Search Campaigns (10 campaigns)',
        'Product Feed Optimization',
        'Basic Display & Remarketing',
        'Monthly Performance Reports',
        'Email Support',
        'Basic Conversion Tracking',
        'Monthly Optimization'
      ],
      bestFor: 'Small ecommerce stores starting with PPC',
    ...
    },
    {
      ...
      features: [
        ...
        'Advanced Search Campaigns (30 campaigns)',
        ...
        'Competitor Analysis',
        'Dedicated Ecommerce PPC Manager',
        'Priority Phone & Email Support',
        'Budget Optimization & Scaling',
        'Cross-Platform Campaign Management'
      ],
      bestFor: 'Growing ecommerce businesses serious about PPC results',
      exclusiveFeatures: ['Exclusive: AI-Powered Bid Optimization', 'Exclusive: Advanced Attribution Modeling', 'Exclusive: Custom Ecommerce PPC Dashboard']
    },
    {
      name: 'Enterprise',
      price: '₹1,59,000',
      ...
      features: [
        ...
        'Full-Scale Shopping & Search Campaigns',
        'International Ecommerce PPC Setup',
        'Multi-Platform Campaign Management',
        'Advanced Analytics & Custom Reports',
        'Weekly Performance Reviews',
        'Dedicated Ecommerce PPC Team (3 specialists)',
      ...
      bestFor: 'Large ecommerce businesses requiring maximum PPC impact',
  ...
  const technologyFeatures = [
    {
      title: 'Real-Time Ecommerce PPC Monitoring',
      description: 'Track your ecommerce ad performance across all platforms—updated in real-time.',
      icon: <Activity className="h-8 w-8" />
    },
    {
      title: 'AI-Powered Ecommerce Bid Optimization',
      description: 'Discover high-value ecommerce opportunities and optimize bids automatically.',
  ...
  const caseStudies = [
    {
      title: 'Ecommerce Brand Achieves 600% ROI',
      description: 'With Marktechrover\'s ecommerce PPC strategy, an online store achieved 600% ROI through Google Shopping and search campaigns—results that brought in ₹50+ crores in revenue within eight months.',
      metric: '600% ROI',
      timeframe: '8 Months'
    },
    {
      title: 'NCR-Based Ecommerce Firm Dominates Shopping Ads',
      description: 'We helped a large ecommerce business go from zero to market leader in NCR\'s online retail space. The blend of Shopping Ads and Performance Max campaigns brought in enterprise-level sales—beyond expectations.',
      metric: 'Enterprise Sales',
      timeframe: 'Shopping Dominance'
    },
    {
      title: 'Pan-India Ecommerce Expands Nationally',
      description: 'We enabled a pan-India ecommerce business to expand nationally through strategic PPC campaigns. Our multi-platform strategy drove national reach and conversions.',
  ...
  const approachSteps = [
    {
      step: 'Step 1: Ecommerce PPC Strategy & Audit',
      description: 'Understand your ecommerce goals, current PPC performance, and competitor landscape.',
      detailedDescription: 'We conduct a comprehensive analysis of your current ecommerce PPC performance, competitor strategies, and market opportunities. This includes account audit, product feed review, and campaign performance analysis.',
      icon: <Search className="h-6 w-6" />,
      duration: '1-2 weeks',
      deliverables: ['Ecommerce PPC Audit', 'Competitor Analysis', 'Product Feed Review', 'Campaign Strategy'],
      color: 'from-blue-500 to-blue-600',
      bgColor: 'from-blue-500/20 to-blue-600/20'
    },
    {
      step: 'Step 2: Custom Ecommerce Roadmap',
      description: 'No generic plans—only tailored, goal-oriented ecommerce PPC strategies.',
      detailedDescription: 'Based on our audit findings, we create a personalized ecommerce PPC roadmap that aligns with your business objectives. This includes campaign structure, budget allocation, and timeline projections.',
      icon: <Target className="h-6 w-6" />,
      duration: '1 week',
      deliverables: ['Custom Ecommerce PPC Strategy', 'Campaign Architecture', 'Budget Plan', 'Timeline Projections'],
      color: 'from-purple-500 to-purple-600',
      bgColor: 'from-purple-500/20 to-purple-600/20'
    },
    {
      step: 'Step 3: Ecommerce Campaign Launch',
      description: 'Shopping Ads, Search campaigns, Display, and Performance Max delivered together.',
      detailedDescription: 'Our comprehensive execution covers all aspects of ecommerce PPC simultaneously. We set up Shopping campaigns, create search ads, implement display remarketing, and launch Performance Max campaigns.',
      icon: <Layers className="h-6 w-6" />,
      duration: 'Ongoing',
      deliverables: ['Shopping Ads Setup', 'Search Campaigns', 'Display & Remarketing', 'Performance Max'],
  ...
  const faqs = [
    {
      question: 'How soon will I see ecommerce PPC results?',
      answer: 'Expect to see initial ecommerce PPC results within 1-2 weeks for most campaigns, with significant improvements in traffic, conversions, and ROI achieved within 3-4 months. The biggest gains come from committed ecommerce clients with sustained monthly optimization.',
      category: 'timeline',
      tags: ['results', 'timeline', 'performance']
    },
    {
      question: 'Is all work original and platform-compliant for ecommerce?',
      answer: 'Yes! All ecommerce ad creatives and strategies are created by our team and follow Google, Bing, and other platform best practices for safety and long-term ecommerce success.',
      category: 'safety',
      tags: ['compliance', 'safety', 'platforms']
    },
    {
      question: 'Which ecommerce PPC plan should I pick?',
      answer: 'Pick an ecommerce PPC plan that matches your store size and growth goals, or ask for a free, custom ecommerce audit and recommendation from our team.',
      category: 'pricing',
      tags: ['packages', 'pricing', 'selection']
    },
    {
      question: 'Can I scale my ecommerce PPC package later?',
      answer: 'Absolutely. Our ecommerce PPC packages are flexible—upgrade or customize at any time as your store grows and you add more products.',
      category: 'pricing',
      tags: ['scaling', 'flexibility', 'upgrades']
    },
    {
      question: 'What\'s included in ecommerce PPC reporting?',
    ...
    },
    {
      ...
      answer: 'Yes, we serve ecommerce clients globally. While we\'re based in Delhi, NCR, our ecommerce PPC strategies work for online stores worldwide, with specialized optimization for Indian markets.',
      category: 'service',
      tags: ['international', 'global', 'local']
    },
    {
      question: 'What makes your ecommerce PPC different from others?',
    ...
    <>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center">
            ...
            <h1 className={`text-4xl md:text-6xl font-bold text-white mb-6 transition-all duration-1000 ${
              ...
              MarkTechRover: Delhi's <span className="bg-gradient-to-r from-purple-300 via-purple-400 to-purple-500 bg-clip-text text-transparent font-extrabold">Ecommerce PPC Agency</span> for Revenue Growth
            </h1>
            ...
            <p className={`text-xl text-gray-300 mb-8 max-w-4xl mx-auto transition-all duration-1000 delay-300 ${
              ...
              Grow with a Delhi-based team that blends AI insights with full-funnel ecommerce PPC. We focus on measurable ROI, transparent reporting, and strategies tuned for India's ecommerce landscape—so you win across Google Shopping, Search, and beyond.
            </p>
            ...
            <div className={`grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 transition-all duration-1000 delay-500 ${
              ...
              <div className="text-center group cursor-pointer transform hover:scale-105 transition-all duration-300">
                ...
                <div className="text-gray-300 font-semibold">Ecommerce PPC Awards</div>
            ...
            <div className={`flex flex-col sm:flex-row gap-4 justify-center transition-all duration-1000 delay-1000 ${
              ...
              >
                <span className="relative z-10">Get Free Ecommerce PPC Consultation</span>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-black/40 via-purple-900/10 to-black/40">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">The Ecommerce PPC Company Built for 2025</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="rounded-2xl p-6 border border-purple-500/20 bg-gradient-to-br from-purple-900/10 to-purple-800/10">
              <div className="flex items-center space-x-3 mb-3">
                ...
                <h3 className="text-white font-semibold">AI-Powered Ecommerce PPC</h3>
              </div>
              <p className="text-gray-300 text-sm">Target the right product and category keywords. Stay ahead as ecommerce PPC evolves.</p>
            </div>
            <div className="rounded-2xl p-6 border border-purple-500/20 bg-gradient-to-br from-purple-900/10 to-purple-800/10">
              <div className="flex items-center space-x-3 mb-3">
              ...
              <p className="text-gray-300 text-sm">A cross-functional team for Shopping Ads, Search campaigns, Display, and CRO — aligned to your ecommerce goals.</p>
            </div>
            <div className="rounded-2xl p-6 border border-purple-500/20 bg-gradient-to-br from-purple-900/10 to-purple-800/10">
              <div className="flex items-center space-x-3 mb-3">
              ...
              <p className="text-gray-300 text-sm">Dashboards that connect PPC performance to product sales and revenue — not just clicks.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              ...
              At Marktechrover, our ecommerce PPC deliverables are crafted to help you reach the right customers, drive more qualified traffic, and convert more visitors—month after month:
              </p>
            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="bg-gradient-to-r from-purple-900/20 to-purple-800/20 rounded-xl p-6 border border-purple-500/20">
                        ...
                        <ul className="space-y-3 text-gray-300">
                          <li className="flex items-start space-x-3">
                            ...
                            <span className="text-sm">Professional implementation by certified ecommerce PPC experts</span>
                          </li>
                          <li className="flex items-start space-x-3">
                            <div className="w-2 h-2 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
                      ...
                      <div className="bg-gradient-to-r from-blue-900/20 to-blue-800/20 rounded-xl p-6 border border-blue-500/20">
                        ...
                        <div className="space-y-4">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              <div className="text-blue-200 font-semibold">Week 1-2: Ecommerce PPC Audit</div>
                              <div className="text-blue-100 text-sm">Account audit, product feed review, and strategy planning</div>
                            </div>
                          </div>
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              ...
                              <div className="text-blue-100 text-sm">Shopping Ads, Search campaigns, and Display setup</div>
                            </div>
                          </div>
                          <div className="flex items-center space-x-3">
                      ...
                      <div className="bg-gradient-to-r from-purple-900/20 to-purple-800/20 rounded-xl p-6 border border-purple-500/20">
                        ...
                        <div className="grid grid-cols-2 gap-3 text-sm">
                          ...
                          <div className="flex items-center space-x-2">
                            <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
                            <span className="text-gray-300">Performance Max</span>
                          </div>
                          <div className="flex items-center space-x-2">
                            <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
      ...
      <section id="packages" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-900/5 via-transparent to-purple-900/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">Ecommerce PPC Plans Built for Growth</h2>
            ...
            <div className="bg-gradient-to-r from-purple-900/20 to-purple-800/20 rounded-2xl p-8 border border-purple-500/20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="text-center">
                  ...
                  <div className="text-gray-400 text-sm">Ecommerce PPC</div>
                </div>
                <div className="text-center">
      ...
      <section id="technology" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-900/5 via-transparent to-purple-900/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Our Technology: Smarter Ecommerce PPC for Modern Results
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Marktechrover invests in powerful ecommerce tools and automation to keep your PPC strategy one step ahead
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm">
              <div className="text-3xl font-bold bg-gradient-to-r from-purple-400 to-purple-600 bg-clip-text text-transparent mb-2">+25%</div>
              <div className="text-lg font-semibold text-white mb-1">Boost in Ecommerce Conversion Rate</div>
              <div className="text-gray-400 text-sm">for campaigns with ai-driven bid optimization</div>
            </div>
            <div className="text-center p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm">
          ...
          <div className="text-center mb-16">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm">
              ...
              <p className="text-gray-300 mb-4">
                "Marktechrover transformed our ecommerce PPC completely. We went from zero to ₹50+ crores in revenue through Google Shopping and search campaigns—results that brought in 6X qualified traffic and 600% ROI within eight months!"
              </p>
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm">
              ...
              <p className="text-gray-300 mb-4">
                "The ecommerce PPC team at Marktechrover is incredibly professional and results-driven. Our Shopping Ads conversions increased by 500% within the first year of working with them."
              </p>
              <div className="flex items-center">
                <div className="w-10 h-10 bg-gradient-to-br from-purple-500 via-purple-400 to-purple-600 rounded-full flex items-center justify-center mr-3">
                  <Users className="h-5 w-5 text-white" />
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm">
              ...
              <p className="text-gray-300 mb-4">
                "Best investment we've made for our ecommerce. Marktechrover's PPC expertise helped us dominate the NCR market and attract high-quality paid traffic."
              </p>
              <div className="flex items-center">
                <div className="w-10 h-10 bg-gradient-to-br from-purple-500 via-purple-400 to-purple-600 rounded-full flex items-center justify-center mr-3">
                  <Users className="h-5 w-5 text-white" />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              A proven 5-step ecommerce PPC process that delivers consistent results
              </p>
            </div>
          ...
          <div className="text-center mt-12">
            <div className="bg-gradient-to-r from-purple-900/20 to-purple-800/20 rounded-2xl p-8 border border-purple-500/20">
              <h3 className="text-2xl font-bold text-white mb-4">
                Ready to Start Your Ecommerce PPC Journey?
              </h3>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Everything you need to know about our ecommerce PPC services
            </p>
          ...
          <div className="mt-12 text-center">
            <div className="bg-gradient-to-r from-purple-900/20 to-purple-800/20 rounded-2xl p-6 border border-purple-500/20">
              ...
              <p className="text-gray-300 mb-4">
                Can't find what you're looking for? Our ecommerce PPC experts are here to help!
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  to="/contact"
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-900/5 via-transparent to-purple-900/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Why Choose Marktechrover for Ecommerce PPC?
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              We're not just another PPC agency. We're your strategic partner for ecommerce digital growth.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm hover:border-purple-400/40 transition-all duration-300">
              ...
              <p className="text-gray-400">We focus on measurable ecommerce outcomes, not just clicks.</p>
            </div>
            ...
            <div className="text-center p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm hover:border-purple-400/40 transition-all duration-300">
              ...
              <p className="text-gray-400">All our ecommerce PPC strategies comply with Google, Bing, and other platform best practices.</p>
            </div>
            ...
            <div className="text-center p-6 rounded-2xl bg-gradient-to-r from-purple-900/10 via-purple-800/10 to-purple-900/10 border border-purple-500/20 backdrop-blur-sm hover:border-purple-400/40 transition-all duration-300">
              ...
              <p className="text-gray-400">Certified ecommerce PPC specialists with years of experience.</p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Ready to dominate ecommerce paid search?
            </h2>
              <p className="text-xl text-gray-300 mb-8">
                Partner with Marktechrover—the best ecommerce PPC service provider in Delhi, NCR, and across India. Get in touch for a free consultation or a detailed proposal tailored to your ecommerce goals!
              </p>
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-6 w-6 text-green-400 flex-shrink-0" />
                  <span className="text-gray-300">Free ecommerce PPC audit worth ₹25,000</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-6 w-6 text-green-400 flex-shrink-0" />
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-r from-purple-900/20 via-purple-800/20 to-purple-900/20 border border-purple-500/30 backdrop-blur-sm">
              ...
              >
                    Get Free Ecommerce PPC Consultation
              </Link>
                  <Link
                    to="/contact"
