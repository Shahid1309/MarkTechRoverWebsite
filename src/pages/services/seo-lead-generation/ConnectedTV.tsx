...
const ConnectedTV = () => {
  ...
  const navItems = [
    ...
    { id: 'packages', label: 'Connected TV & OTT Packages', icon: <DollarSign className="h-4 w-4" /> },
    { id: 'technology', label: 'Connected TV & OTT Technology', icon: <Cpu className="h-4 w-4" /> },
    { id: 'case-studies', label: 'Connected TV & OTT Case Studies', icon: <Trophy className="h-4 w-4" /> },
    { id: 'approach', label: 'Connected TV & OTT Approach', icon: <Rocket className="h-4 w-4" /> },
  ...
  const seoConfig = {
    ...
    keywords: [
      'Connected TV Advertising Delhi', 'Best CTV ads agency in Delhi', 'OTT advertising services NCR', 'Best CTV advertising services in India', 'Professional CTV ads services India', 'Connected TV advertising experts in Delhi NCR', 'CTV ads company India', 'SEO services in Delhi', 'OTT advertising Delhi', 'Connected TV advertising India'
    ],
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 transition-all duration-1000">
              Marktechrover: Best <span className="bg-gradient-to-r from-purple-300 via-purple-400 to-purple-500 bg-clip-text text-transparent font-extrabold">Connected T V</span> in Delhi, NCR & India
            </h1>

            {/* Animated Description */}
            <p className="text-xl text-gray-300 mb-8 max-w-4xl mx-auto transition-all duration-1000 delay-300">
              Professional connected t v services in Delhi NCR. Get expert connected t v solutions with proven results and ROI.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center transition-all duration-1000 delay-1000">
              ...
              >
                <span className="relative z-10">Get Free Connected T V Consultation</span>
