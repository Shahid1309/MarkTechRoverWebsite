      ...
      <div className="relative w-full">
        ...
        <div className="w-full px-4 lg:px-8 py-12">
          <div className="w-full">
            <div className="bg-gradient-to-r from-purple-500/10 via-purple-400/10 to-purple-500/10 rounded-3xl p-8 border border-purple-500/20 backdrop-blur-sm relative overflow-hidden">
              ...
              <div className="relative text-center">
                <div className="flex items-center justify-center space-x-3 mb-4">
                  ...
                  <h2 className="text-white font-bold text-2xl md:text-3xl">Stay Ahead of the Curve</h2>
                </div>
                <p className="text-purple-200 text-base mb-6 max-w-2xl mx-auto leading-relaxed">
                ...
                <div className="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto">
                  <input
                    ...
                    className="flex-1 px-6 py-3 bg-slate-900/50 border border-purple-500/30 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-white placeholder-purple-300 backdrop-blur-sm"
                    required
                  />
                  <button
                    type="submit"
                    className="px-8 py-3 bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-700 hover:to-purple-600 text-white rounded-xl transition-all duration-300 flex items-center justify-center font-semibold group shadow-lg hover:shadow-purple-500/25"
                  >
                    Subscribe
              ...
              <div className="lg:col-span-4">
                <Link to="/" className="inline-block mb-8 group">
                  <div className="relative">
                    ...
                    <img src={Footerlogo} alt="MarkTechRover" className="relative h-14 w-auto" loading="lazy" />
                  </div>
                </Link>
                ...
                <div className="space-y-4 mb-8">
                  <a href="mailto:info@marktechrover.com" 
                    ...
                    <div className="w-12 h-12 bg-gradient-to-br from-purple-500/20 to-purple-400/20 rounded-xl flex items-center justify-center mr-4 group-hover:from-purple-500/30 group-hover:to-purple-400/30 transition-all duration-300 border border-purple-500/30">
                      <Mail className="h-5 w-5" />
                    </div>
                    <span className="font-medium">info@marktechrover.com</span>
                  </a>
                  ...
                  <a href="tel:918826790981" 
                    ...
                    <span className="font-medium">+91 8826790981</span>
                  </a>
                  
                  <div className="flex items-start text-gray-300">
                    <div className="w-12 h-12 bg-gradient-to-br from-purple-500/20 to-purple-400/20 rounded-xl flex items-center justify-center mr-4 flex-shrink-0 border border-purple-500/30">
                      <MapPin className="h-5 w-5" />
                    </div>
                    <span className="font-medium">C-83, Shivalik Colony, Malviya Nagar, New Delhi 110017</span>
                  </div>
                </div>
                ...
                <div className="flex space-x-3">
                  {socialLinks.map((social, index) => (
                    <a
                      ...
                      className="w-14 h-14 bg-gradient-to-br from-purple-500/20 to-purple-400/20 hover:from-purple-500/30 hover:to-purple-400/30 rounded-xl flex items-center justify-center text-gray-300 hover:text-white transition-all duration-300 group border border-purple-500/30"
                  ...
                  {serviceCategories.map((category, index) => (
                    <div key={index} className="space-y-6 group">
                      <div className="flex items-center space-x-3 mb-6">
                        <div className={`w-12 h-12 bg-gradient-to-br ${category.gradient} rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-all duration-300`}>
                      ...
                      <ul className="space-y-4">
                        {category.services.map((service, serviceIndex) => (
                          <li key={serviceIndex}>
                            <Link
                              to={service.path}
                              className="text-gray-300 hover:text-white transition-all duration-300 flex items-center group font-medium"
                            >
                              <ArrowRight className="h-4 w-4 mr-3 opacity-0 -ml-6 group-hover:opacity-100 group-hover:ml-0 transition-all duration-300 text-purple-400" />
                              {service.name}
                            </Link>
                          </li>
                        ))}
        ...
        <div className="w-full px-4 lg:px-8 mb-8">
          <div className="w-full border-t border-purple-500/20 pt-8">
            <div className="flex flex-col lg:flex-row justify-between items-center gap-6">
              ...
              <div className="flex items-center space-x-4 text-slate-400 text-sm">
                ...
                <span className="hidden sm:inline flex items-center">
                  Made with <Heart className="inline h-4 w-4 text-red-500 mx-1" /> in India
                </span>
              </div>
              ...
              <div className="flex flex-wrap justify-center gap-6">
                ...
                <Link to="/privacy-policy" className="text-slate-400 hover:text-purple-300 transition-colors text-sm font-medium">
                  Privacy Policy
                </Link>
                <span className="text-slate-400 text-sm font-medium cursor-pointer hover:text-purple-300 transition-colors">
                  Terms of Service
                </span>
                <span className="text-slate-400 text-sm font-medium cursor-pointer hover:text-purple-300 transition-colors">
                  Cookie Policy
